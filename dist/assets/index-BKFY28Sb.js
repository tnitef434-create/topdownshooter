...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Y0(n,e,t){const i=new Float32Array(Un),s=new V(0,1,0);return new zi({name:"SphericalGaussianBlur",defines:{n:Un,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ur(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function $c(){return new zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ur(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Yc(){return new zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ur(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function ur(){return`
...
`].filter(zs).join(`
`)),r=dl(r),r=sh(r,t),r=ah(r,t),o=dl(o),o=sh(o,t),o=ah(o,t),r=rh(r),o=rh(o),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
