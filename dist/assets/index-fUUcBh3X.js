...
void main() {
	...
	`}class Xh extends Pi{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new Bh(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}const Tg={[yh]:"Linear",[xh]:"Reinhard",[vh]:"Cineon",[_h]:"ACESFilmic",[Mh]:"AgX",[bh]:"Neutral",[Sh]:"Custom"};function wg(n,e){const t=Tg[e];return t===void 0?(Le("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ua=new V;function Ag(){Ye.getLuminanceCoefficients(ua);const n=ua.x.toFixed(4),e=ua.y.toFixed(4),t=ua.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const v=b+m+r,x=b+p+o,y=zc(s,s.VERTEX_SHADER,v),E=zc(s,s.FRAGMENT_SHADER,x);s.attachShader(_,y),s.attachShader(_,E),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(R){if(n.debug.checkShaderErrors){const P=s.getProgramInfoLog(_)||"",O=s.getShaderInfoLog(y)||"",N=s.getShaderInfoLog(E)||"",I=P.trim(),B=O.trim(),F=N.trim();let K=!0,Q=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(K=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,y,E);else{const ie=Hc(s,y,"vertex"),X=Hc(s,E,"fragment");Qe("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
Program Info Log: `+I+`
`+ie+`
`+X)}else I!==""?Le("WebGLProgram: Program Info Log:",I):(B===""||F==="")&&(Q=!1);Q&&(R.diagnostics={runnable:K,programLog:I,vertexShader:{log:B,prefix:m},fragmentShader:{log:F,prefix:p}})}s.deleteShader(y),s.deleteShader(E),S=new Da(s,_),w=Pg(s,_)}let S;this.getUniforms=function(){return S===void 0&&C(this),S};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let L=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return L===!1&&(L=s.getProgramParameter(_,_g)),L},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Sg++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=y,this.fragmentShader=E,this}let qg=0;class Yg{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,s=this._getShaderStage(t),a=this._getShaderStage(i),r=this._getShaderCacheForMaterial(e);return r.has(s)===!1&&(r.add(s),s.usedTimes++),r.has(a)===!1&&(r.add(a),a.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new $g(e),t.set(e,i)),i}}class $g{constructor(e){this.id=qg++,this.code=e,this.usedTimes=0}}function Kg(n){return n===On||n===Fa||n===za}function Zg(n,e,t,i,s,a){const r=new Nh,o=new Yg,l=new Set,c=[],h=new Map,f=i.logarithmicDepthBuffer;let d=i.precision;const u={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(S){return l.add(S),S===0?"uv":`uv${S}`}function _(S,w,L,R,P,O){const N=R.fog,I=P.geometry,B=S.isMeshStandardMaterial||S.isMeshLambertMaterial||S.isMeshPhongMaterial?R.environment:null,F=S.isMeshStandardMaterial||S.isMeshLambertMaterial&&!S.envMap||S.isMeshPhongMaterial&&!S.envMap,K=e.get(S.envMap||B,F),Q=K&&K.mapping===Za?K.image.height:null,ie=u[S.type];S.precision!==null&&(d=i.getMaxPrecision(S.precision),d!==S.precision&&Le("WebGLProgram.getParameters:",S.precision,"not supported, using",d,"instead."));const X=I.morphAttributes.position||I.morphAttributes.normal||I.morphAttributes.color,J=X!==void 0?X.length:0;let Te=0;I.morphAttributes.position!==void 0&&(Te=1),I.morphAttributes.normal!==void 0&&(Te=2),I.morphAttributes.color!==void 0&&(Te=3);let ze,Pe,Y,se;if(ie){const ke=Ti[ie];ze=ke.vertexShader,Pe=ke.fragmentShader}else ze=S.vertexShader,Pe=S.fragmentShader,o.update(S),Y=o.getVertexShaderID(S),se=o.getFragmentShaderID(S);const ne=n.getRenderTarget(),Me=n.state.buffers.depth.getReversed(),Ie=P.isInstancedMesh===!0,Ce=P.isBatchedMesh===!0,Ze=!!S.map,Be=!!S.matcap,je=!!K,pt=!!S.aoMap,Ge=!!S.lightMap,Pt=!!S.bumpMap,yt=!!S.normalMap,jt=!!S.displacementMap,k=!!S.emissiveMap,It=!!S.metalnessMap,Xe=!!S.roughnessMap,dt=S.anisotropy>0,fe=S.clearcoat>0,vt=S.dispersion>0,A=S.iridescence>0,M=S.sheen>0,z=S.transmission>0,Z=dt&&!!S.anisotropyMap,te=fe&&!!S.clearcoatMap,ae=fe&&!!S.clearcoatNormalMap,he=fe&&!!S.clearcoatRoughnessMap,q=A&&!!S.iridescenceMap,j=A&&!!S.iridescenceThicknessMap,ge=M&&!!S.sheenColorMap,_e=M&&!!S.sheenRoughnessMap,le=!!S.specularMap,re=!!S.specularColorMap,De=!!S.specularIntensityMap,Fe=z&&!!S.transmissionMap,et=z&&!!S.thicknessMap,D=!!S.gradientMap,oe=!!S.alphaMap,$=S.alphaTest>0,ye=!!S.alphaHash,ce=!!S.extensions;let ee=Ci;S.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(ee=n.toneMapping);const we={shaderID:ie,shaderType:S.type,shaderName:S.name,vertexShader:ze,fragmentShader:Pe,defines:S.defines,customVertexShaderID:Y,customFragmentShaderID:se,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:d,batching:Ce,batchingColor:Ce&&P._colorsTexture!==null,instancing:Ie,instancingColor:Ie&&P.instanceColor!==null,instancingMorph:Ie&&P.morphTexture!==null,outputColorSpace:ne===null?n.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:Ye.workingColorSpace,alphaToCoverage:!!S.alphaToCoverage,map:Ze,matcap:Be,envMap:je,envMapMode:je&&K.mapping,envMapCubeUVHeight:Q,aoMap:pt,lightMap:Ge,bumpMap:Pt,normalMap:yt,displacementMap:jt,emissiveMap:k,normalMapObjectSpace:yt&&S.normalMapType===Df,normalMapTangentSpace:yt&&S.normalMapType===Wo,packedNormalMap:yt&&S.normalMapType===Wo&&Kg(S.normalMap.format),metalnessMap:It,roughnessMap:Xe,anisotropy:dt,anisotropyMap:Z,clearcoat:fe,clearcoatMap:te,clearcoatNormalMap:ae,clearcoatRoughnessMap:he,dispersion:vt,iridescence:A,iridescenceMap:q,iridescenceThicknessMap:j,sheen:M,sheenColorMap:ge,sheenRoughnessMap:_e,specularMap:le,specularColorMap:re,specularIntensityMap:De,transmission:z,transmissionMap:Fe,thicknessMap:et,gradientMap:D,opaque:S.transparent===!1&&S.blending===rs&&S.alphaToCoverage===!1,alphaMap:oe,alphaTest:$,alphaHash:ye,combine:S.combine,mapUv:Ze&&g(S.map.channel),aoMapUv:pt&&g(S.aoMap.channel),lightMapUv:Ge&&g(S.lightMap.channel),bumpMapUv:Pt&&g(S.bumpMap.channel),normalMapUv:yt&&g(S.normalMap.channel),displacementMapUv:jt&&g(S.displacementMap.channel),emissiveMapUv:k&&g(S.emissiveMap.channel),metalnessMapUv:It&&g(S.metalnessMap.channel),roughnessMapUv:Xe&&g(S.roughnessMap.channel),anisotropyMapUv:Z&&g(S.anisotropyMap.channel),clearcoatMapUv:te&&g(S.clearcoatMap.channel),clearcoatNormalMapUv:ae&&g(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:he&&g(S.clearcoatRoughnessMap.channel),iridescenceMapUv:q&&g(S.iridescenceMap.channel),iridescenceThicknessMapUv:j&&g(S.iridescenceThicknessMap.channel),sheenColorMapUv:ge&&g(S.sheenColorMap.channel),sheenRoughnessMapUv:_e&&g(S.sheenRoughnessMap.channel),specularMapUv:le&&g(S.specularMap.channel),specularColorMapUv:re&&g(S.specularColorMap.channel),specularIntensityMapUv:De&&g(S.specularIntensityMap.channel),transmissionMapUv:Fe&&g(S.transmissionMap.channel),thicknessMapUv:et&&g(S.thicknessMap.channel),alphaMapUv:oe&&g(S.alphaMap.channel),vertexTangents:!!I.attributes.tangent&&(yt||dt),vertexNormals:!!I.attributes.normal,vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!I.attributes.color&&I.attributes.color.itemSize===4,pointsUvs:P.isPoints===!0&&!!I.attributes.uv&&(Ze||oe),fog:!!N,useFog:S.fog===!0,fogExp2:!!N&&N.isFogExp2,flatShading:S.wireframe===!1&&(S.flatShading===!0||I.attributes.normal===void 0&&yt===!1&&(S.isMeshLambertMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isMeshPhysicalMaterial)),sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:Me,skinning:P.isSkinnedMesh===!0,morphTargets:I.morphAttributes.position!==void 0,morphNormals:I.morphAttributes.normal!==void 0,morphColors:I.morphAttributes.color!==void 0,morphTargetsCount:J,morphTextureStride:Te,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:O.length,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:S.dithering,shadowMapEnabled:n.shadowMap.enabled&&L.length>0,shadowMapType:n.shadowMap.type,toneMapping:ee,decodeVideoTexture:Ze&&S.map.isVideoTexture===!0&&Ye.getTransfer(S.map.colorSpace)===st,decodeVideoTextureEmissive:k&&S.emissiveMap.isVideoTexture===!0&&Ye.getTransfer(S.emissiveMap.colorSpace)===st,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Gi,flipSided:S.side===Zt,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:ce&&S.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&S.extensions.multiDraw===!0||Ce)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return we.vertexUv1s=l.has(1),we.vertexUv2s=l.has(2),we.vertexUv3s=l.has(3),l.clear(),we}function m(S){const w=[];if(S.shaderID?w.push(S.shaderID):(w.push(S.customVertexShaderID),w.push(S.customFragmentShaderID)),S.defines!==void 0)for(const L in S.defines)w.push(L),w.push(S.defines[L]);return S.isRawShaderMaterial===!1&&(p(w,S),b(w,S),w.push(n.outputColorSpace)),w.push(S.customProgramCacheKey),w.join()}function p(S,w){S.push(w.precision),S.push(w.outputColorSpace),S.push(w.envMapMode),S.push(w.envMapCubeUVHeight),S.push(w.mapUv),S.push(w.alphaMapUv),S.push(w.lightMapUv),S.push(w.aoMapUv),S.push(w.bumpMapUv),S.push(w.normalMapUv),S.push(w.displacementMapUv),S.push(w.emissiveMapUv),S.push(w.metalnessMapUv),S.push(w.roughnessMapUv),S.push(w.anisotropyMapUv),S.push(w.clearcoatMapUv),S.push(w.clearcoatNormalMapUv),S.push(w.clearcoatRoughnessMapUv),S.push(w.iridescenceMapUv),S.push(w.iridescenceThicknessMapUv),S.push(w.sheenColorMapUv),S.push(w.sheenRoughnessMapUv),S.push(w.specularMapUv),S.push(w.specularColorMapUv),S.push(w.specularIntensityMapUv),S.push(w.transmissionMapUv),S.push(w.thicknessMapUv),S.push(w.combine),S.push(w.fogExp2),S.push(w.sizeAttenuation),S.push(w.morphTargetsCount),S.push(w.morphAttributeCount),S.push(w.numDirLights),S.push(w.numPointLights),S.push(w.numSpotLights),S.push(w.numSpotLightMaps),S.push(w.numHemiLights),S.push(w.numRectAreaLights),S.push(w.numDirLightShadows),S.push(w.numPointLightShadows),S.push(w.numSpotLightShadows),S.push(w.numSpotLightShadowsWithMaps),S.push(w.numLightProbes),S.push(w.shadowMapType),S.push(w.toneMapping),S.push(w.numClippingPlanes),S.push(w.numClipIntersection),S.push(w.depthPacking)}function b(S,w){r.disableAll(),w.instancing&&r.enable(0),w.instancingColor&&r.enable(1),w.instancingMorph&&r.enable(2),w.matcap&&r.enable(3),w.envMap&&r.enable(4),w.normalMapObjectSpace&&r.enable(5),w.normalMapTangentSpace&&r.enable(6),w.clearcoat&&r.enable(7),w.iridescence&&r.enable(8),w.alphaTest&&r.enable(9),w.vertexColors&&r.enable(10),w.vertexAlphas&&r.enable(11),w.vertexUv1s&&r.enable(12),w.vertexUv2s&&r.enable(13),w.vertexUv3s&&r.enable(14),w.vertexTangents&&r.enable(15),w.anisotropy&&r.enable(16),w.alphaHash&&r.enable(17),w.batching&&r.enable(18),w.dispersion&&r.enable(19),w.batchingColor&&r.enable(20),w.gradientMap&&r.enable(21),w.packedNormalMap&&r.enable(22),w.vertexNormals&&r.enable(23),S.push(r.mask),r.disableAll(),w.fog&&r.enable(0),w.useFog&&r.enable(1),w.flatShading&&r.enable(2),w.logarithmicDepthBuffer&&r.enable(3),w.reversedDepthBuffer&&r.enable(4),w.skinning&&r.enable(5),w.morphTargets&&r.enable(6),w.morphNormals&&r.enable(7),w.morphColors&&r.enable(8),w.premultipliedAlpha&&r.enable(9),w.shadowMapEnabled&&r.enable(10),w.doubleSided&&r.enable(11),w.flipSided&&r.enable(12),w.useDepthPacking&&r.enable(13),w.dithering&&r.enable(14),w.transmission&&r.enable(15),w.sheen&&r.enable(16),w.opaque&&r.enable(17),w.pointsUvs&&r.enable(18),w.decodeVideoTexture&&r.enable(19),w.decodeVideoTextureEmissive&&r.enable(20),w.alphaToCoverage&&r.enable(21),w.numLightProbeGrids>0&&r.enable(22),S.push(r.mask)}function v(S){const w=u[S.type];let L;if(w){const R=Ti[w];L=yu.clone(R.uniforms)}else L=S.uniforms;return L}function x(S,w){let L=h.get(w);return L!==void 0?++L.usedTimes:(L=new Xg(n,w,S,s),c.push(L),h.set(w,L)),L}function y(S){if(--S.usedTimes===0){const w=c.indexOf(S);c[w]=c[c.length-1],c.pop(),h.delete(S.cacheKey),S.destroy()}}function E(S){o.remove(S)}function C(){o.dispose()}return{getParameters:_,getProgramCacheKey:m,getUniforms:v,acquireProgram:x,releaseProgram:y,releaseShaderCache:E,programs:c,dispose:C}}function jg(){let n=new WeakMap;function e(r){return n.has(r)}function t(r){let o=n.get(r);return o===void 0&&(o={},n.set(r,o)),o}function i(r){n.delete(r)}function s(r,o,l){n.get(r)[o]=l}function a(){n=new WeakMap}return{has:e,get:t,remove:i,update:s,dispose:a}}function Jg(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.materialVariant!==e.materialVariant?n.materialVariant-e.materialVariant:n.z!==e.z?n.z-e.z:n.id-e.id}function Yc(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function $c(){const n=[];let e=0;const t=[],i=[],s=[];function a(){e=0,t.length=0,i.length=0,s.length=0}function r(d){let u=0;return d.isInstancedMesh&&(u+=2),d.isSkinnedMesh&&(u+=1),u}function o(d,u,g,_,m,p){let b=n[e];return b===void 0?(b={id:d.id,object:d,geometry:u,material:g,materialVariant:r(d),groupOrder:_,renderOrder:d.renderOrder,z:m,group:p},n[e]=b):(b.id=d.id,b.object=d,b.geometry=u,b.material=g,b.materialVariant=r(d),b.groupOrder=_,b.renderOrder=d.renderOrder,b.z=m,b.group=p),e++,b}function l(d,u,g,_,m,p){const b=o(d,u,g,_,m,p);g.transmission>0?i.push(b):g.transparent===!0?s.push(b):t.push(b)}function c(d,u,g,_,m,p){const b=o(d,u,g,_,m,p);g.transmission>0?i.unshift(b):g.transparent===!0?s.unshift(b):t.unshift(b)}function h(d,u){t.length>1&&t.sort(d||Jg),i.length>1&&i.sort(u||Yc),s.length>1&&s.sort(u||Yc)}function f(){for(let d=e,u=n.length;d<u;d++){const g=n[d];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:t,transmissive:i,transparent:s,init:a,push:l,unshift:c,finish:f,sort:h}}function Qg(){let n=new WeakMap;function e(i,s){const a=n.get(i);let r;return a===void 0?(r=new $c,n.set(i,[r])):s>=a.length?(r=new $c,a.push(r)):r=a[s],r}function t(){n=new WeakMap}return{get:e,dispose:t}}function ey(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new V,color:new nt};break;case"SpotLight":t={position:new V,direction:new V,color:new nt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new V,color:new nt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new V,skyColor:new nt,groundColor:new nt};break;case"RectAreaLight":t={color:new nt,position:new V,halfWidth:new V,halfHeight:new V};break}return n[e.id]=t,t}}}function ty(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new it,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let iy=0;function ny(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function sy(n){const e=new ey,t=ty(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new V);const s=new V,a=new wt,r=new wt;function o(c){let h=0,f=0,d=0;for(let w=0;w<9;w++)i.probe[w].set(0,0,0);let u=0,g=0,_=0,m=0,p=0,b=0,v=0,x=0,y=0,E=0,C=0;c.sort(ny);for(let w=0,L=c.length;w<L;w++){const R=c[w],P=R.color,O=R.intensity,N=R.distance;let I=null;if(R.shadow&&R.shadow.map&&(R.shadow.map.texture.format===On?I=R.shadow.map.texture:I=R.shadow.map.depthTexture||R.shadow.map.texture),R.isAmbientLight)h+=P.r*O,f+=P.g*O,d+=P.b*O;else if(R.isLightProbe){for(let B=0;B<9;B++)i.probe[B].addScaledVector(R.sh.coefficients[B],O);C++}else if(R.isDirectionalLight){const B=e.get(R);if(B.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const F=R.shadow,K=t.get(R);K.shadowIntensity=F.intensity,K.shadowBias=F.bias,K.shadowNormalBias=F.normalBias,K.shadowRadius=F.radius,K.shadowMapSize=F.mapSize,i.directionalShadow[u]=K,i.directionalShadowMap[u]=I,i.directionalShadowMatrix[u]=R.shadow.matrix,b++}i.directional[u]=B,u++}else if(R.isSpotLight){const B=e.get(R);B.position.setFromMatrixPosition(R.matrixWorld),B.color.copy(P).multiplyScalar(O),B.distance=N,B.coneCos=Math.cos(R.angle),B.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),B.decay=R.decay,i.spot[_]=B;const F=R.shadow;if(R.map&&(i.spotLightMap[y]=R.map,y++,F.updateMatrices(R),R.castShadow&&E++),i.spotLightMatrix[_]=F.matrix,R.castShadow){const K=t.get(R);K.shadowIntensity=F.intensity,K.shadowBias=F.bias,K.shadowNormalBias=F.normalBias,K.shadowRadius=F.radius,K.shadowMapSize=F.mapSize,i.spotShadow[_]=K,i.spotShadowMap[_]=I,x++}_++}else if(R.isRectAreaLight){const B=e.get(R);B.color.copy(P).multiplyScalar(O),B.halfWidth.set(R.width*.5,0,0),B.halfHeight.set(0,R.height*.5,0),i.rectArea[m]=B,m++}else if(R.isPointLight){const B=e.get(R);if(B.color.copy(R.color).multiplyScalar(R.intensity),B.distance=R.distance,B.decay=R.decay,R.castShadow){const F=R.shadow,K=t.get(R);K.shadowIntensity=F.intensity,K.shadowBias=F.bias,K.shadowNormalBias=F.normalBias,K.shadowRadius=F.radius,K.shadowMapSize=F.mapSize,K.shadowCameraNear=F.camera.near,K.shadowCameraFar=F.camera.far,i.pointShadow[g]=K,i.pointShadowMap[g]=I,i.pointShadowMatrix[g]=R.shadow.matrix,v++}i.point[g]=B,g++}else if(R.isHemisphereLight){const B=e.get(R);B.skyColor.copy(R.color).multiplyScalar(O),B.groundColor.copy(R.groundColor).multiplyScalar(O),i.hemi[p]=B,p++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=ue.LTC_FLOAT_1,i.rectAreaLTC2=ue.LTC_FLOAT_2):(i.rectAreaLTC1=ue.LTC_HALF_1,i.rectAreaLTC2=ue.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=f,i.ambient[2]=d;const S=i.hash;(S.directionalLength!==u||S.pointLength!==g||S.spotLength!==_||S.rectAreaLength!==m||S.hemiLength!==p||S.numDirectionalShadows!==b||S.numPointShadows!==v||S.numSpotShadows!==x||S.numSpotMaps!==y||S.numLightProbes!==C)&&(i.directional.length=u,i.spot.length=_,i.rectArea.length=m,i.point.length=g,i.hemi.length=p,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=x,i.spotShadowMap.length=x,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=x+y-E,i.spotLightMap.length=y,i.numSpotLightShadowsWithMaps=E,i.numLightProbes=C,S.directionalLength=u,S.pointLength=g,S.spotLength=_,S.rectAreaLength=m,S.hemiLength=p,S.numDirectionalShadows=b,S.numPointShadows=v,S.numSpotShadows=x,S.numSpotMaps=y,S.numLightProbes=C,i.version=iy++)}function l(c,h){let f=0,d=0,u=0,g=0,_=0;const m=h.matrixWorldInverse;for(let p=0,b=c.length;p<b;p++){const v=c[p];if(v.isDirectionalLight){const x=i.directional[f];x.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(m),f++}else if(v.isSpotLight){const x=i.spot[u];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(m),u++}else if(v.isRectAreaLight){const x=i.rectArea[g];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(m),r.identity(),a.copy(v.matrixWorld),a.premultiply(m),r.extractRotation(a),x.halfWidth.set(v.width*.5,0,0),x.halfHeight.set(0,v.height*.5,0),x.halfWidth.applyMatrix4(r),x.halfHeight.applyMatrix4(r),g++}else if(v.isPointLight){const x=i.point[d];x.position.setFromMatrixPosition(v.matrixWorld),x.position.applyMatrix4(m),d++}else if(v.isHemisphereLight){const x=i.hemi[_];x.direction.setFromMatrixPosition(v.matrixWorld),x.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:i}}function Kc(n){const e=new sy(n),t=[],i=[],s=[];function a(d){f.camera=d,t.length=0,i.length=0,s.length=0}function r(d){t.push(d)}function o(d){i.push(d)}function l(d){s.push(d)}function c(){e.setup(t)}function h(d){e.setupView(t,d)}const f={lightsArray:t,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:a,state:f,setupLights:c,setupLightsView:h,pushLight:r,pushShadow:o,pushLightProbeGrid:l}}function ay(n){let e=new WeakMap;function t(s,a=0){const r=e.get(s);let o;return r===void 0?(o=new Kc(n),e.set(s,[o])):a>=r.length?(o=new Kc(n),r.push(o)):o=r[a],o}function i(){e=new WeakMap}return{get:t,dispose:i}}const ry=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,ly=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],cy=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],Zc=new wt,Rs=new V,Wr=new V;function hy(n,e,t){let i=new pl;const s=new it,a=new it,r=new St,o=new Su,l=new Mu,c={},h=t.maxTextureSize,f={[gn]:Zt,[Zt]:gn,[Gi]:Gi},d=new Ni({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new it},radius:{value:4}},vertexShader:ry,fragmentShader:oy}),u=d.clone();u.defines.HORIZONTAL_PASS=1;const g=new _i;g.setAttribute("position",new Ii(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ht(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ra;let p=this.type;this.render=function(E,C,S){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;this.type===hf&&(Le("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ra);const w=n.getRenderTarget(),L=n.getActiveCubeFace(),R=n.getActiveMipmapLevel(),P=n.state;P.setBlending(Yi),P.buffers.depth.getReversed()===!0?P.buffers.color.setClear(0,0,0,0):P.buffers.color.setClear(1,1,1,1),P.buffers.depth.setTest(!0),P.setScissorTest(!1);const O=p!==this.type;O&&C.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(I=>I.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,I=E.length;N<I;N++){const B=E[N],F=B.shadow;if(F===void 0){Le("WebGLShadowMap:",B,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;s.copy(F.mapSize);const K=F.getFrameExtents();s.multiply(K),a.copy(F.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/K.x),s.x=a.x*K.x,F.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/K.y),s.y=a.y*K.y,F.mapSize.y=a.y));const Q=n.state.buffers.depth.getReversed();if(F.camera._reversedDepth=Q,F.map===null||O===!0){if(F.map!==null&&(F.map.depthTexture!==null&&(F.map.depthTexture.dispose(),F.map.depthTexture=null),F.map.dispose()),this.type===Ps){if(B.isPointLight){Le("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}F.map=new Pi(s.x,s.y,{format:On,type:Ki,minFilter:Wt,magFilter:Wt,generateMipmaps:!1}),F.map.texture.name=B.name+".shadowMap",F.map.depthTexture=new ds(s.x,s.y,wi),F.map.depthTexture.name=B.name+".shadowMapDepth",F.map.depthTexture.format=Zi,F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Ft,F.map.depthTexture.magFilter=Ft}else B.isPointLight?(F.map=new Xh(s.x),F.map.depthTexture=new mu(s.x,Di)):(F.map=new Pi(s.x,s.y),F.map.depthTexture=new ds(s.x,s.y,Di)),F.map.depthTexture.name=B.name+".shadowMap",F.map.depthTexture.format=Zi,this.type===Ra?(F.map.depthTexture.compareFunction=Q?dl:hl,F.map.depthTexture.minFilter=Wt,F.map.depthTexture.magFilter=Wt):(F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=Ft,F.map.depthTexture.magFilter=Ft);F.camera.updateProjectionMatrix()}const ie=F.map.isWebGLCubeRenderTarget?6:1;for(let X=0;X<ie;X++){if(F.map.isWebGLCubeRenderTarget)n.setRenderTarget(F.map,X),n.clear();else{X===0&&(n.setRenderTarget(F.map),n.clear());const J=F.getViewport(X);r.set(a.x*J.x,a.y*J.y,a.x*J.z,a.y*J.w),P.viewport(r)}if(B.isPointLight){const J=F.camera,Te=F.matrix,ze=B.distance||J.far;ze!==J.far&&(J.far=ze,J.updateProjectionMatrix()),Rs.setFromMatrixPosition(B.matrixWorld),J.position.copy(Rs),Wr.copy(J.position),Wr.add(ly[X]),J.up.copy(cy[X]),J.lookAt(Wr),J.updateMatrixWorld(),Te.makeTranslation(-Rs.x,-Rs.y,-Rs.z),Zc.multiplyMatrices(J.projectionMatrix,J.matrixWorldInverse),F._frustum.setFromProjectionMatrix(Zc,J.coordinateSystem,J.reversedDepth)}else F.updateMatrices(B);i=F.getFrustum(),x(C,S,F.camera,B,this.type)}F.isPointLightShadow!==!0&&this.type===Ps&&b(F,S),F.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(w,L,R)};function b(E,C){const S=e.update(_);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,u.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,u.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Pi(s.x,s.y,{format:On,type:Ki})),d.uniforms.shadow_pass.value=E.map.depthTexture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,n.setRenderTarget(E.mapPass),n.clear(),n.renderBufferDirect(C,null,S,d,_,null),u.uniforms.shadow_pass.value=E.mapPass.texture,u.uniforms.resolution.value=E.mapSize,u.uniforms.radius.value=E.radius,n.setRenderTarget(E.map),n.clear(),n.renderBufferDirect(C,null,S,u,_,null)}function v(E,C,S,w){let L=null;const R=S.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(R!==void 0)L=R;else if(L=S.isPointLight===!0?l:o,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const P=L.uuid,O=C.uuid;let N=c[P];N===void 0&&(N={},c[P]=N);let I=N[O];I===void 0&&(I=L.clone(),N[O]=I,C.addEventListener("dispose",y)),L=I}if(L.visible=C.visible,L.wireframe=C.wireframe,w===Ps?L.side=C.shadowSide!==null?C.shadowSide:C.side:L.side=C.shadowSide!==null?C.shadowSide:f[C.side],L.alphaMap=C.alphaMap,L.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,L.map=C.map,L.clipShadows=C.clipShadows,L.clippingPlanes=C.clippingPlanes,L.clipIntersection=C.clipIntersection,L.displacementMap=C.displacementMap,L.displacementScale=C.displacementScale,L.displacementBias=C.displacementBias,L.wireframeLinewidth=C.wireframeLinewidth,L.linewidth=C.linewidth,S.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const P=n.properties.get(L);P.light=S}return L}function x(E,C,S,w,L){if(E.visible===!1)return;if(E.layers.test(C.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&L===Ps)&&(!E.frustumCulled||i.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(S.matrixWorldInverse,E.matrixWorld);const O=e.update(E),N=E.material;if(Array.isArray(N)){const I=O.groups;for(let B=0,F=I.length;B<F;B++){const K=I[B],Q=N[K.materialIndex];if(Q&&Q.visible){const ie=v(E,Q,w,L);E.onBeforeShadow(n,E,C,S,O,ie,K),n.renderBufferDirect(S,null,O,ie,E,K),E.onAfterShadow(n,E,C,S,O,ie,K)}}}else if(N.visible){const I=v(E,N,w,L);E.onBeforeShadow(n,E,C,S,O,I,null),n.renderBufferDirect(S,null,O,I,E,null),E.onAfterShadow(n,E,C,S,O,I,null)}}const P=E.children;for(let O=0,N=P.length;O<N;O++)x(P[O],C,S,w,L)}function y(E){E.target.removeEventListener("dispose",y);for(const S in c){const w=c[S],L=E.target.uuid;L in w&&(w[L].dispose(),delete w[L])}}}function dy(n,e){function t(){let D=!1;const oe=new St;let $=null;const ye=new St(0,0,0,0);return{setMask:function(ce){$!==ce&&!D&&(n.colorMask(ce,ce,ce,ce),$=ce)},setLocked:function(ce){D=ce},setClear:function(ce,ee,we,ke,Mt){Mt===!0&&(ce*=ke,ee*=ke,we*=ke),oe.set(ce,ee,we,ke),ye.equals(oe)===!1&&(n.clearColor(ce,ee,we,ke),ye.copy(oe))},reset:function(){D=!1,$=null,ye.set(-1,0,0,0)}}}function i(){let D=!1,oe=!1,$=null,ye=null,ce=null;return{setReversed:function(ee){if(oe!==ee){const we=e.get("EXT_clip_control");ee?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),oe=ee;const ke=ce;ce=null,this.setClear(ke)}},getReversed:function(){return oe},setTest:function(ee){ee?ne(n.DEPTH_TEST):Me(n.DEPTH_TEST)},setMask:function(ee){$!==ee&&!D&&(n.depthMask(ee),$=ee)},setFunc:function(ee){if(oe&&(ee=Wf[ee]),ye!==ee){switch(ee){case no:n.depthFunc(n.NEVER);break;case so:n.depthFunc(n.ALWAYS);break;case ao:n.depthFunc(n.LESS);break;case cs:n.depthFunc(n.LEQUAL);break;case ro:n.depthFunc(n.EQUAL);break;case oo:n.depthFunc(n.GEQUAL);break;case lo:n.depthFunc(n.GREATER);break;case co:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ye=ee}},setLocked:function(ee){D=ee},setClear:function(ee){ce!==ee&&(ce=ee,oe&&(ee=1-ee),n.clearDepth(ee))},reset:function(){D=!1,$=null,ye=null,ce=null,oe=!1}}}function s(){let D=!1,oe=null,$=null,ye=null,ce=null,ee=null,we=null,ke=null,Mt=null;return{setTest:function(rt){D||(rt?ne(n.STENCIL_TEST):Me(n.STENCIL_TEST))},setMask:function(rt){oe!==rt&&!D&&(n.stencilMask(rt),oe=rt)},setFunc:function(rt,ki,Si){($!==rt||ye!==ki||ce!==Si)&&(n.stencilFunc(rt,ki,Si),$=rt,ye=ki,ce=Si)},setOp:function(rt,ki,Si){(ee!==rt||we!==ki||ke!==Si)&&(n.stencilOp(rt,ki,Si),ee=rt,we=ki,ke=Si)},setLocked:function(rt){D=rt},setClear:function(rt){Mt!==rt&&(n.clearStencil(rt),Mt=rt)},reset:function(){D=!1,oe=null,$=null,ye=null,ce=null,ee=null,we=null,ke=null,Mt=null}}}const a=new t,r=new i,o=new s,l=new WeakMap,c=new WeakMap;let h={},f={},d={},u=new WeakMap,g=[],_=null,m=!1,p=null,b=null,v=null,x=null,y=null,E=null,C=null,S=new nt(0,0,0),w=0,L=!1,R=null,P=null,O=null,N=null,I=null;const B=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,K=0;const Q=n.getParameter(n.VERSION);Q.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(Q)[1]),F=K>=1):Q.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),F=K>=2);let ie=null,X={};const J=n.getParameter(n.SCISSOR_BOX),Te=n.getParameter(n.VIEWPORT),ze=new St().fromArray(J),Pe=new St().fromArray(Te);function Y(D,oe,$,ye){const ce=new Uint8Array(4),ee=n.createTexture();n.bindTexture(D,ee),n.texParameteri(D,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(D,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let we=0;we<$;we++)D===n.TEXTURE_3D||D===n.TEXTURE_2D_ARRAY?n.texImage3D(oe,0,n.RGBA,1,1,ye,0,n.RGBA,n.UNSIGNED_BYTE,ce):n.texImage2D(oe+we,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ce);return ee}const se={};se[n.TEXTURE_2D]=Y(n.TEXTURE_2D,n.TEXTURE_2D,1),se[n.TEXTURE_CUBE_MAP]=Y(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),se[n.TEXTURE_2D_ARRAY]=Y(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),se[n.TEXTURE_3D]=Y(n.TEXTURE_3D,n.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ne(n.DEPTH_TEST),r.setFunc(cs),Pt(!1),yt(Jl),ne(n.CULL_FACE),pt(Yi);function ne(D){h[D]!==!0&&(n.enable(D),h[D]=!0)}function Me(D){h[D]!==!1&&(n.disable(D),h[D]=!1)}function Ie(D,oe){return d[D]!==oe?(n.bindFramebuffer(D,oe),d[D]=oe,D===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=oe),D===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=oe),!0):!1}function Ce(D,oe){let $=g,ye=!1;if(D){$=u.get(oe),$===void 0&&($=[],u.set(oe,$));const ce=D.textures;if($.length!==ce.length||$[0]!==n.COLOR_ATTACHMENT0){for(let ee=0,we=ce.length;ee<we;ee++)$[ee]=n.COLOR_ATTACHMENT0+ee;$.length=ce.length,ye=!0}}else $[0]!==n.BACK&&($[0]=n.BACK,ye=!0);ye&&n.drawBuffers($)}function Ze(D){return _!==D?(n.useProgram(D),_=D,!0):!1}const Be={[An]:n.FUNC_ADD,[ff]:n.FUNC_SUBTRACT,[uf]:n.FUNC_REVERSE_SUBTRACT};Be[pf]=n.MIN,Be[mf]=n.MAX;const je={[gf]:n.ZERO,[yf]:n.ONE,[xf]:n.SRC_COLOR,[to]:n.SRC_ALPHA,[Ef]:n.SRC_ALPHA_SATURATE,[Mf]:n.DST_COLOR,[_f]:n.DST_ALPHA,[vf]:n.ONE_MINUS_SRC_COLOR,[io]:n.ONE_MINUS_SRC_ALPHA,[bf]:n.ONE_MINUS_DST_COLOR,[Sf]:n.ONE_MINUS_DST_ALPHA,[Tf]:n.CONSTANT_COLOR,[wf]:n.ONE_MINUS_CONSTANT_COLOR,[Af]:n.CONSTANT_ALPHA,[Rf]:n.ONE_MINUS_CONSTANT_ALPHA};function pt(D,oe,$,ye,ce,ee,we,ke,Mt,rt){if(D===Yi){m===!0&&(Me(n.BLEND),m=!1);return}if(m===!1&&(ne(n.BLEND),m=!0),D!==df){if(D!==p||rt!==L){if((b!==An||y!==An)&&(n.blendEquation(n.FUNC_ADD),b=An,y=An),rt)switch(D){case rs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eo:n.blendFunc(n.ONE,n.ONE);break;case Ql:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ec:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Qe("WebGLState: Invalid blending: ",D);break}else switch(D){case rs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case eo:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Ql:Qe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ec:Qe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Qe("WebGLState: Invalid blending: ",D);break}v=null,x=null,E=null,C=null,S.set(0,0,0),w=0,p=D,L=rt}return}ce=ce||oe,ee=ee||$,we=we||ye,(oe!==b||ce!==y)&&(n.blendEquationSeparate(Be[oe],Be[ce]),b=oe,y=ce),($!==v||ye!==x||ee!==E||we!==C)&&(n.blendFuncSeparate(je[$],je[ye],je[ee],je[we]),v=$,x=ye,E=ee,C=we),(ke.equals(S)===!1||Mt!==w)&&(n.blendColor(ke.r,ke.g,ke.b,Mt),S.copy(ke),w=Mt),p=D,L=!1}function Ge(D,oe){D.side===Gi?Me(n.CULL_FACE):ne(n.CULL_FACE);let $=D.side===Zt;oe&&($=!$),Pt($),D.blending===rs&&D.transparent===!1?pt(Yi):pt(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),a.setMask(D.colorWrite);const ye=D.stencilWrite;o.setTest(ye),ye&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),k(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ne(n.SAMPLE_ALPHA_TO_COVERAGE):Me(n.SAMPLE_ALPHA_TO_COVERAGE)}function Pt(D){R!==D&&(D?n.frontFace(n.CW):n.frontFace(n.CCW),R=D)}function yt(D){D!==lf?(ne(n.CULL_FACE),D!==P&&(D===Jl?n.cullFace(n.BACK):D===cf?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):Me(n.CULL_FACE),P=D}function jt(D){D!==O&&(F&&n.lineWidth(D),O=D)}function k(D,oe,$){D?(ne(n.POLYGON_OFFSET_FILL),(N!==oe||I!==$)&&(N=oe,I=$,r.getReversed()&&(oe=-oe),n.polygonOffset(oe,$))):Me(n.POLYGON_OFFSET_FILL)}function It(D){D?ne(n.SCISSOR_TEST):Me(n.SCISSOR_TEST)}function Xe(D){D===void 0&&(D=n.TEXTURE0+B-1),ie!==D&&(n.activeTexture(D),ie=D)}function dt(D,oe,$){$===void 0&&(ie===null?$=n.TEXTURE0+B-1:$=ie);let ye=X[$];ye===void 0&&(ye={type:void 0,texture:void 0},X[$]=ye),(ye.type!==D||ye.texture!==oe)&&(ie!==$&&(n.activeTexture($),ie=$),n.bindTexture(D,oe||se[D]),ye.type=D,ye.texture=oe)}function fe(){const D=X[ie];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function vt(){try{n.compressedTexImage2D(...arguments)}catch(D){Qe("WebGLState:",D)}}function A(){try{n.compressedTexImage3D(...arguments)}catch(D){Qe("WebGLState:",D)}}function M(){try{n.texSubImage2D(...arguments)}catch(D){Qe("WebGLState:",D)}}function z(){try{n.texSubImage3D(...arguments)}catch(D){Qe("WebGLState:",D)}}function Z(){try{n.compressedTexSubImage2D(...arguments)}catch(D){Qe("WebGLState:",D)}}function te(){try{n.compressedTexSubImage3D(...arguments)}catch(D){Qe("WebGLState:",D)}}function ae(){try{n.texStorage2D(...arguments)}catch(D){Qe("WebGLState:",D)}}function he(){try{n.texStorage3D(...arguments)}catch(D){Qe("WebGLState:",D)}}function q(){try{n.texImage2D(...arguments)}catch(D){Qe("WebGLState:",D)}}function j(){try{n.texImage3D(...arguments)}catch(D){Qe("WebGLState:",D)}}function ge(D){return f[D]!==void 0?f[D]:n.getParameter(D)}function _e(D,oe){f[D]!==oe&&(n.pixelStorei(D,oe),f[D]=oe)}function le(D){ze.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),ze.copy(D))}function re(D){Pe.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),Pe.copy(D))}function De(D,oe){let $=c.get(oe);$===void 0&&($=new WeakMap,c.set(oe,$));let ye=$.get(D);ye===void 0&&(ye=n.getUniformBlockIndex(oe,D.name),$.set(D,ye))}function Fe(D,oe){const ye=c.get(oe).get(D);l.get(oe)!==ye&&(n.uniformBlockBinding(oe,ye,D.__bindingPointIndex),l.set(oe,ye))}function et(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),r.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),h={},f={},ie=null,X={},d={},u=new WeakMap,g=[],_=null,m=!1,p=null,b=null,v=null,x=null,y=null,E=null,C=null,S=new nt(0,0,0),w=0,L=!1,R=null,P=null,O=null,N=null,I=null,ze.set(0,0,n.canvas.width,n.canvas.height),Pe.set(0,0,n.canvas.width,n.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:ne,disable:Me,bindFramebuffer:Ie,drawBuffers:Ce,useProgram:Ze,setBlending:pt,setMaterial:Ge,setFlipSided:Pt,setCullFace:yt,setLineWidth:jt,setPolygonOffset:k,setScissorTest:It,activeTexture:Xe,bindTexture:dt,unbindTexture:fe,compressedTexImage2D:vt,compressedTexImage3D:A,texImage2D:q,texImage3D:j,pixelStorei:_e,getParameter:ge,updateUBOMapping:De,uniformBlockBinding:Fe,texStorage2D:ae,texStorage3D:he,texSubImage2D:M,texSubImage3D:z,compressedTexSubImage2D:Z,compressedTexSubImage3D:te,scissor:le,viewport:re,reset:et}}function fy(n,e,t,i,s,a,r){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new it,h=new WeakMap,f=new Set;let d;const u=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,M){return g?new OffscreenCanvas(A,M):Wa("canvas")}function m(A,M,z){let Z=1;const te=vt(A);if((te.width>z||te.height>z)&&(Z=z/Math.max(te.width,te.height)),Z<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ae=Math.floor(Z*te.width),he=Math.floor(Z*te.height);d===void 0&&(d=_(ae,he));const q=M?_(ae,he):d;return q.width=ae,q.height=he,q.getContext("2d").drawImage(A,0,0,ae,he),Le("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+ae+"x"+he+")."),q}else return"data"in A&&Le("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),A;return A}function p(A){return A.generateMipmaps}function b(A){n.generateMipmap(A)}function v(A){return A.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?n.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function x(A,M,z,Z,te,ae=!1){if(A!==null){if(n[A]!==void 0)return n[A];Le("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let he;Z&&(he=e.get("EXT_texture_norm16"),he||Le("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=M;if(M===n.RED&&(z===n.FLOAT&&(q=n.R32F),z===n.HALF_FLOAT&&(q=n.R16F),z===n.UNSIGNED_BYTE&&(q=n.R8),z===n.UNSIGNED_SHORT&&he&&(q=he.R16_EXT),z===n.SHORT&&he&&(q=he.R16_SNORM_EXT)),M===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.R8UI),z===n.UNSIGNED_SHORT&&(q=n.R16UI),z===n.UNSIGNED_INT&&(q=n.R32UI),z===n.BYTE&&(q=n.R8I),z===n.SHORT&&(q=n.R16I),z===n.INT&&(q=n.R32I)),M===n.RG&&(z===n.FLOAT&&(q=n.RG32F),z===n.HALF_FLOAT&&(q=n.RG16F),z===n.UNSIGNED_BYTE&&(q=n.RG8),z===n.UNSIGNED_SHORT&&he&&(q=he.RG16_EXT),z===n.SHORT&&he&&(q=he.RG16_SNORM_EXT)),M===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RG8UI),z===n.UNSIGNED_SHORT&&(q=n.RG16UI),z===n.UNSIGNED_INT&&(q=n.RG32UI),z===n.BYTE&&(q=n.RG8I),z===n.SHORT&&(q=n.RG16I),z===n.INT&&(q=n.RG32I)),M===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RGB8UI),z===n.UNSIGNED_SHORT&&(q=n.RGB16UI),z===n.UNSIGNED_INT&&(q=n.RGB32UI),z===n.BYTE&&(q=n.RGB8I),z===n.SHORT&&(q=n.RGB16I),z===n.INT&&(q=n.RGB32I)),M===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(q=n.RGBA16UI),z===n.UNSIGNED_INT&&(q=n.RGBA32UI),z===n.BYTE&&(q=n.RGBA8I),z===n.SHORT&&(q=n.RGBA16I),z===n.INT&&(q=n.RGBA32I)),M===n.RGB&&(z===n.UNSIGNED_SHORT&&he&&(q=he.RGB16_EXT),z===n.SHORT&&he&&(q=he.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(q=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(q=n.R11F_G11F_B10F)),M===n.RGBA){const j=ae?Ha:Ye.getTransfer(te);z===n.FLOAT&&(q=n.RGBA32F),z===n.HALF_FLOAT&&(q=n.RGBA16F),z===n.UNSIGNED_BYTE&&(q=j===st?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&he&&(q=he.RGBA16_EXT),z===n.SHORT&&he&&(q=he.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(q=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(q=n.RGB5_A1)}return(q===n.R16F||q===n.R32F||q===n.RG16F||q===n.RG32F||q===n.RGBA16F||q===n.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function y(A,M){let z;return A?M===null||M===Di||M===Us?z=n.DEPTH24_STENCIL8:M===wi?z=n.DEPTH32F_STENCIL8:M===ks&&(z=n.DEPTH24_STENCIL8,Le("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Di||M===Us?z=n.DEPTH_COMPONENT24:M===wi?z=n.DEPTH_COMPONENT32F:M===ks&&(z=n.DEPTH_COMPONENT16),z}function E(A,M){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==Ft&&A.minFilter!==Wt?Math.log2(Math.max(M.width,M.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?M.mipmaps.length:1}function C(A){const M=A.target;M.removeEventListener("dispose",C),w(M),M.isVideoTexture&&h.delete(M),M.isHTMLTexture&&f.delete(M)}function S(A){const M=A.target;M.removeEventListener("dispose",S),R(M)}function w(A){const M=i.get(A);if(M.__webglInit===void 0)return;const z=A.source,Z=u.get(z);if(Z){const te=Z[M.__cacheKey];te.usedTimes--,te.usedTimes===0&&L(A),Object.keys(Z).length===0&&u.delete(z)}i.remove(A)}function L(A){const M=i.get(A);n.deleteTexture(M.__webglTexture);const z=A.source,Z=u.get(z);delete Z[M.__cacheKey],r.memory.textures--}function R(A){const M=i.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),i.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(M.__webglFramebuffer[Z]))for(let te=0;te<M.__webglFramebuffer[Z].length;te++)n.deleteFramebuffer(M.__webglFramebuffer[Z][te]);else n.deleteFramebuffer(M.__webglFramebuffer[Z]);M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer[Z])}else{if(Array.isArray(M.__webglFramebuffer))for(let Z=0;Z<M.__webglFramebuffer.length;Z++)n.deleteFramebuffer(M.__webglFramebuffer[Z]);else n.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&n.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&n.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let Z=0;Z<M.__webglColorRenderbuffer.length;Z++)M.__webglColorRenderbuffer[Z]&&n.deleteRenderbuffer(M.__webglColorRenderbuffer[Z]);M.__webglDepthRenderbuffer&&n.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const z=A.textures;for(let Z=0,te=z.length;Z<te;Z++){const ae=i.get(z[Z]);ae.__webglTexture&&(n.deleteTexture(ae.__webglTexture),r.memory.textures--),i.remove(z[Z])}i.remove(A)}let P=0;function O(){P=0}function N(){return P}function I(A){P=A}function B(){const A=P;return A>=s.maxTextures&&Le("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),P+=1,A}function F(A){const M=[];return M.push(A.wrapS),M.push(A.wrapT),M.push(A.wrapR||0),M.push(A.magFilter),M.push(A.minFilter),M.push(A.anisotropy),M.push(A.internalFormat),M.push(A.format),M.push(A.type),M.push(A.generateMipmaps),M.push(A.premultiplyAlpha),M.push(A.flipY),M.push(A.unpackAlignment),M.push(A.colorSpace),M.join()}function K(A,M){const z=i.get(A);if(A.isVideoTexture&&dt(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&z.__version!==A.version){const Z=A.image;if(Z===null)Le("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)Le("WebGLRenderer: Texture marked for update but image is incomplete");else{Me(z,A,M);return}}else A.isExternalTexture&&(z.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+M)}function Q(A,M){const z=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){Me(z,A,M);return}else A.isExternalTexture&&(z.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+M)}function ie(A,M){const z=i.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){Me(z,A,M);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+M)}function X(A,M){const z=i.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&z.__version!==A.version){Ie(z,A,M);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+M)}const J={[ho]:n.REPEAT,[Xi]:n.CLAMP_TO_EDGE,[fo]:n.MIRRORED_REPEAT},Te={[Ft]:n.NEAREST,[If]:n.NEAREST_MIPMAP_NEAREST,[qs]:n.NEAREST_MIPMAP_LINEAR,[Wt]:n.LINEAR,[dr]:n.LINEAR_MIPMAP_NEAREST,[Cn]:n.LINEAR_MIPMAP_LINEAR},ze={[Nf]:n.NEVER,[Ff]:n.ALWAYS,[kf]:n.LESS,[hl]:n.LEQUAL,[Uf]:n.EQUAL,[dl]:n.GEQUAL,[Of]:n.GREATER,[Bf]:n.NOTEQUAL};function Pe(A,M){if(M.type===wi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Wt||M.magFilter===dr||M.magFilter===qs||M.magFilter===Cn||M.minFilter===Wt||M.minFilter===dr||M.minFilter===qs||M.minFilter===Cn)&&Le("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(A,n.TEXTURE_WRAP_S,J[M.wrapS]),n.texParameteri(A,n.TEXTURE_WRAP_T,J[M.wrapT]),(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)&&n.texParameteri(A,n.TEXTURE_WRAP_R,J[M.wrapR]),n.texParameteri(A,n.TEXTURE_MAG_FILTER,Te[M.magFilter]),n.texParameteri(A,n.TEXTURE_MIN_FILTER,Te[M.minFilter]),M.compareFunction&&(n.texParameteri(A,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(A,n.TEXTURE_COMPARE_FUNC,ze[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Ft||M.minFilter!==qs&&M.minFilter!==Cn||M.type===wi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||i.get(M).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(A,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,s.getMaxAnisotropy())),i.get(M).__currentAnisotropy=M.anisotropy}}}function Y(A,M){let z=!1;A.__webglInit===void 0&&(A.__webglInit=!0,M.addEventListener("dispose",C));const Z=M.source;let te=u.get(Z);te===void 0&&(te={},u.set(Z,te));const ae=F(M);if(ae!==A.__cacheKey){te[ae]===void 0&&(te[ae]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,z=!0),te[ae].usedTimes++;const he=te[A.__cacheKey];he!==void 0&&(te[A.__cacheKey].usedTimes--,he.usedTimes===0&&L(M)),A.__cacheKey=ae,A.__webglTexture=te[ae].texture}return z}function se(A,M,z){return Math.floor(Math.floor(A/z)/M)}function ne(A,M,z,Z){const ae=A.updateRanges;if(ae.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,M.width,M.height,z,Z,M.data);else{ae.sort((_e,le)=>_e.start-le.start);let he=0;for(let _e=1;_e<ae.length;_e++){const le=ae[he],re=ae[_e],De=le.start+le.count,Fe=se(re.start,M.width,4),et=se(le.start,M.width,4);re.start<=De+1&&Fe===et&&se(re.start+re.count-1,M.width,4)===Fe?le.count=Math.max(le.count,re.start+re.count-le.start):(++he,ae[he]=re)}ae.length=he+1;const q=t.getParameter(n.UNPACK_ROW_LENGTH),j=t.getParameter(n.UNPACK_SKIP_PIXELS),ge=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,M.width);for(let _e=0,le=ae.length;_e<le;_e++){const re=ae[_e],De=Math.floor(re.start/4),Fe=Math.ceil(re.count/4),et=De%M.width,D=Math.floor(De/M.width),oe=Fe,$=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,et),t.pixelStorei(n.UNPACK_SKIP_ROWS,D),t.texSubImage2D(n.TEXTURE_2D,0,et,D,oe,$,z,Z,M.data)}A.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,q),t.pixelStorei(n.UNPACK_SKIP_PIXELS,j),t.pixelStorei(n.UNPACK_SKIP_ROWS,ge)}}function Me(A,M,z){let Z=n.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),M.isData3DTexture&&(Z=n.TEXTURE_3D);const te=Y(A,M),ae=M.source;t.bindTexture(Z,A.__webglTexture,n.TEXTURE0+z);const he=i.get(ae);if(ae.version!==he.__version||te===!0){if(t.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&M.image instanceof ImageBitmap)===!1){const $=Ye.getPrimaries(Ye.workingColorSpace),ye=M.colorSpace===ln?null:Ye.getPrimaries(M.colorSpace),ce=M.colorSpace===ln||$===ye?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce)}t.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment);let j=m(M.image,!1,s.maxTextureSize);j=fe(M,j);const ge=a.convert(M.format,M.colorSpace),_e=a.convert(M.type);let le=x(M.internalFormat,ge,_e,M.normalized,M.colorSpace,M.isVideoTexture);Pe(Z,M);let re;const De=M.mipmaps,Fe=M.isVideoTexture!==!0,et=he.__version===void 0||te===!0,D=ae.dataReady,oe=E(M,j);if(M.isDepthTexture)le=y(M.format===Pn,M.type),et&&(Fe?t.texStorage2D(n.TEXTURE_2D,1,le,j.width,j.height):t.texImage2D(n.TEXTURE_2D,0,le,j.width,j.height,0,ge,_e,null));else if(M.isDataTexture)if(De.length>0){Fe&&et&&t.texStorage2D(n.TEXTURE_2D,oe,le,De[0].width,De[0].height);for(let $=0,ye=De.length;$<ye;$++)re=De[$],Fe?D&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,re.width,re.height,ge,_e,re.data):t.texImage2D(n.TEXTURE_2D,$,le,re.width,re.height,0,ge,_e,re.data);M.generateMipmaps=!1}else Fe?(et&&t.texStorage2D(n.TEXTURE_2D,oe,le,j.width,j.height),D&&ne(M,j,ge,_e)):t.texImage2D(n.TEXTURE_2D,0,le,j.width,j.height,0,ge,_e,j.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){Fe&&et&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,le,De[0].width,De[0].height,j.depth);for(let $=0,ye=De.length;$<ye;$++)if(re=De[$],M.format!==yi)if(ge!==null)if(Fe){if(D)if(M.layerUpdates.size>0){const ce=Ac(re.width,re.height,M.format,M.type);for(const ee of M.layerUpdates){const we=re.data.subarray(ee*ce/re.data.BYTES_PER_ELEMENT,(ee+1)*ce/re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,ee,re.width,re.height,1,ge,we)}M.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,0,re.width,re.height,j.depth,ge,re.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,$,le,re.width,re.height,j.depth,0,re.data,0,0);else Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Fe?D&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,0,re.width,re.height,j.depth,ge,_e,re.data):t.texImage3D(n.TEXTURE_2D_ARRAY,$,le,re.width,re.height,j.depth,0,ge,_e,re.data)}else{Fe&&et&&t.texStorage2D(n.TEXTURE_2D,oe,le,De[0].width,De[0].height);for(let $=0,ye=De.length;$<ye;$++)re=De[$],M.format!==yi?ge!==null?Fe?D&&t.compressedTexSubImage2D(n.TEXTURE_2D,$,0,0,re.width,re.height,ge,re.data):t.compressedTexImage2D(n.TEXTURE_2D,$,le,re.width,re.height,0,re.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Fe?D&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,re.width,re.height,ge,_e,re.data):t.texImage2D(n.TEXTURE_2D,$,le,re.width,re.height,0,ge,_e,re.data)}else if(M.isDataArrayTexture)if(Fe){if(et&&t.texStorage3D(n.TEXTURE_2D_ARRAY,oe,le,j.width,j.height,j.depth),D)if(M.layerUpdates.size>0){const $=Ac(j.width,j.height,M.format,M.type);for(const ye of M.layerUpdates){const ce=j.data.subarray(ye*$/j.data.BYTES_PER_ELEMENT,(ye+1)*$/j.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ye,j.width,j.height,1,ge,_e,ce)}M.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,j.width,j.height,j.depth,ge,_e,j.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,le,j.width,j.height,j.depth,0,ge,_e,j.data);else if(M.isData3DTexture)Fe?(et&&t.texStorage3D(n.TEXTURE_3D,oe,le,j.width,j.height,j.depth),D&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,j.width,j.height,j.depth,ge,_e,j.data)):t.texImage3D(n.TEXTURE_3D,0,le,j.width,j.height,j.depth,0,ge,_e,j.data);else if(M.isFramebufferTexture){if(et)if(Fe)t.texStorage2D(n.TEXTURE_2D,oe,le,j.width,j.height);else{let $=j.width,ye=j.height;for(let ce=0;ce<oe;ce++)t.texImage2D(n.TEXTURE_2D,ce,le,$,ye,0,ge,_e,null),$>>=1,ye>>=1}}else if(M.isHTMLTexture){if("texElementImage2D"in n){const $=n.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),j.parentNode!==$){$.appendChild(j),f.add(M),$.onpaint=ke=>{const Mt=ke.changedElements;for(const rt of f)Mt.includes(rt.image)&&(rt.needsUpdate=!0)},$.requestPaint();return}const ye=0,ce=n.RGBA,ee=n.RGBA,we=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,ye,ce,ee,we,j),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(De.length>0){if(Fe&&et){const $=vt(De[0]);t.texStorage2D(n.TEXTURE_2D,oe,le,$.width,$.height)}for(let $=0,ye=De.length;$<ye;$++)re=De[$],Fe?D&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,ge,_e,re):t.texImage2D(n.TEXTURE_2D,$,le,ge,_e,re);M.generateMipmaps=!1}else if(Fe){if(et){const $=vt(j);t.texStorage2D(n.TEXTURE_2D,oe,le,$.width,$.height)}D&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ge,_e,j)}else t.texImage2D(n.TEXTURE_2D,0,le,ge,_e,j);p(M)&&b(Z),he.__version=ae.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function Ie(A,M,z){if(M.image.length!==6)return;const Z=Y(A,M),te=M.source;t.bindTexture(n.TEXTURE_CUBE_MAP,A.__webglTexture,n.TEXTURE0+z);const ae=i.get(te);if(te.version!==ae.__version||Z===!0){t.activeTexture(n.TEXTURE0+z);const he=Ye.getPrimaries(Ye.workingColorSpace),q=M.colorSpace===ln?null:Ye.getPrimaries(M.colorSpace),j=M.colorSpace===ln||he===q?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,M.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,M.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,j);const ge=M.isCompressedTexture||M.image[0].isCompressedTexture,_e=M.image[0]&&M.image[0].isDataTexture,le=[];for(let ee=0;ee<6;ee++)!ge&&!_e?le[ee]=m(M.image[ee],!0,s.maxCubemapSize):le[ee]=_e?M.image[ee].image:M.image[ee],le[ee]=fe(M,le[ee]);const re=le[0],De=a.convert(M.format,M.colorSpace),Fe=a.convert(M.type),et=x(M.internalFormat,De,Fe,M.normalized,M.colorSpace),D=M.isVideoTexture!==!0,oe=ae.__version===void 0||Z===!0,$=te.dataReady;let ye=E(M,re);Pe(n.TEXTURE_CUBE_MAP,M);let ce;if(ge){D&&oe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,et,re.width,re.height);for(let ee=0;ee<6;ee++){ce=le[ee].mipmaps;for(let we=0;we<ce.length;we++){const ke=ce[we];M.format!==yi?De!==null?D?$&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,0,0,ke.width,ke.height,De,ke.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,et,ke.width,ke.height,0,ke.data):Le("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,0,0,ke.width,ke.height,De,Fe,ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we,et,ke.width,ke.height,0,De,Fe,ke.data)}}}else{if(ce=M.mipmaps,D&&oe){ce.length>0&&ye++;const ee=vt(le[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,et,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(_e){D?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,le[ee].width,le[ee].height,De,Fe,le[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,et,le[ee].width,le[ee].height,0,De,Fe,le[ee].data);for(let we=0;we<ce.length;we++){const Mt=ce[we].image[ee].image;D?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,0,0,Mt.width,Mt.height,De,Fe,Mt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,et,Mt.width,Mt.height,0,De,Fe,Mt.data)}}else{D?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,De,Fe,le[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,et,De,Fe,le[ee]);for(let we=0;we<ce.length;we++){const ke=ce[we];D?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,0,0,De,Fe,ke.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,we+1,et,De,Fe,ke.image[ee])}}}p(M)&&b(n.TEXTURE_CUBE_MAP),ae.__version=te.version,M.onUpdate&&M.onUpdate(M)}A.__version=M.version}function Ce(A,M,z,Z,te,ae){const he=a.convert(z.format,z.colorSpace),q=a.convert(z.type),j=x(z.internalFormat,he,q,z.normalized,z.colorSpace),ge=i.get(M),_e=i.get(z);if(_e.__renderTarget=M,!ge.__hasExternalTextures){const le=Math.max(1,M.width>>ae),re=Math.max(1,M.height>>ae);te===n.TEXTURE_3D||te===n.TEXTURE_2D_ARRAY?t.texImage3D(te,ae,j,le,re,M.depth,0,he,q,null):t.texImage2D(te,ae,j,le,re,0,he,q,null)}t.bindFramebuffer(n.FRAMEBUFFER,A),Xe(M)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,te,_e.__webglTexture,0,It(M)):(te===n.TEXTURE_2D||te>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,te,_e.__webglTexture,ae),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ze(A,M,z){if(n.bindRenderbuffer(n.RENDERBUFFER,A),M.depthBuffer){const Z=M.depthTexture,te=Z&&Z.isDepthTexture?Z.type:null,ae=y(M.stencilBuffer,te),he=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Xe(M)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,It(M),ae,M.width,M.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,It(M),ae,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,ae,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,A)}else{const Z=M.textures;for(let te=0;te<Z.length;te++){const ae=Z[te],he=a.convert(ae.format,ae.colorSpace),q=a.convert(ae.type),j=x(ae.internalFormat,he,q,ae.normalized,ae.colorSpace);Xe(M)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,It(M),j,M.width,M.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,It(M),j,M.width,M.height):n.renderbufferStorage(n.RENDERBUFFER,j,M.width,M.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Be(A,M,z){const Z=M.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,A),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=i.get(M.depthTexture);if(te.__renderTarget=M,(!te.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),Z){if(te.__webglInit===void 0&&(te.__webglInit=!0,M.depthTexture.addEventListener("dispose",C)),te.__webglTexture===void 0){te.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,te.__webglTexture),Pe(n.TEXTURE_CUBE_MAP,M.depthTexture);const ge=a.convert(M.depthTexture.format),_e=a.convert(M.depthTexture.type);let le;M.depthTexture.format===Zi?le=n.DEPTH_COMPONENT24:M.depthTexture.format===Pn&&(le=n.DEPTH24_STENCIL8);for(let re=0;re<6;re++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,le,M.width,M.height,0,ge,_e,null)}}else K(M.depthTexture,0);const ae=te.__webglTexture,he=It(M),q=Z?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,j=M.depthTexture.format===Pn?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(M.depthTexture.format===Zi)Xe(M)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,q,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,j,q,ae,0);else if(M.depthTexture.format===Pn)Xe(M)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,j,q,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,j,q,ae,0);else throw new Error("Unknown depthTexture format")}function je(A){const M=i.get(A),z=A.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==A.depthTexture){const Z=A.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),Z){const te=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,Z.removeEventListener("dispose",te)};Z.addEventListener("dispose",te),M.__depthDisposeCallback=te}M.__boundDepthTexture=Z}if(A.depthTexture&&!M.__autoAllocateDepthBuffer)if(z)for(let Z=0;Z<6;Z++)Be(M.__webglFramebuffer[Z],A,Z);else{const Z=A.texture.mipmaps;Z&&Z.length>0?Be(M.__webglFramebuffer[0],A,0):Be(M.__webglFramebuffer,A,0)}else if(z){M.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[Z]),M.__webglDepthbuffer[Z]===void 0)M.__webglDepthbuffer[Z]=n.createRenderbuffer(),Ze(M.__webglDepthbuffer[Z],A,!1);else{const te=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=M.__webglDepthbuffer[Z];n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,ae)}}else{const Z=A.texture.mipmaps;if(Z&&Z.length>0?t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=n.createRenderbuffer(),Ze(M.__webglDepthbuffer,A,!1);else{const te=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=M.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,te,n.RENDERBUFFER,ae)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function pt(A,M,z){const Z=i.get(A);M!==void 0&&Ce(Z.__webglFramebuffer,A,A.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&je(A)}function Ge(A){const M=A.texture,z=i.get(A),Z=i.get(M);A.addEventListener("dispose",S);const te=A.textures,ae=A.isWebGLCubeRenderTarget===!0,he=te.length>1;if(he||(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=M.version,r.memory.textures++),ae){z.__webglFramebuffer=[];for(let q=0;q<6;q++)if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer[q]=[];for(let j=0;j<M.mipmaps.length;j++)z.__webglFramebuffer[q][j]=n.createFramebuffer()}else z.__webglFramebuffer[q]=n.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){z.__webglFramebuffer=[];for(let q=0;q<M.mipmaps.length;q++)z.__webglFramebuffer[q]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(he)for(let q=0,j=te.length;q<j;q++){const ge=i.get(te[q]);ge.__webglTexture===void 0&&(ge.__webglTexture=n.createTexture(),r.memory.textures++)}if(A.samples>0&&Xe(A)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let q=0;q<te.length;q++){const j=te[q];z.__webglColorRenderbuffer[q]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[q]);const ge=a.convert(j.format,j.colorSpace),_e=a.convert(j.type),le=x(j.internalFormat,ge,_e,j.normalized,j.colorSpace,A.isXRRenderTarget===!0),re=It(A);n.renderbufferStorageMultisample(n.RENDERBUFFER,re,le,A.width,A.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+q,n.RENDERBUFFER,z.__webglColorRenderbuffer[q])}n.bindRenderbuffer(n.RENDERBUFFER,null),A.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),Ze(z.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ae){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),Pe(n.TEXTURE_CUBE_MAP,M);for(let q=0;q<6;q++)if(M.mipmaps&&M.mipmaps.length>0)for(let j=0;j<M.mipmaps.length;j++)Ce(z.__webglFramebuffer[q][j],A,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+q,j);else Ce(z.__webglFramebuffer[q],A,M,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);p(M)&&b(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let q=0,j=te.length;q<j;q++){const ge=te[q],_e=i.get(ge);let le=n.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(le=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(le,_e.__webglTexture),Pe(le,ge),Ce(z.__webglFramebuffer,A,ge,n.COLOR_ATTACHMENT0+q,le,0),p(ge)&&b(le)}t.unbindTexture()}else{let q=n.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(q=A.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(q,Z.__webglTexture),Pe(q,M),M.mipmaps&&M.mipmaps.length>0)for(let j=0;j<M.mipmaps.length;j++)Ce(z.__webglFramebuffer[j],A,M,n.COLOR_ATTACHMENT0,q,j);else Ce(z.__webglFramebuffer,A,M,n.COLOR_ATTACHMENT0,q,0);p(M)&&b(q),t.unbindTexture()}A.depthBuffer&&je(A)}function Pt(A){const M=A.textures;for(let z=0,Z=M.length;z<Z;z++){const te=M[z];if(p(te)){const ae=v(A),he=i.get(te).__webglTexture;t.bindTexture(ae,he),b(ae),t.unbindTexture()}}}const yt=[],jt=[];function k(A){if(A.samples>0){if(Xe(A)===!1){const M=A.textures,z=A.width,Z=A.height;let te=n.COLOR_BUFFER_BIT;const ae=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(A),q=M.length>1;if(q)for(let ge=0;ge<M.length;ge++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);const j=A.texture.mipmaps;j&&j.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let ge=0;ge<M.length;ge++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(te|=n.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(te|=n.STENCIL_BUFFER_BIT)),q){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[ge]);const _e=i.get(M[ge]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,_e,0)}n.blitFramebuffer(0,0,z,Z,0,0,z,Z,te,n.NEAREST),l===!0&&(yt.length=0,jt.length=0,yt.push(n.COLOR_ATTACHMENT0+ge),A.depthBuffer&&A.resolveDepthBuffer===!1&&(yt.push(ae),jt.push(ae),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,jt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,yt))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),q)for(let ge=0;ge<M.length;ge++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,he.__webglColorRenderbuffer[ge]);const _e=i.get(M[ge]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,_e,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const M=A.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[M])}}}function It(A){return Math.min(s.maxSamples,A.samples)}function Xe(A){const M=i.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function dt(A){const M=r.render.frame;h.get(A)!==M&&(h.set(A,M),A.update())}function fe(A,M){const z=A.colorSpace,Z=A.format,te=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||z!==Va&&z!==ln&&(Ye.getTransfer(z)===st?(Z!==yi||te!==ni)&&Le("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Qe("WebGLTextures: Unsupported texture color space:",z)),M}function vt(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=O,this.getTextureUnits=N,this.setTextureUnits=I,this.setTexture2D=K,this.setTexture2DArray=Q,this.setTexture3D=ie,this.setTextureCube=X,this.rebindTextures=pt,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=Pt,this.updateMultisampleRenderTarget=k,this.setupDepthRenderbuffer=je,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Xe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function uy(n,e){function t(i,s=ln){let a;const r=Ye.getTransfer(s);if(i===ni)return n.UNSIGNED_BYTE;if(i===al)return n.UNSIGNED_SHORT_4_4_4_4;if(i===rl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Ah)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Rh)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Th)return n.BYTE;if(i===wh)return n.SHORT;if(i===ks)return n.UNSIGNED_SHORT;if(i===sl)return n.INT;if(i===Di)return n.UNSIGNED_INT;if(i===wi)return n.FLOAT;if(i===Ki)return n.HALF_FLOAT;if(i===Ch)return n.ALPHA;if(i===Ph)return n.RGB;if(i===yi)return n.RGBA;if(i===Zi)return n.DEPTH_COMPONENT;if(i===Pn)return n.DEPTH_STENCIL;if(i===Ih)return n.RED;if(i===ol)return n.RED_INTEGER;if(i===On)return n.RG;if(i===ll)return n.RG_INTEGER;if(i===cl)return n.RGBA_INTEGER;if(i===Ca||i===Pa||i===Ia||i===La)if(r===st)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===Ca)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Pa)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ia)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===La)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===Ca)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Pa)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ia)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===La)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===uo||i===po||i===mo||i===go)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===uo)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===po)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===mo)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===go)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===yo||i===xo||i===vo||i===_o||i===So||i===Fa||i===Mo)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(i===yo||i===xo)return r===st?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===vo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(i===_o)return a.COMPRESSED_R11_EAC;if(i===So)return a.COMPRESSED_SIGNED_R11_EAC;if(i===Fa)return a.COMPRESSED_RG11_EAC;if(i===Mo)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===bo||i===Eo||i===To||i===wo||i===Ao||i===Ro||i===Co||i===Po||i===Io||i===Lo||i===Do||i===No||i===ko||i===Uo)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(i===bo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Eo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===To)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===wo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ao)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Ro)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Co)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Po)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Io)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Lo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Do)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===No)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===ko)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Uo)return r===st?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Oo||i===Bo||i===Fo)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(i===Oo)return r===st?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Bo)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Fo)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===zo||i===Vo||i===za||i===Ho)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(i===zo)return a.COMPRESSED_RED_RGTC1_EXT;if(i===Vo)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===za)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ho)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Us?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const py=`
void main() {
...
`);let i=90;t.forEach(s=>{const a=Math.floor((this.canvas.width-40)/7);for(let r=0;r<s.length;r+=a)this.ctx.fillText(s.substring(r,r+a),20,i),i+=18})}loop(){if(!this.active)return;const e=performance.now();if(this.lastTime=e,this.fpsFrameCount++,e-this.fpsLastTick>=1e3){this.currentFPS=Math.round(this.fpsFrameCount*1e3/(e-this.fpsLastTick)),this.fpsFrameCount=0,this.fpsLastTick=e;const t=document.getElementById("fps-counter");t&&this.settings&&this.settings.showFps&&(t.innerText=`FPS: ${this.currentFPS}`)}try{this.update(e),this.render()}catch(t){console.error("Game Loop Crash:",t),this.drawErrorOverlay(t),this.active=!1;return}requestAnimationFrame(()=>this.loop())}triggerHitmarker(e,t,i,s){this.activeHitmarkers.push({x:e,y:t,age:0,duration:200,isHeadshot:!!s}),this.floatingNumbers.push({x:e,y:t-10,damage:i,age:0,duration:800,isHeadshot:!!s})}registerLocalPlayerKill(e){if(e-this.lastKillTime<4e3?this.multiKillCount++:this.multiKillCount=1,this.lastKillTime=e,this.multiKillCount>=2){let t="DOUBLE KILL!";if(this.multiKillCount===3?t="TRIPLE KILL!":this.multiKillCount>3&&(t="RAMPAGE!"),this.combatBanner={text:t,timer:3,scale:2},this.sound)try{this.sound.playHighBeep()}catch(i){console.warn(i)}}}update(e){this.lastUpdateTime||(this.lastUpdateTime=e);const t=e-this.lastUpdateTime;this.lastUpdateTime=e;const i=Math.max(1,Math.min(150,t));if(this.dtFactor=i/16.67,this.combatBanner&&(this.combatBanner.timer-=i/1e3,this.combatBanner.timer<=0&&(this.combatBanner=null)),this.activeMinigame){this.activeMinigame.timer-=i/1e3;const v=document.getElementById("minigame-timer-bar");v&&(v.style.width=`${Math.max(0,this.activeMinigame.timer/4*100)}%`),this.activeMinigame.timer<=0&&this.failHackingMinigame()}let s=null;this.map&&this.map.terminals&&this.localPlayer&&this.localPlayer.health>0&&(s=this.map.terminals.find(v=>!v.hacked&&Math.hypot(this.localPlayer.x-v.x,this.localPlayer.y-v.y)<55));const a=document.getElementById("hud-interaction-prompt");if(s&&this.gameState==="playing"?(a&&(a.style.display="block",a.innerText=this.keys.e?`HACKING... ${Math.round(this.hackingProgress)}%`:"HOLD [E] TO HACK TERMINAL"),this.keys.e&&!this.activeMinigame?(this.localPlayer.vx=0,this.localPlayer.vy=0,this.hackingProgress||(this.hackingProgress=0),this.hackingProgress+=i*.08,this.hackingProgress>=100&&(this.hackingProgress=0,this.startHackingMinigame(s))):this.activeMinigame||(this.hackingProgress=Math.max(0,(this.hackingProgress||0)-i*.1))):(a&&!this.activeMinigame&&(a.style.display="none"),this.hackingProgress=0),this.matchMode==="sabotage"&&(this.ventCooldown>0&&(this.ventCooldown=Math.max(0,this.ventCooldown-i/1e3)),this.activeTask&&(this.sweepAngle+=.06*this.dtFactor),this.tasks.forEach(v=>{if(v.alarmActive){v.alarmTimer-=i/1e3;const x=Math.hypot(this.localPlayer.x-v.x,this.localPlayer.y-v.y);try{this.sound.playAlarmForTask(v.id,x)}catch{}if(v.alarmTimer<=0){v.alarmActive=!1,v.lastBeepTime=0;try{this.sound.stopAlarmForTask(v.id)}catch{}}}else try{this.sound.stopAlarmForTask(v.id)}catch{}})),this.gameState==="replay"){if(this.replayIndex+=this.dtFactor,Math.floor(this.replayIndex)>=this.replayFrames.length&&this.postReplayCallback){const v=this.postReplayCallback;this.postReplayCallback=null,v()}return}if(this.pollGamepad(),this.gameState==="countdown"){const v=(e-this.countdownStart)/1e3,x=3-Math.floor(v);if(x!==this.countdownTimer&&x>=0){this.countdownTimer=x;try{this.sound.playMetallicClick(0,1e3,.05,.2)}catch{}}if(x>0){const y=document.getElementById("hud-status");y&&(y.innerText=`DEPLOYING IN ${x}...`)}else{try{this.sound.playMetallicClick(0,2e3,.15,.35)}catch{}this.startRoundAction()}}(this.gameState==="playing"||this.gameState==="countdown")&&(this.localPlayer.update(this.keys,this.mouse,this.map,this.sound,e,null,this.localPlayer),this.localPlayer.justDashed&&(this.localPlayer.justDashed=!1,this.particles.spawnDashParticles(this.localPlayer.x,this.localPlayer.y,this.localPlayer.angle,this.localPlayer.colorTheme)),this.mode==="offline"?this.players.forEach(v=>{if(v.isBot){const x=v.team===1?2:1,y=this.players.filter(E=>E.health>0&&E.team===x);y.length>0?(y.sort((E,C)=>Math.hypot(v.x-E.x,v.y-E.y)-Math.hypot(v.x-C.x,v.y-C.y)),v.update(null,null,this.map,this.sound,e,y[0],this.localPlayer)):v.update(null,null,this.map,this.sound,e,null,this.localPlayer)}}):this.network.interpolateOpponents(),this.players.forEach(v=>{if(v!==this.localPlayer&&v.justDashed&&(v.justDashed=!1,this.particles.spawnDashParticles(v.x,v.y,v.angle,v.colorTheme),this.sound)){const x=Math.hypot(v.x-this.localPlayer.x,v.y-this.localPlayer.y);this.sound.playDashSound(x)}}),this.localPlayer.checkPickups(this.map,this.sound),this.mode==="offline"&&this.players.forEach(v=>{v.isBot&&v.checkPickups(this.map,this.sound)}),this.players.forEach(v=>{if(this.gameState==="playing"&&v.throwFlashbangRequest&&v.flashGrenades>0){v.throwFlashbangRequest=!1,v.flashGrenades--,v.isLocal&&!v.isBot&&v.updateHUD();const x=11,y=Math.cos(v.angle)*x,E=Math.sin(v.angle)*x,C=new Qc(v.x,v.y,y,E,v.id);this.grenades.push(C);try{this.sound.playMetallicClick(0,1500,.08,.2)}catch{}this.mode==="online"&&v.isLocal&&this.socket.emit("throw-grenade",{x:v.x,y:v.y,vx:y,vy:E})}else v.throwFlashbangRequest=!1}));const r=this.devCheatActive&&this.localPlayer.aimbotHasLOS;if(this.gameState==="playing"&&(this.mouse.clicked||r)&&!this.localPlayer.isReloading){const v=this.localPlayer.weapon.type==="Automatic"||r,x=e-this.localPlayer.lastFiredTime;if(v||x>this.localPlayer.weapon.fireRate){const y=this.localPlayer.shoot(e,this.sound);if(y){if(window.MatchStats.shotsFired+=y.pellets||1,this.shakeCamera(y.recoil*.7),this.particles.spawnGunCasing(this.localPlayer.x,this.localPlayer.y,this.localPlayer.angle,this.localPlayer.weaponKey),y.pellets&&y.pellets>1)for(let E=0;E<y.pellets;E++)this.bullets.push(new ya(y));else this.bullets.push(new ya(y));this.mode==="online"&&this.network.sendShoot(y),v||(this.mouse.clicked=!1)}}}for(let v=this.bullets.length-1;v>=0;v--){const x=this.bullets[v];x.update(this.map,this.players,this.particles,this.sound,this.dtFactor),x.active||(x.playerId===this.localPlayer.id&&window.MatchStats.hitsRegistered++,this.bullets.splice(v,1))}for(let v=this.grenades.length-1;v>=0;v--){const x=this.grenades[v];if(x.update(this.map,e),!x.active){this.particles.spawnFlashbangBurst(x.x,x.y);const y=Math.hypot(this.localPlayer.x-x.x,this.localPlayer.y-x.y);this.sound.playFlashbangExplosion(y),y<800&&this.shakeCamera(Math.max(1,15*(1-y/800))),this.players.forEach(E=>{if(E.health<=0)return;Math.hypot(E.x-x.x,E.y-x.y)<380&&E.checkLineOfSight(this.map,x.x,x.y,E.x,E.y)&&(E.flashAlpha=1,E.isLocal&&E.updateHUD())}),this.grenades.splice(v,1)}}this.particles.update(this.map);for(let v=this.activeHitmarkers.length-1;v>=0;v--){const x=this.activeHitmarkers[v];x.age+=i,x.age>=x.duration&&this.activeHitmarkers.splice(v,1)}for(let v=this.floatingNumbers.length-1;v>=0;v--){const x=this.floatingNumbers[v];x.age+=i,x.y-=1*this.dtFactor,x.age>=x.duration&&this.floatingNumbers.splice(v,1)}this.players.forEach(v=>{v.health<=0&&!v.isDeadLogged&&(v.isDeadLogged=!0,this.onKillFeed&&this.onKillFeed("Eliminated",v.name,v.weaponKey))});const o=this.players.filter(v=>v.team===this.localPlayer.team),l=o.reduce((v,x)=>{let y=x.health;return x.isLocal&&this.devCheatActive&&(y=Math.round(y/2)),v+y},0)/o.length,c=document.getElementById("hud-self-hp");c&&(c.style.width=`${Math.max(0,l)}%`);const h=document.getElementById("hud-self-hp-text");h&&(h.innerText=Math.round(Math.max(0,l)));const f=this.localPlayer.team===1?2:1,d=this.players.filter(v=>v.team===f),u=d.reduce((v,x)=>v+x.health,0)/d.length,g=document.getElementById("hud-opponent-hp");if(g&&(g.style.width=`${Math.max(0,u)}%`),this.zone.active&&this.gameState==="playing"){this.zone.currentRadius>this.zone.targetRadius&&(this.zone.currentRadius=Math.max(this.zone.targetRadius,this.zone.currentRadius-this.zone.shrinkSpeed*this.dtFactor));const v=e;v-this.zone.lastDamageTick>=1e3&&(this.zone.lastDamageTick=v,this.players.forEach(x=>{if(x.health<=0||this.mode==="online"&&!x.isLocal)return;const y=x.x-this.zone.centerX,E=x.y-this.zone.centerY;if(Math.sqrt(y*y+E*E)>this.zone.currentRadius&&(x.takeDamage(this.zone.damage,this.sound),x.isLocal&&!x.isBot&&(x.showTextNotification&&x.showTextNotification("-20 ZONE DAMAGE"),this.mode==="online"&&this.socket))){const w=this.devCheatActive?Math.round(x.health/2):x.health;this.socket.emit("sync-health",{playerId:x.id,health:w})}}))}if(this.gameState==="playing"){const v=this.players.some(y=>y.health>0&&y.team===1),x=this.players.some(y=>y.health>0&&y.team===2);v&&!x?this.mode==="offline"&&this.endRound(1,"eliminated"):!v&&x?this.mode==="offline"&&this.endRound(2,"eliminated"):!v&&!x&&this.mode==="offline"&&this.endRound(null,"both dead")}this.gameState==="playing"&&this.players.forEach(v=>{if(v.health<=0||v.health>=v.maxHealth)return;const x=this.map.checkZone(v.x,v.y);x&&x.type==="healing"&&(v.health=Math.min(v.maxHealth,v.health+x.healRate),v.isLocal&&!v.isBot&&v.updateHUD())});const _=.25,m=this.localPlayer.x+(this.mouse.x-this.canvas.width/2)*_,p=this.localPlayer.y+(this.mouse.y-this.canvas.height/2)*_,b=1-Math.pow(1-.085,this.dtFactor);if(this.camera.x+=(m-this.camera.x)*b,this.camera.y+=(p-this.camera.y)*b,this.cameraShake>.1?(this.camera.shakeX=(Math.random()-.5)*this.cameraShake,this.camera.shakeY=(Math.random()-.5)*this.cameraShake,this.cameraShake*=Math.pow(.88,this.dtFactor)):(this.camera.shakeX=0,this.camera.shakeY=0,this.cameraShake=0),this.gameState==="playing"){const v=this.keys.shift,x=document.getElementById("sprint-tip-popup");v?(this.lastSprintTime=e,this.sprintTipVisible&&(this.sprintTipVisible=!1,x&&(x.style.display="none"))):this.localPlayer&&(Math.abs(this.localPlayer.vx)>.2||Math.abs(this.localPlayer.vy)>.2)?e-this.lastSprintTime>9e3&&(this.sprintTipVisible||(this.sprintTipVisible=!0,x&&(x.style.display="flex"))):this.lastSprintTime=e}if(this.mode==="online"&&(this.gameState==="playing"||this.gameState==="countdown")&&this.network.sendState(e),this.gameState==="playing"&&e-this.lastSnapshotTime>=1e3/60){this.lastSnapshotTime=e;const v={players:this.players.map(x=>({id:x.id,x:x.x,y:x.y,angle:x.angle,health:x.health,maxHealth:x.maxHealth,weaponKey:x.weaponKey,muzzleFlash:x.muzzleFlash,isLocal:x.isLocal,isBot:x.isBot,isTeammate:x.isTeammate,color:x.colorTheme,name:x.name,flashlightActive:x.flashlightActive,flashAlpha:x.flashAlpha,radius:x.radius})),bullets:this.bullets.map(x=>({x:x.x,y:x.y,prevX:x.prevX,prevY:x.prevY,angle:x.angle,playerId:x.playerId,active:x.active,weaponKey:x.weaponKey})),grenades:this.grenades.map(x=>({x:x.x,y:x.y})),particles:this.particles.particles.map(x=>({x:x.x,y:x.y,type:x.type,angle:x.angle,size:x.size,color:x.color,life:x.life})),decals:this.particles.decals.map(x=>({x:x.x,y:x.y,type:x.type,size:x.size,color:x.color,angle:x.angle,scaleX:x.scaleX,scaleY:x.scaleY})),camera:{x:this.camera.x,y:this.camera.y},brokenLightOn:this.map.ambientLights.brokenCeiling?this.map.ambientLights.brokenCeiling.on:!0};this.replayFrames.push(v),this.replayFrames.length>300&&this.replayFrames.shift()}}startReplay(e){const t=this.players.some(i=>i.health<=0);if(this.replayFrames&&this.replayFrames.length>0&&t){this.gameState="replay",this.replayIndex=0,this.postReplayCallback=e;const i=document.getElementById("hud-status");i&&(i.innerText="● REPLAY / KILLCAM",i.style.color="#ff3c3c")}else e()}drawSnapshotPlayer(e,t){if(this.ctx.save(),t){this.ctx.fillStyle="rgba(180, 0, 0, 0.35)",this.ctx.beginPath(),this.ctx.ellipse(e.x,e.y,26,22,0,0,Math.PI*2),this.ctx.fill(),dn.ready&&(this.ctx.save(),this.ctx.translate(e.x,e.y),this.ctx.rotate(e.angle+Math.PI/2),this.ctx.globalAlpha=.55,dn.draw(this.ctx,e.id+"_dead",0,0,0,0,!1,e.isLocal?"blue":"red"),this.ctx.restore()),this.ctx.restore();return}if(this.settings.laser&&e.isLocal&&this.matchMode!=="sabotage"){let c=e.x+Math.cos(e.angle)*1200,h=e.y+Math.sin(e.angle)*1200;const f=this.map.getLineIntersection({x:e.x,y:e.y},{x:c,y:h});f&&(c=f.x,h=f.y),this.ctx.save(),this.ctx.strokeStyle=e.isLocal?"rgba(102, 252, 241, 0.5)":"rgba(255, 60, 60, 0.5)",this.ctx.lineWidth=1.2,this.ctx.beginPath(),this.ctx.moveTo(e.x,e.y),this.ctx.lineTo(c,h),this.ctx.stroke();const d=e.isLocal?"#66fcf1":"#ff3c3c",u=this.ctx.createRadialGradient(c,h,1,c,h,6);u.addColorStop(0,"#ffffff"),u.addColorStop(.3,d),u.addColorStop(1,"rgba(0, 0, 0, 0)"),this.ctx.fillStyle=u,this.ctx.beginPath(),this.ctx.arc(c,h,6,0,Math.PI*2),this.ctx.fill(),this.ctx.restore()}const i=e.muzzleFlash>.1;if(!dn.draw(this.ctx,e.id,e.x,e.y,e.angle,0,i,e.isLocal?"blue":"red")){this.ctx.save(),this.ctx.translate(e.x,e.y),this.ctx.rotate(e.angle);const l={cyan:{body:"#3ba39f",armor:"#16202c",helmet:"#66fcf1"},green:{body:"#39db14",armor:"#133d07",helmet:"#5eff39"},purple:{body:"#9d3bff",armor:"#20083c",helmet:"#c47aff"},orange:{body:"#ff7f3b",armor:"#3f1b07",helmet:"#ff9d7a"},yellow:{body:"#ffd700",armor:"#3a3000",helmet:"#ffea70"},red:{body:"#ff3c3c",armor:"#3a0707",helmet:"#ff7a7a"}},c=l[e.color]||l[e.isLocal?"cyan":"red"],h=c.body,f=c.armor,d=c.helmet;let u=18,g=4;e.weaponKey==="rifle"&&(u=24,g=5),e.weaponKey==="shotgun"&&(u=22,g=6),e.weaponKey==="sniper"&&(u=32,g=4),e.weaponKey==="smg"&&(u=16,g=4),e.weaponKey==="lmg"&&(u=26,g=7),e.weaponKey==="dmr"&&(u=28,g=5),e.weaponKey==="knife"&&(u=10,g=2),this.ctx.fillStyle="#444",this.ctx.strokeStyle="#000",this.ctx.lineWidth=1,this.ctx.fillRect(10,-g/2,u,g),this.ctx.strokeRect(10,-g/2,u,g),this.ctx.fillStyle=f,this.ctx.strokeStyle="#000",this.ctx.lineWidth=1.5,this.ctx.beginPath(),this.ctx.arc(8,-10,5,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.beginPath(),this.ctx.arc(14,6,5,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle=h,this.ctx.beginPath(),this.ctx.ellipse(0,0,18,21,0,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle=f,this.ctx.beginPath(),this.ctx.ellipse(-3,0,14,16,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle=d,this.ctx.beginPath(),this.ctx.arc(-2,0,8,0,Math.PI*2),this.ctx.fill(),this.ctx.stroke(),this.ctx.fillStyle="#111",this.ctx.fillRect(1,-5,3,10),this.ctx.restore()}this.ctx.save(),this.ctx.translate(e.x,e.y),this.ctx.rotate(e.angle),this.ctx.fillStyle=e.weaponKey==="knife"?"#b0b8c0":"#333",this.ctx.strokeStyle="rgba(0,0,0,0.7)",this.ctx.lineWidth=1;let a=18,r=3;if(e.weaponKey==="rifle"&&(a=26,r=4),e.weaponKey==="shotgun"&&(a=22,r=5),e.weaponKey==="sniper"&&(a=36,r=3),e.weaponKey==="smg"&&(a=16,r=3),e.weaponKey==="lmg"&&(a=28,r=5),e.weaponKey==="dmr"&&(a=30,r=4),e.weaponKey==="knife"&&(a=10,r=2),this.ctx.fillRect(12,-r/2,a,r),this.ctx.strokeRect(12,-r/2,a,r),e.muzzleFlash>0){this.ctx.save(),this.ctx.translate(12+a,0);const l=this.ctx.createRadialGradient(0,0,2,0,0,16);l.addColorStop(0,"rgba(255, 255, 255, 1.0)"),l.addColorStop(.3,"rgba(255, 220, 0, 0.9)"),l.addColorStop(.7,"rgba(255, 80, 0, 0.5)"),l.addColorStop(1,"rgba(255, 0, 0, 0.0)"),this.ctx.fillStyle=l,this.ctx.beginPath(),this.ctx.arc(0,0,16,0,Math.PI*2),this.ctx.fill(),this.ctx.restore()}this.ctx.restore(),this.ctx.save(),this.ctx.textAlign="center";const o=e.isLocal?"#66fcf1":e.isTeammate?"#39db14":"#ff3c3c";if(this.ctx.fillStyle=o,this.ctx.font="10px Orbitron",this.ctx.fillText(e.name.toUpperCase(),e.x,e.y-30),!e.isLocal&&e.health>0){this.ctx.fillStyle="rgba(0,0,0,0.5)",this.ctx.fillRect(e.x-20,e.y-26,40,4);const l=e.isTeammate?"#39db14":"#ff3c3c";this.ctx.fillStyle=l,this.ctx.fillRect(e.x-20,e.y-26,40*(e.health/e.maxHealth),4)}this.ctx.restore(),this.ctx.restore()}render(){let e=null;if(this.gameState==="replay"){const y=Math.min(this.replayFrames.length-1,Math.floor(this.replayIndex));e=this.replayFrames[y]}if(this.gameState==="replay"&&!e)return;this.ctx.fillStyle="#06070a",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height);const t=1920,i=1080,s=this.canvas.width/t,a=this.canvas.height/i,r=Math.min(s,a);this.zoom=Math.max(.5,Math.min(1.35,r)),this.ctx.save(),this.ctx.translate(this.canvas.width/2,this.canvas.height/2),this.ctx.scale(this.zoom,this.zoom);const o=e?e.camera.x:this.camera.x,l=e?e.camera.y:this.camera.y,c=e?0:this.camera.shakeX,h=e?0:this.camera.shakeY,f=-o+c,d=-l+h;this.ctx.translate(f,d);const u=e?e.players:this.players,g=e?e.bullets:this.bullets,_=e?e.brokenLightOn:this.map.ambientLights.brokenCeiling?this.map.ambientLights.brokenCeiling.on:!0;this.map.ambientLights.brokenCeiling&&(this.map.ambientLights.brokenCeiling.on=_),u.forEach(y=>{y.health>0&&y.flashlightActive?y.lightPoly=this.map.computeVisibilityPolygon(y.x,y.y,700,y.angle,65*Math.PI/180):y.lightPoly=null}),e?e.decals.forEach(y=>{this.ctx.save(),this.ctx.translate(y.x,y.y),this.ctx.rotate(y.angle),this.ctx.globalAlpha=y.type==="blood"?.75:.9,y.type==="blood"?(this.ctx.fillStyle=y.color,this.ctx.beginPath(),this.ctx.ellipse(0,0,y.size*y.scaleX,y.size*y.scaleY,0,0,Math.PI*2),this.ctx.fill()):y.type==="casing"?(this.ctx.fillStyle="#b5921c",this.ctx.fillRect(-y.size,-y.size/2,y.size*2,y.size)):y.type==="splinter"&&(this.ctx.fillStyle="#6e441c",this.ctx.fillRect(-y.size,-y.size/3,y.size*1.5,y.size*.7)),this.ctx.restore()}):this.particles.drawDecals(this.ctx);const m=e?e.players.find(y=>y.isLocal):this.localPlayer;if(this.map.draw(this.ctx,this.settings,u,m,g),u.forEach(y=>{y.health<=0&&(e?this.drawSnapshotPlayer(y,!0):y.draw(this.ctx))}),u.forEach(y=>{if(y.health<=0)return;let E=!0;if(this.settings.shadows&&m&&m.health>0&&!y.isLocal){const C=m.flashlightActive&&m.lightPoly&&this.isPointInPolygon({x:y.x,y:y.y},m.lightPoly),S=!this.map.getLineIntersection({x:m.x,y:m.y},{x:y.x,y:y.y}),w=this.map.isPointInAmbientLight(y.x,y.y,y.radius||18);E=C||y.isTeammate||y.flashlightActive&&S||w&&S}E&&(e?this.drawSnapshotPlayer(y,!1):y.draw(this.ctx,this.settings,this.map))}),m&&m.health>0&&(this.ctx.save(),this.ctx.translate(m.x,m.y),this.ctx.strokeStyle="rgba(102, 252, 241, 0.15)",this.ctx.lineWidth=1,this.ctx.setLineDash([4,8]),this.ctx.beginPath(),this.ctx.arc(0,0,32,Date.now()/1500,Date.now()/1500+Math.PI*2),this.ctx.stroke(),this.ctx.restore()),this.ctx.save(),this.ctx.globalCompositeOperation="lighter",e?(e.bullets.forEach(y=>{if(y.active){if(this.ctx.save(),y.weaponKey==="knife")this.ctx.lineWidth=3.5,this.ctx.lineCap="round",this.ctx.strokeStyle="rgba(230, 235, 255, 0.85)",this.ctx.shadowColor="#66fcf1",this.ctx.shadowBlur=6,this.ctx.beginPath(),this.ctx.arc(y.x,y.y,18,y.angle-.6,y.angle+.6),this.ctx.stroke();else{this.ctx.lineWidth=2.5,this.ctx.lineCap="round";const E=y.playerId===(m==null?void 0:m.id),C=this.ctx.createLinearGradient(y.prevX,y.prevY,y.x,y.y);E?(C.addColorStop(0,"rgba(102, 252, 241, 0.0)"),C.addColorStop(1,"rgba(102, 252, 241, 1.0)"),this.ctx.strokeStyle=C,this.ctx.shadowColor="#66fcf1"):(C.addColorStop(0,"rgba(255, 60, 60, 0.0)"),C.addColorStop(1,"rgba(255, 60, 60, 1.0)"),this.ctx.strokeStyle=C,this.ctx.shadowColor="#ff3c3c"),this.ctx.shadowBlur=4,this.ctx.beginPath(),this.ctx.moveTo(y.prevX,y.prevY),this.ctx.lineTo(y.x,y.y),this.ctx.stroke()}this.ctx.restore()}}),e.particles.forEach(y=>{this.ctx.save(),this.ctx.globalAlpha=Math.max(0,y.life),y.type==="casing"?(this.ctx.translate(y.x,y.y),this.ctx.rotate(y.angle),this.ctx.fillStyle="#d4af37",this.ctx.strokeStyle="#996515",this.ctx.lineWidth=.5,this.ctx.fillRect(-y.size,-y.size/2,y.size*2,y.size),this.ctx.strokeRect(-y.size,-y.size/2,y.size*2,y.size)):y.type==="splinter"?(this.ctx.translate(y.x,y.y),this.ctx.rotate(y.angle),this.ctx.fillStyle="#8b5a2b",this.ctx.beginPath(),this.ctx.moveTo(-y.size,0),this.ctx.lineTo(y.size,-y.size/2),this.ctx.lineTo(y.size/2,y.size/2),this.ctx.closePath(),this.ctx.fill()):y.type==="blood"?(this.ctx.fillStyle=y.color,this.ctx.beginPath(),this.ctx.arc(y.x,y.y,y.size,0,Math.PI*2),this.ctx.fill()):(this.ctx.fillStyle=y.color,(y.color.startsWith("#66fc")||y.color.startsWith("#ff3c"))&&(this.ctx.shadowColor=y.color,this.ctx.shadowBlur=4),this.ctx.beginPath(),this.ctx.arc(y.x,y.y,y.size*y.life,0,Math.PI*2),this.ctx.fill()),this.ctx.restore()})):(this.bullets.forEach(y=>y.draw(this.ctx)),this.particles.drawParticles(this.ctx)),this.ctx.restore(),e&&e.grenades?e.grenades.forEach(y=>{this.ctx.save(),this.ctx.beginPath(),this.ctx.arc(y.x,y.y,6,0,Math.PI*2),this.ctx.fillStyle="#2d332f",this.ctx.strokeStyle="#66fcf1",this.ctx.lineWidth=1.5,this.ctx.fill(),this.ctx.stroke(),this.ctx.restore()}):this.grenades&&this.grenades.forEach(y=>y.draw(this.ctx)),!e&&this.zone&&this.zone.active){const y=this.zone,E=Date.now(),C=Math.sin(E/300)*.15+.85;this.ctx.save(),this.ctx.beginPath(),this.ctx.rect(-100,-100,this.mapWidth+200,this.mapHeight+200),this.ctx.arc(y.centerX,y.centerY,y.currentRadius,0,Math.PI*2,!0),this.ctx.fillStyle=`rgba(255, 30, 30, ${.12*C})`,this.ctx.fill("evenodd"),this.ctx.beginPath(),this.ctx.arc(y.centerX,y.centerY,y.currentRadius,0,Math.PI*2),this.ctx.strokeStyle=`rgba(255, 50, 50, ${.85*C})`,this.ctx.lineWidth=4,this.ctx.shadowColor="#ff2222",this.ctx.shadowBlur=18,this.ctx.stroke(),this.ctx.shadowBlur=0,this.ctx.beginPath(),this.ctx.arc(y.centerX,y.centerY,y.currentRadius,0,Math.PI*2),this.ctx.strokeStyle=`rgba(255, 150, 150, ${.3*C})`,this.ctx.lineWidth=12,this.ctx.stroke(),this.ctx.restore()}this.matchMode==="sabotage"&&(this.vents.forEach(y=>{this.ctx.save(),this.ctx.translate(y.x,y.y),this.ctx.fillStyle="#1e2124",this.ctx.fillRect(-20,-15,40,30),this.ctx.strokeStyle="#535960",this.ctx.lineWidth=2.5,this.ctx.strokeRect(-20,-15,40,30),this.ctx.strokeStyle="#0f1112",this.ctx.lineWidth=2;for(let C=-12;C<=12;C+=6)this.ctx.beginPath(),this.ctx.moveTo(C,-10),this.ctx.lineTo(C,10),this.ctx.stroke();Math.hypot(this.localPlayer.x-y.x,this.localPlayer.y-y.y)<50&&this.localPlayer.health>0&&!this.localPlayer.inVent&&(this.ctx.fillStyle="#66fcf1",this.ctx.font="bold 9px Orbitron",this.ctx.textAlign="center",this.ctx.fillText("[E] VENT",0,-22)),this.ctx.restore()}),this.tasks.forEach(y=>{const E=Date.now();this.ctx.save(),this.ctx.translate(y.x,y.y);const S=E%1200/1200*Math.PI*2;if(y.alarmActive){const N=.7+.3*Math.abs(Math.sin(E/60+y.x)),I=90+20*Math.abs(Math.sin(E/200)),B=Math.PI/6;this.ctx.save(),this.ctx.createConicalGradient;for(let K=0;K<2;K++){const Q=S+K*Math.PI;this.ctx.beginPath(),this.ctx.moveTo(0,-26),this.ctx.arc(0,-26,I,Q-B,Q+B),this.ctx.closePath();const ie=this.ctx.createRadialGradient(0,-26,0,0,-26,I);ie.addColorStop(0,`rgba(255, 60, 40, ${.55*N})`),ie.addColorStop(.45,`rgba(255, 80, 40, ${.18*N})`),ie.addColorStop(1,"rgba(255, 40, 0, 0)"),this.ctx.fillStyle=ie,this.ctx.fill()}const F=this.ctx.createRadialGradient(0,0,0,0,0,75);F.addColorStop(0,`rgba(255, 30, 10, ${.22*N})`),F.addColorStop(1,"rgba(255,0,0,0)"),this.ctx.fillStyle=F,this.ctx.beginPath(),this.ctx.ellipse(0,5,75,35,0,0,Math.PI*2),this.ctx.fill(),this.ctx.restore()}else if(y.status==="doing"){const N=.12+.1*Math.abs(Math.sin(E/350)),I=this.ctx.createRadialGradient(0,0,0,0,0,40);I.addColorStop(0,`rgba(255,220,50,${N})`),I.addColorStop(1,"rgba(255,200,0,0)"),this.ctx.fillStyle=I,this.ctx.beginPath(),this.ctx.ellipse(0,5,40,22,0,0,Math.PI*2),this.ctx.fill()}y.status,y.alarmActive||y.status,this.ctx.fillStyle="rgba(0,0,0,0.45)",this.ctx.beginPath(),this.ctx.ellipse(0,17,22,7,0,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#1a1f26",this.ctx.beginPath(),this.ctx.roundRect(-18,-18,36,32,3),this.ctx.fill(),this.ctx.strokeStyle="#3a4555",this.ctx.lineWidth=1.5,this.ctx.stroke(),this.ctx.fillStyle="#0d1117",this.ctx.fillRect(-13,-14,26,16),this.ctx.strokeStyle="#2a3340",this.ctx.lineWidth=1,this.ctx.strokeRect(-13,-14,26,16);const w=y.alarmActive?"#1a0000":"#001a0a";this.ctx.fillStyle=w,this.ctx.fillRect(-11,-12,22,12),this.ctx.strokeStyle=y.alarmActive?"rgba(255,20,20,0.06)":"rgba(0,255,100,0.07)",this.ctx.lineWidth=.8;for(let N=-11;N<0;N+=2)this.ctx.beginPath(),this.ctx.moveTo(-11,N),this.ctx.lineTo(11,N),this.ctx.stroke();y.alarmActive?(this.ctx.shadowColor="#ff3c3c",this.ctx.shadowBlur=6,this.ctx.fillStyle="#ff3c3c"):y.status==="completed"?(this.ctx.shadowColor="#66fcf1",this.ctx.shadowBlur=6,this.ctx.fillStyle="#66fcf1"):y.status==="doing"?(this.ctx.shadowColor="#ffd700",this.ctx.shadowBlur=5,this.ctx.fillStyle="#ffd700"):(this.ctx.shadowColor="#1aff8a",this.ctx.shadowBlur=4,this.ctx.fillStyle="#1aff8a"),this.ctx.font="bold 5px monospace",this.ctx.textAlign="center";const L=y.alarmActive?"ALARM":y.status==="completed"?"DONE":y.status==="doing"?"ACTIVE":"READY";this.ctx.fillText(L,0,-5),this.ctx.shadowBlur=0,this.ctx.fillStyle="#141a22",this.ctx.fillRect(-13,4,26,8);const R=y.alarmActive?`rgba(255,40,40,${.6+.4*Math.abs(Math.sin(E/90))})`:y.status==="completed"?"#66fcf1":y.status==="doing"?"#ffd700":"#1aff8a";this.ctx.fillStyle=R,y.alarmActive&&(this.ctx.shadowColor="#ff3c3c",this.ctx.shadowBlur=8),this.ctx.beginPath(),this.ctx.arc(-8,8,2.5,0,Math.PI*2),this.ctx.fill(),this.ctx.shadowBlur=0;for(let N=-1;N<=5;N+=3)this.ctx.fillStyle="#2a3545",this.ctx.fillRect(N,6,2.5,4);if(y.alarmActive){const N=.6+.4*Math.abs(Math.sin(E/45));this.ctx.fillStyle="#1a0a0a",this.ctx.beginPath(),this.ctx.arc(0,-26,6,Math.PI,0),this.ctx.fill(),this.ctx.save(),this.ctx.translate(0,-26),this.ctx.rotate(S),this.ctx.fillStyle=`rgba(255, 60, 10, ${N})`,this.ctx.shadowColor="#ff3c3c",this.ctx.shadowBlur=14,this.ctx.beginPath(),this.ctx.arc(0,0,4.5,0,Math.PI*2),this.ctx.fill(),this.ctx.shadowBlur=0,this.ctx.fillStyle=`rgba(255, 220, 180, ${.8*N})`,this.ctx.beginPath(),this.ctx.arc(0,0,2,0,Math.PI*2),this.ctx.fill(),this.ctx.restore(),this.ctx.strokeStyle="#2a1a1a",this.ctx.lineWidth=1.5,this.ctx.beginPath(),this.ctx.moveTo(0,-20),this.ctx.lineTo(0,-22),this.ctx.stroke()}else this.ctx.fillStyle="#1a2030",this.ctx.beginPath(),this.ctx.arc(0,-22,4,Math.PI,0),this.ctx.fill(),this.ctx.fillStyle="#2a3040",this.ctx.beginPath(),this.ctx.arc(0,-22,2,0,Math.PI*2),this.ctx.fill();this.ctx.strokeStyle="#0a0f14",this.ctx.lineWidth=1.2,this.ctx.beginPath(),this.ctx.moveTo(-18,5),this.ctx.quadraticCurveTo(-26,10,-24,16),this.ctx.stroke(),this.ctx.beginPath(),this.ctx.moveTo(18,3),this.ctx.quadraticCurveTo(25,8,22,16),this.ctx.stroke(),[[-16,-16],[16,-16],[-16,12],[16,12]].forEach(([N,I])=>{this.ctx.fillStyle="#2c3545",this.ctx.beginPath(),this.ctx.arc(N,I,1.5,0,Math.PI*2),this.ctx.fill()}),Math.hypot(this.localPlayer.x-y.x,this.localPlayer.y-y.y)<40&&this.localPlayer.health>0&&y.status==="pending"&&(this.ctx.shadowColor="#ffd700",this.ctx.shadowBlur=8,this.ctx.fillStyle="#ffd700",this.ctx.font="bold 9px Orbitron",this.ctx.textAlign="center",this.ctx.fillText("[F] INTERACT",0,-36),this.ctx.shadowBlur=0),this.ctx.restore()})),this.activeHitmarkers.forEach(y=>{const E=y.age/y.duration;this.ctx.save(),this.ctx.translate(y.x,y.y);const C=1-E;this.ctx.strokeStyle=y.isHeadshot?`rgba(255, 215, 0, ${C})`:`rgba(255, 255, 255, ${C})`,this.ctx.lineWidth=y.isHeadshot?2.5:1.5;const S=5+E*5,w=2;this.ctx.beginPath(),this.ctx.moveTo(-w,-w),this.ctx.lineTo(-S,-S),this.ctx.moveTo(w,-w),this.ctx.lineTo(S,-S),this.ctx.moveTo(-w,w),this.ctx.lineTo(-S,S),this.ctx.moveTo(w,w),this.ctx.lineTo(S,S),this.ctx.stroke(),this.ctx.restore()}),this.floatingNumbers.forEach(y=>{const E=y.age/y.duration;this.ctx.save(),this.ctx.translate(y.x,y.y);const C=1-E;let S=1;E<.25?S=1+E/.25*.4:S=1.4-(E-.25)/.75*.4,this.ctx.scale(S,S),this.ctx.font=y.isHeadshot?"bold 14px 'Orbitron', sans-serif":"bold 11px 'Orbitron', sans-serif",this.ctx.textAlign="center",this.ctx.strokeStyle=`rgba(0, 0, 0, ${C})`,this.ctx.lineWidth=3,this.ctx.strokeText(y.damage,0,0),this.ctx.fillStyle=y.isHeadshot?`rgba(255, 215, 0, ${C})`:`rgba(255, 255, 255, ${C})`,this.ctx.fillText(y.damage,0,0),this.ctx.restore()}),this.ctx.restore(),this.ctx.save();const b=this.ctx.createRadialGradient(this.canvas.width/2,this.canvas.height/2,this.canvas.width/3,this.canvas.width/2,this.canvas.height/2,this.canvas.width/1.1);b.addColorStop(0,"rgba(0, 0, 0, 0)");let v="rgba(0, 0, 0, 0.82)";if(this.localPlayer){const y=Date.now(),E=this.localPlayer.adrenalineEndTime&&y<this.localPlayer.adrenalineEndTime||this.localPlayer.adrenalineActive,C=this.localPlayer.overdriveEndTime&&y<this.localPlayer.overdriveEndTime||this.localPlayer.overdriveActive;this.matchMode==="sabotage"&&this.tasks&&this.tasks.some(w=>w.alarmActive)?v=`rgba(255, 30, 30, ${Math.sin(y/100)*.15+.55})`:C?v=`rgba(255, 180, 0, ${Math.sin(y/150)*.12+.48})`:E&&(v=`rgba(57, 219, 20, ${Math.sin(y/150)*.12+.48})`)}b.addColorStop(1,v),this.ctx.fillStyle=b,this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.fillStyle="rgba(255, 255, 255, 0.015)";for(let y=0;y<this.canvas.height;y+=4)this.ctx.fillRect(0,y,this.canvas.width,1);if(this.ctx.restore(),this.localPlayer&&this.localPlayer.health>0&&this.localPlayer.health<35&&!e){this.ctx.save();const y=Math.sin(Date.now()/150)*.2+.3,E=this.ctx.createRadialGradient(this.canvas.width/2,this.canvas.height/2,this.canvas.width/3,this.canvas.width/2,this.canvas.height/2,this.canvas.width/1.1);E.addColorStop(0,"rgba(255, 0, 0, 0)"),E.addColorStop(1,`rgba(255, 0, 0, ${y})`),this.ctx.fillStyle=E,this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.restore()}let x=0;if(e){const y=e.players.find(E=>E.isLocal);y&&(x=y.flashAlpha||0)}else this.localPlayer&&(x=this.localPlayer.flashAlpha||0);if(x>0&&(this.ctx.save(),this.ctx.fillStyle=`rgba(255, 255, 255, ${x})`,this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.restore()),!e){const y=this.localPlayer&&this.localPlayer.health>0?this.map.checkZone(this.localPlayer.x,this.localPlayer.y):null;if(y)try{this.ctx.save();const E=y.type==="healing",C=Math.sin(Date.now()/400)*.25+.75,S=E?`rgba(80,255,130,${C})`:`rgba(255,100,60,${C})`,w=E?`rgba(40,255,110,${C*.18})`:`rgba(255,60,20,${C*.18})`,L=E?`rgba(80,255,130,${C*.8})`:`rgba(255,100,60,${C*.8})`,R=260,P=38,O=this.canvas.width/2-R/2,N=this.canvas.height-130;this.ctx.fillStyle=w,this.ctx.fillRect(O,N,R,P),this.ctx.strokeStyle=L,this.ctx.lineWidth=1.5,this.ctx.strokeRect(O,N,R,P),this.ctx.textAlign="center",this.ctx.font="bold 12px Orbitron",this.ctx.fillStyle=S;const I=E?"+":"!";this.ctx.fillText(`${I} ${y.label}`,this.canvas.width/2,N+15),this.ctx.font="9px Orbitron",this.ctx.fillStyle=E?"rgba(60,255,110,0.7)":"rgba(255,80,40,0.7)";const B=E?`+${(y.healRate*60).toFixed(0)} HP/s REGENERATION`:`DAMAGE x${y.multiplier} -- DANGER`;this.ctx.fillText(B,this.canvas.width/2,N+29),this.ctx.restore()}catch{}}if(this.matchMode==="sabotage"&&this.gameState==="playing"){this.ctx.save(),this.ctx.font="bold 11px 'Orbitron', sans-serif",this.ctx.textAlign="left";const y=20,E=120;this.ctx.fillStyle="#ff3c3c",this.ctx.fillText("MISSION TASKS:",y,E),this.tasks.forEach((C,S)=>{const w=E+20+S*18,L=C.status==="completed";this.ctx.fillStyle=L?"#39db14":"#fff",this.ctx.font=L?"10px 'Orbitron', sans-serif":"bold 10px 'Orbitron', sans-serif",this.ctx.strokeStyle=L?"#39db14":"#888",this.ctx.lineWidth=1,this.ctx.strokeRect(y,w-8,8,8),L&&(this.ctx.fillStyle="#39db14",this.ctx.fillRect(y+2,w-6,4,4)),this.ctx.fillText(C.name,y+15,w)}),this.ctx.restore()}if(this.matchMode==="sabotage"&&this.localPlayer&&this.localPlayer.health>0&&(this.localPlayer.inVent&&this.currentVent&&(this.ctx.save(),this.ctx.fillStyle="rgba(2, 4, 8, 0.85)",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height),this.ctx.fillStyle="rgba(102, 252, 241, 0.08)",this.ctx.strokeStyle="#66fcf1",this.ctx.lineWidth=2,this.ctx.fillRect(this.canvas.width/2-200,this.canvas.height/2-150,400,300),this.ctx.strokeRect(this.canvas.width/2-200,this.canvas.height/2-150,400,300),this.ctx.font="bold 16px 'Orbitron', sans-serif",this.ctx.fillStyle="#66fcf1",this.ctx.textAlign="center",this.ctx.fillText("VENT NETWORK SYSTEM",this.canvas.width/2,this.canvas.height/2-110),this.ctx.font="11px 'Orbitron', sans-serif",this.ctx.fillStyle="#8892b0",this.ctx.fillText("Select destination vent code to travel:",this.canvas.width/2,this.canvas.height/2-80),this.vents.forEach((y,E)=>{const C=E+1,S=y.id===this.currentVent.id;this.ctx.fillStyle=S?"#ffd700":"#fff",this.ctx.fillText(`[${C}] ${y.name} ${S?"(CURRENT LOCATION)":""}`,this.canvas.width/2,this.canvas.height/2-40+E*30)}),this.ctx.font="bold 11px 'Orbitron', sans-serif",this.ctx.fillStyle="#ff3c3c",this.ctx.fillText("PRESS [SPACEBAR] TO EXIT VENT",this.canvas.width/2,this.canvas.height/2+120),this.ctx.restore()),this.activeTask)){this.ctx.save(),this.ctx.fillStyle="rgba(2, 4, 8, 0.85)",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height);const y=this.canvas.width/2-200,E=this.canvas.height/2-140,C=400,S=280;this.ctx.fillStyle="#11151c",this.ctx.strokeStyle="#ffd700",this.ctx.lineWidth=3,this.ctx.fillRect(y,E,C,S),this.ctx.strokeRect(y,E,C,S),this.ctx.font="bold 15px 'Orbitron', sans-serif",this.ctx.fillStyle="#ffd700",this.ctx.textAlign="center",this.ctx.fillText(this.activeTask.name.toUpperCase(),this.canvas.width/2,E+35),this.ctx.font="11px 'Orbitron', sans-serif",this.ctx.fillStyle="#888",this.ctx.fillText("TASK TYPE: GRID CALIBRATION",this.canvas.width/2,E+60);const w=this.canvas.width/2-120,L=E+100,R=240,P=40;this.ctx.fillStyle="#1a1d24",this.ctx.fillRect(w,L,R,P),this.ctx.strokeStyle="#333",this.ctx.strokeRect(w,L,R,P),this.ctx.fillStyle="rgba(57, 219, 20, 0.35)",this.ctx.fillRect(this.canvas.width/2-24,L,48,P),this.ctx.strokeStyle="#39db14",this.ctx.strokeRect(this.canvas.width/2-24,L,48,P);const O=Math.abs(Math.sin(this.sweepAngle)),N=w+O*R;this.ctx.strokeStyle="#fff",this.ctx.lineWidth=3,this.ctx.beginPath(),this.ctx.moveTo(N,L-5),this.ctx.lineTo(N,L+P+5),this.ctx.stroke();const I=this.canvas.width/2-120,B=E+175,F=240,K=20;this.ctx.fillStyle="#1a1d24",this.ctx.fillRect(I,B,F,K),this.ctx.fillStyle="#ffd700",this.ctx.fillRect(I,B,this.sweepProgress/100*F,K),this.ctx.strokeStyle="#ffd700",this.ctx.strokeRect(I,B,F,K),this.ctx.font="bold 10px 'Orbitron', sans-serif",this.ctx.fillStyle="#fff",this.ctx.fillText(`CALIBRATION PROGRESS: ${this.sweepProgress}%`,this.canvas.width/2,B+14),this.ctx.font="11px 'Orbitron', sans-serif",this.ctx.fillStyle="#ffaa00",this.ctx.fillText("PRESS [SPACEBAR] WHEN LINE IS IN GREEN ZONE",this.canvas.width/2,E+230),this.ctx.fillStyle="#888",this.ctx.fillText("PRESS [ESC] OR [F] TO ABANDON TASK",this.canvas.width/2,E+255),this.ctx.restore()}if(!e&&this.gameState==="playing"&&(this.matchMode==="sabotage"||performance.now()-this.roundStartTime>2e4)){this.ctx.save();const y=150,C=this.canvas.width-y-20,S=100;this.ctx.fillStyle="rgba(6, 7, 10, 0.85)",this.ctx.fillRect(C,S,y,y),this.ctx.strokeStyle="hsla(43, 74%, 49%, 0.6)",this.ctx.lineWidth=2,this.ctx.strokeRect(C,S,y,y),this.ctx.fillStyle="hsla(43, 74%, 49%, 0.9)",this.ctx.font="bold 9px Orbitron",this.ctx.textAlign="center",this.ctx.fillText("TACTICAL MINIMAP",C+y/2,S-6);const w=y/this.map.width;if(this.ctx.fillStyle="rgba(255, 255, 255, 0.12)",this.map.walls.forEach(R=>{this.ctx.fillRect(C+R.x*w,S+R.y*w,R.w*w,R.h*w)}),this.localPlayer&&this.localPlayer.health>0){const R=C+this.localPlayer.x*w,P=S+this.localPlayer.y*w;this.ctx.fillStyle="#00ffff",this.ctx.beginPath(),this.ctx.arc(R,P,3.5,0,Math.PI*2),this.ctx.fill(),this.ctx.strokeStyle="rgba(0, 255, 255, 0.8)",this.ctx.lineWidth=1,this.ctx.beginPath(),this.ctx.moveTo(R,P),this.ctx.lineTo(R+Math.cos(this.localPlayer.angle)*7,P+Math.sin(this.localPlayer.angle)*7),this.ctx.stroke()}this.matchMode==="sabotage"&&this.tasks.forEach(R=>{if(R.status==="completed")return;const P=C+R.x*w,O=S+R.y*w,N=Math.abs(Math.sin(performance.now()/250));this.ctx.fillStyle=`rgba(255, 215, 0, ${.4+.6*N})`,this.ctx.beginPath(),this.ctx.arc(P,O,3.5+N*2,0,Math.PI*2),this.ctx.fill()});const L=Math.abs(Math.sin(performance.now()/200));this.players.forEach(R=>{if(R.health>0&&!R.isLocal){const P=C+R.x*w,O=S+R.y*w;if(R.isTeammate)this.ctx.fillStyle="#39ff14",this.ctx.beginPath(),this.ctx.arc(P,O,3,0,Math.PI*2),this.ctx.fill();else{if(this.matchMode==="sabotage")return;this.ctx.fillStyle=`rgba(255, 60, 60, ${.4+.6*L})`,this.ctx.beginPath(),this.ctx.arc(P,O,4+L*2.5,0,Math.PI*2),this.ctx.fill(),this.ctx.fillStyle="#ff3c3c",this.ctx.beginPath(),this.ctx.arc(P,O,2,0,Math.PI*2),this.ctx.fill()}}}),this.ctx.restore()}if(e){this.ctx.save(),this.ctx.strokeStyle="rgba(255, 60, 60, 0.6)",this.ctx.lineWidth=12,this.ctx.strokeRect(0,0,this.canvas.width,this.canvas.height);const y=Math.floor(Date.now()/500)%2===0;this.ctx.fillStyle=y?"#ff3c3c":"rgba(255, 60, 60, 0.2)",this.ctx.beginPath(),this.ctx.arc(40,40,8,0,Math.PI*2),this.ctx.fill(),this.ctx.font="900 16px Orbitron",this.ctx.fillStyle="#ffffff",this.ctx.textAlign="left",this.ctx.fillText("KILLCAM REPLAY",60,46);const E=this.replayIndex/this.replayFrames.length,C=this.canvas.width-80;this.ctx.fillStyle="rgba(255, 255, 255, 0.15)",this.ctx.fillRect(40,this.canvas.height-40,C,6),this.ctx.fillStyle="#ff3c3c",this.ctx.fillRect(40,this.canvas.height-40,C*E,6),this.ctx.restore()}if(!e&&this.combatBanner){this.ctx.save(),this.ctx.textAlign="center",this.ctx.textBaseline="middle";const y=this.combatBanner.timer,E=this.combatBanner.text;let C=1;y<.5&&(C=y/.5);const S=1.5+Math.max(0,y-2.5)*2+.05*Math.sin(Date.now()/100);this.ctx.translate(this.canvas.width/2,this.canvas.height/2-180),this.ctx.scale(S,S),this.ctx.shadowColor="#ff3c3c",this.ctx.shadowBlur=20,this.ctx.font="italic 900 24px 'Orbitron', sans-serif";const w=this.ctx.createLinearGradient(-150,0,150,0);w.addColorStop(0,`rgba(255, 60, 60, ${C})`),w.addColorStop(.5,`rgba(255, 220, 0, ${C})`),w.addColorStop(1,`rgba(255, 60, 60, ${C})`),this.ctx.fillStyle=w,this.ctx.fillText(E,0,0),this.ctx.shadowBlur=0,this.ctx.strokeStyle=`rgba(255, 215, 0, ${C*.4})`,this.ctx.lineWidth=1.5,this.ctx.beginPath(),this.ctx.moveTo(-100,18),this.ctx.lineTo(100,18),this.ctx.moveTo(-100,-18),this.ctx.lineTo(100,-18),this.ctx.stroke(),this.ctx.restore()}if(this.localPlayer&&this.localPlayer.weaponLevelUpAlert>0&&!e){this.ctx.save(),this.ctx.textAlign="center",this.ctx.textBaseline="middle";const y=this.localPlayer.weaponLevelUpAlert,E=Math.min(1,y),C=1+.15*Math.sin(Date.now()/150);this.ctx.translate(this.canvas.width/2,this.canvas.height/2-80),this.ctx.scale(C,C),this.ctx.shadowColor="#ffd700",this.ctx.shadowBlur=15,this.ctx.font="bold 28px 'Orbitron', sans-serif",this.ctx.fillStyle=`rgba(255, 215, 0, ${E})`,this.ctx.fillText("WEAPON UPGRADED",0,0),this.ctx.shadowBlur=0,this.ctx.font="bold 16px 'Orbitron', sans-serif",this.ctx.fillStyle=`rgba(255, 255, 255, ${E})`,this.ctx.fillText(`LVL ${this.localPlayer.weaponLevel}`,0,35),this.ctx.restore()}}isPointInPolygon(e,t){let i=!1;for(let s=0,a=t.length-1;s<t.length;a=s++){const r=t[s].x,o=t[s].y,l=t[a].x,c=t[a].y;o>e.y!=c>e.y&&e.x<(l-r)*(e.y-o)/(c-o)+r&&(i=!i)}return i}handleServerRoundOver(e){if(this.gameState!=="playing")return;if(this.gameState="round-over",this.matchTimerInterval&&clearInterval(this.matchTimerInterval),this.matchMode==="sabotage")try{this.sound.stopBearMusic()}catch{}let t=document.getElementById("hud-status");const i=this.localPlayer.team;e.winningTeam===i?t&&(t.innerText="ROUND WON",t.style.color="#39ff14"):t&&(t.innerText="ROUND LOST",t.style.color="#ff3c3c"),i===1?(this.scoreSelf=e.score1,this.scoreOpponent=e.score2):(this.scoreSelf=e.score2,this.scoreOpponent=e.score1),this.updateScoreboardHUD();const s=e.winningTeam===1?2:1;this.players.forEach(a=>{a.team===s&&(a.health=0)}),this.roundNumber=e.roundNumber,this.startReplay(()=>this.startRoundCycle())}handleServerMatchOver(e){if(this.gameState!=="playing"&&this.gameState!=="round-over")return;this.gameState="round-over",this.matchTimerInterval&&clearInterval(this.matchTimerInterval),this.localPlayer.team===1?(this.scoreSelf=e.score1,this.scoreOpponent=e.score2):(this.scoreSelf=e.score2,this.scoreOpponent=e.score1),this.updateScoreboardHUD();const i=window.MatchStats.shotsFired||1,s=window.MatchStats.hitsRegistered/i*100;window.MatchStats.accuracy=s,window.MatchStats.roundsWon=this.scoreSelf,window.MatchStats.winnerId=e.winnerId;const a=this.matchMode==="sabotage"?this.scoreSelf>this.scoreOpponent:this.scoreSelf>=3,r=this.localPlayer.rank?this.localPlayer.rank.label:"";let o=!1,l=0;this.isRanked&&(o=this.localPlayer.applyRankDelta(a?ma:ga),l=a?ma:ga),window.MatchStats.isWin=a,window.MatchStats.newRP=this.localPlayer.rp,window.MatchStats.newRank=this.localPlayer.rank,window.MatchStats.rpDelta=l,window.MatchStats.rankChanged=o,window.MatchStats.oldRankLabel=r;const h=(this.matchMode==="sabotage"?e.score1>e.score2?1:2:e.score1>=3?1:2)===1?2:1;this.players.forEach(d=>{d.team===h&&(d.health=0)});const f=()=>{this.gameState="match-over",this.active=!1,a?this.sound.playMatchWin():this.sound.playMatchLose(),this.onMatchEnd&&this.onMatchEnd(window.MatchStats)};this.startReplay(f)}spawnItemAt(e,t,i,s=null){const a=s||`item_${i}_${Date.now()}_${Math.round(Math.random()*1e3)}`;return this.map.items.some(r=>r.id===a)||this.map.items.push({id:a,x:e,y:t,type:i,active:!0}),a}generateRandomCode(){const e=["w","a","s","d","q","e","r","f"];let t="";for(let i=0;i<4;i++)t+=e[Math.floor(Math.random()*e.length)];return t}startHackingMinigame(e){const t=this.generateRandomCode();this.activeMinigame={terminal:e,code:t,input:"",timer:4},this.keys.e=!1;const i=document.getElementById("hacking-minigame-overlay");i&&(i.style.display="flex");const s=document.getElementById("hud-interaction-prompt");s&&(s.style.display="none"),this.renderMinigameKeys()}renderMinigameKeys(){const e=document.getElementById("minigame-keys-container");if(!e||!this.activeMinigame)return;e.innerHTML="";const t=this.activeMinigame.code,i=this.activeMinigame.input;for(let s=0;s<t.length;s++){const a=t[s],r=s<i.length,o=document.createElement("div");o.style.width="35px",o.style.height="35px",o.style.lineHeight="35px",o.style.borderRadius="4px",o.style.fontFamily="var(--font-title)",o.style.fontWeight="bold",o.style.fontSize="14px",o.style.textTransform="uppercase",o.style.border=r?"1px solid #39ff14":"1px solid rgba(255,255,255,0.15)",o.style.background=r?"rgba(57, 255, 20, 0.12)":"rgba(0,0,0,0.4)",o.style.color=r?"#39ff14":"rgba(255,255,255,0.7)",o.style.boxShadow=r?"0 0 6px rgba(57, 255, 20, 0.25)":"none",o.innerText=a,e.appendChild(o)}}handleMinigameKeyPress(e){if(!this.activeMinigame)return;const t=this.activeMinigame.code,i=this.activeMinigame.input,s=t[i.length];if(e===s){this.activeMinigame.input+=e,this.renderMinigameKeys();try{this.sound.playMetallicClick(0,2500,.04,.2)}catch{}this.activeMinigame.input===t&&this.successHackingMinigame()}else{this.activeMinigame.input="",this.renderMinigameKeys();try{this.sound.playMetallicClick(0,300,.15,.3)}catch{}}}cancelHackingMinigame(){this.activeMinigame=null;const e=document.getElementById("hacking-minigame-overlay");e&&(e.style.display="none")}successHackingMinigame(){if(!this.activeMinigame)return;const e=this.activeMinigame.terminal;e.hacked=!0;const t=this.spawnItemAt(e.x-22,e.y,"health"),i=this.spawnItemAt(e.x+22,e.y,"adrenaline");this.localPlayer.showTextNotification("HACK SUCCESSFUL! LOOT SPAWNED","#39ff14"),this.localPlayer.networkDroppedItems||(this.localPlayer.networkDroppedItems=[]),this.localPlayer.networkDroppedItems.push({id:t,x:e.x-22,y:e.y,type:"health"}),this.localPlayer.networkDroppedItems.push({id:i,x:e.x+22,y:e.y,type:"adrenaline"});try{this.sound.playMetallicClick(0,3500,.25,.45)}catch{}this.cancelHackingMinigame()}failHackingMinigame(){this.localPlayer.showTextNotification("HACK FAILED!","#ff3c3c");try{this.sound.playMetallicClick(0,200,.3,.45)}catch{}this.cancelHackingMinigame()}}const ve={getItem(n){try{return localStorage.getItem(n)}catch(e){return console.warn("localStorage.getItem failed:",e),null}},setItem(n,e){try{localStorage.setItem(n,e)}catch(t){console.warn("localStorage.setItem failed:",t)}},removeItem(n){try{localStorage.removeItem(n)}catch(e){console.warn("localStorage.removeItem failed:",e)}}},gl="tacticstrike_account_session",us="tacticstrike_account_user",yl="tacticstrike_admin_session",Py=performance.now();function Iy(){try{const n=JSON.parse(ve.getItem(us)||"null");return n&&typeof n.email=="string"?n:null}catch{return ve.removeItem(us),null}}let Ct={token:ve.getItem(gl),user:Iy()};Ct.token||(Ct.user=null);let Dn=!!Ct.token,ls=ve.getItem(yl),xl=null;function Xr(n){return new Promise(e=>setTimeout(e,n))}function vl({immediate:n=!1}={}){const e=document.getElementById("startup-overlay");if(document.body.classList.remove("is-starting"),!!e){if(e.setAttribute("aria-hidden","true"),n){e.remove();return}e.classList.add("is-exiting"),setTimeout(()=>e.remove(),650)}}setTimeout(()=>{document.body.classList.contains("is-starting")&&vl()},6500);async function Ly(n){const e=Math.max(0,1350-(performance.now()-Py)),t=Ct.token&&!Ct.user?Promise.race([Promise.resolve(n),Xr(3600)]):Promise.resolve();await Promise.all([Xr(e),t]);const i=document.getElementById("startup-status");i&&(i.textContent=Ct.user?"OPERATIVE SESSION READY":"SYSTEMS ONLINE"),await Xr(140),vl()}function _l(){return window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"?window.location.port==="3000"?window.location.origin:"http://localhost:3000":window.location.hostname.endsWith("onrender.com")?window.location.origin:"https://topdownshooter.onrender.com"}async function qi(n,e={}){const t={"Content-Type":"application/json",...e.headers||{}};Ct.token&&(t.Authorization=`Bearer ${Ct.token}`);const i=await fetch(`${_l()}${n}`,{...e,headers:t}),s=i.status===204?null:await i.json().catch(()=>null);if(!i.ok){const a=new Error((s==null?void 0:s.message)||"The account server could not complete this request.");throw a.code=s==null?void 0:s.error,a.status=i.status,a}return s}async function ps(n,e={}){const t={"Content-Type":"application/json",...e.headers||{}};ls&&(t.Authorization=`Bearer ${ls}`);const i=await fetch(`${_l()}${n}`,{...e,headers:t}),s=i.status===204?null:await i.json().catch(()=>null);if(!i.ok){const a=new Error((s==null?void 0:s.message)||"The admin server could not complete this request.");throw a.code=s==null?void 0:s.error,a.status=i.status,a}return s}const mi={menu:document.getElementById("menu-screen"),lobby:document.getElementById("lobby-screen"),game:document.getElementById("game-screen"),matchmaking:document.getElementById("matchmaking-screen")},tt={rankedRealistic:document.getElementById("btn-ranked-realistic"),rankedCompetitive:document.getElementById("btn-ranked-competitive"),createRoom:document.getElementById("btn-create-room"),joinRoom:document.getElementById("btn-join-room"),practiceBot:document.getElementById("btn-practice-bot"),openMatchSettings:document.getElementById("btn-open-match-settings"),closeSettings:document.getElementById("btn-close-settings"),leaveLobby:document.getElementById("btn-leave-lobby"),readyToggle:document.getElementById("btn-ready-toggle"),copyCode:document.getElementById("btn-copy-code"),returnLobby:document.getElementById("btn-return-lobby"),btnAmongUs:document.getElementById("btn-among-us-mode")},Oe={name:document.getElementById("player-name-input"),roomCode:document.getElementById("room-code-input"),chat:document.getElementById("chat-input"),qpMapSelect:document.getElementById("qp-map-select"),lobbyMapSelect:document.getElementById("lobby-map-select"),lobbyModeSelect:document.getElementById("lobby-mode-select"),lobbyStyleSelect:document.getElementById("lobby-style-select")},at={roomCode:document.getElementById("room-code-display"),weaponStats:document.getElementById("weapon-stats-display"),playersList:document.getElementById("lobby-players-list"),chatMessages:document.getElementById("chat-messages"),chatDrawer:document.getElementById("chat-drawer")},gt={modal:document.getElementById("settings-modal"),volume:document.getElementById("setting-volume"),volumeVal:document.getElementById("volume-val"),blood:document.getElementById("setting-blood"),shadows:document.getElementById("setting-shadows"),laser:document.getElementById("setting-laser")},fn=document.getElementById("game-over-modal"),tr={pistol:{name:"Tactical 9mm",damage:22,fireRate:35,accuracy:90,magSize:12,range:400,reloadTime:1200,speedMultiplier:1,type:"Semi-Auto",damagePct:33,fireRatePct:45},rifle:{name:"Assault Rifle (M4A1)",damage:28,fireRate:75,accuracy:70,magSize:30,range:600,reloadTime:2200,speedMultiplier:1,type:"Automatic",damagePct:65,fireRatePct:85},shotgun:{name:"Shotgun (Remington 870)",damage:15,fireRate:20,accuracy:40,magSize:6,range:250,reloadTime:3e3,speedMultiplier:1,type:"Pump-Action",damagePct:80,fireRatePct:20,pellets:8},sniper:{name:"Sniper Rifle (AWM)",damage:95,fireRate:10,accuracy:98,magSize:5,range:1e3,reloadTime:2800,speedMultiplier:1,type:"Bolt-Action",damagePct:100,fireRatePct:10},smg:{name:"SMG (MP5)",damage:18,fireRate:85,accuracy:82,magSize:30,range:350,reloadTime:1500,speedMultiplier:1,type:"Automatic",damagePct:30,fireRatePct:95},lmg:{name:"LMG (M249)",damage:25,fireRate:80,accuracy:75,magSize:100,range:550,reloadTime:4500,speedMultiplier:1,type:"Automatic",damagePct:55,fireRatePct:90},dmr:{name:"DMR (M14 EBR)",damage:45,fireRate:30,accuracy:94,magSize:20,range:800,reloadTime:2400,speedMultiplier:1,type:"Semi-Auto",damagePct:75,fireRatePct:35},vector:{name:"Vector SMG",damage:14,fireRate:95,accuracy:85,magSize:33,range:320,reloadTime:1100,speedMultiplier:1,type:"Automatic",damagePct:25,fireRatePct:98},famas:{name:"FAMAS Burst Carbine",damage:20,fireRate:55,accuracy:91,magSize:25,range:550,reloadTime:1800,speedMultiplier:1,type:"Burst-Fire",damagePct:45,fireRatePct:60},plasma:{name:"Plasma Rifle PL-45",damage:32,fireRate:65,accuracy:90,magSize:20,range:600,reloadTime:2e3,speedMultiplier:1,type:"Automatic",damagePct:60,fireRatePct:70},railgun:{name:"Railgun RG-X",damage:85,fireRate:8,accuracy:99,magSize:5,range:1200,reloadTime:3500,speedMultiplier:.95,type:"Single-Shot",damagePct:95,fireRatePct:8}},Nn={dmr:{rp:1e3,rank:"VETERAN",price:2200},sniper:{rp:1e3,rank:"VETERAN",price:2500},lmg:{rp:4e3,rank:"ELITE",price:4500},vector:{rp:1e3,rank:"VETERAN",price:2100},famas:{rp:1e3,rank:"VETERAN",price:2300},plasma:{rp:4e3,rank:"ELITE",price:4e3},railgun:{rp:4e3,rank:"ELITE",price:5e3}},Dy={dmr:{code:"M14",role:"PRECISION",tier:"ADVANCED",description:"A controlled semi-auto platform built for disciplined mid-to-long range fire."},sniper:{code:"AWM",role:"LONGSHOT",tier:"ADVANCED",description:"A high-impact bolt-action system engineered to end an engagement in one shot."},lmg:{code:"M249",role:"SUPPORT",tier:"ELITE",description:"Sustained suppressive fire with a deep belt and uncompromising lane control."},vector:{code:"VEC",role:"BREACH",tier:"ADVANCED",description:"Extreme close-range fire rate for operatives who fight inside the objective."},famas:{code:"FAM",role:"BURST",tier:"ADVANCED",description:"A precise burst carbine tuned for fast target acquisition and controlled recoil."},plasma:{code:"PL45",role:"PROTOTYPE",tier:"ELITE",description:"Experimental energy rifle with exceptional accuracy and balanced stopping power."},railgun:{code:"RG-X",role:"EXOTIC",tier:"ELITE",description:"Blacksite electromagnetic technology delivering devastating single-shot force."}},Bs={pistol:"Pistol",rifle:"Rifle",shotgun:"Shotgun",sniper:"Sniper",smg:"SMG",lmg:"LMG",dmr:"DMR",vector:"Vector",famas:"FAMAS",plasma:"Plasma",railgun:"Railgun"};function Ny(n){const t=`; ${document.cookie}`.split(`; ${n}=`);return t.length===2?t.pop().split(";").shift():null}function ky(n,e,t=365){const i=new Date;i.setTime(i.getTime()+t*24*60*60*1e3),document.cookie=`${n}=${e};expires=${i.toUTCString()};path=/;SameSite=Strict`}function Sl(){let n=ve.getItem("tacticstrike_uuid");return n||(n=Ny("tacticstrike_uuid")),n||(n="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){const t=Math.random()*16|0;return(e==="x"?t:t&3|8).toString(16)})),ve.setItem("tacticstrike_uuid",n),ky("tacticstrike_uuid",n,365),n}function _s(){try{const n=window.AudioContext||window.webkitAudioContext;if(!n)return;const e=new n,t=e.createOscillator(),i=e.createGain();t.type="sawtooth",t.frequency.setValueAtTime(120,e.currentTime),i.gain.setValueAtTime(.12,e.currentTime),i.gain.exponentialRampToValueAtTime(.001,e.currentTime+.15),t.connect(i),i.connect(e.destination),t.start(),t.stop(e.currentTime+.15)}catch{}}function Ml(){const n=parseInt(ve.getItem("tacticstrike_rp")||"0"),e=document.querySelectorAll("#menu-weapon-selector .weapon-btn");e.forEach(s=>{const a=s.dataset.weapon,r=Nn[a],o=qr(a);if(r&&!o)s.classList.add("locked"),s.innerHTML=`🔒 ${Bs[a]} <span style="font-size:7px; display:block; color:#ff3c3c; margin-top:2.5px; font-family:var(--font-title); font-weight:bold;">${r.rank}</span>`;else{s.classList.remove("locked");let l=Bs[a]||a;try{JSON.parse(ve.getItem("tacticstrike_purchased_weapons")||"[]").includes(a)&&n<r.rp&&(l=`🛍️ ${l}`)}catch{}s.innerHTML=l}});const t=document.querySelectorAll(".weapon-option");t.forEach(s=>{const a=s.dataset.weapon,r=Nn[a],o=qr(a);let l=s.querySelector(".lock-badge");r&&!o?(s.classList.add("locked"),l||(l=document.createElement("span"),l.className="lock-badge",s.appendChild(l)),l.innerHTML=`🔒 <span style="font-size:8px; font-weight:bold; color:#ff3c3c; margin-left:2px;">${r.rank}</span>`,l.style.display="inline-flex"):(s.classList.remove("locked"),l&&(l.style.display="none"))}),Nn[ut]&&!qr(ut)&&(ut="pistol",ve.setItem("tacticstrike_player_weapon","pistol"),e.forEach(s=>{s.dataset.weapon==="pistol"?s.classList.add("active"):s.classList.remove("active")}),t.forEach(s=>{s.dataset.weapon==="pistol"?s.classList.add("active"):s.classList.remove("active")}),gs("pistol"))}let de=null,Ee=null,Lt=null,Ke="Operative",ut="pistol",ii="cyan",qt="1v1",Ds=!1,Na=[],xi="menu",gi=ve.getItem("tacticstrike_qp_style")||"realistic",ss=ve.getItem("tacticstrike_selected_map")||"manor";function ms(){try{return JSON.parse(localStorage.getItem("tacticstrike_career")||'{"wins":0,"losses":0}')}catch{return{wins:0,losses:0}}}function jh(n){try{localStorage.setItem("tacticstrike_career",JSON.stringify(n))}catch{}}function bl(){const n=ms(),e=n.wins+n.losses,t=e>0?Math.round(n.wins/e*100):null,i=document.getElementById("stat-wins"),s=document.getElementById("stat-losses"),a=document.getElementById("stat-winpct");i&&(i.innerText=n.wins),s&&(s.innerText=n.losses),a&&(a.innerText=t!==null?`${t}%`:"—")}function ir(n){const e=ms();n?e.wins++:e.losses++,jh(e),bl()}function Uy(n,e){if(n)try{const t=localStorage.getItem("tacticstrike_h2h")||"{}",i=JSON.parse(t);i[n]||(i[n]={wins:0,losses:0}),e?i[n].wins++:i[n].losses++,localStorage.setItem("tacticstrike_h2h",JSON.stringify(i))}catch(t){console.warn("Failed to record H2H result:",t)}}function Oy(){const n=document.getElementById("h2h-history-container");if(!n)return;let e={};try{e=JSON.parse(localStorage.getItem("tacticstrike_h2h")||"{}")}catch{e={}}const t=Object.entries(e);if(t.length===0){n.innerHTML='<div style="color: var(--text-muted); font-size: 10px; text-align: center; padding: 10px 0; letter-spacing: 0.5px;">No head-to-head records found. Play a match to start tracking!</div>';return}t.sort((s,a)=>a[1].wins+a[1].losses-(s[1].wins+s[1].losses));let i="";t.forEach(([s,a])=>{const r=a.wins+a.losses,o=r>0?Math.round(a.wins/r*100):0;i+=`
  ...
  `}function wn(n){var c;if(Na=n,!at.playersList)return;at.playersList.innerHTML="";const e=qt==="2v2"?4:2;for(let h=0;h<e;h++){const f=n[h],d=document.createElement("div");if(f){d.className=`player-slot active ${f.ready?"ready":""}`;const u=((c=tr[f.weapon])==null?void 0:c.name)||f.weapon,_={cyan:"#66fcf1",green:"#39db14",purple:"#9d3bff",orange:"#ff7f3b",yellow:"#ffd700",red:"#ff3c3c"}[f.color]||"#66fcf1",m=qt==="2v2"?`TEAM ${h%2===0?"1":"2"}`:h===0?"HOST":"GUEST",p=f.rp||0,b=wl(p);d.innerHTML=`
        <div class="player-info">
          <span class="player-name" style="color: ${_};">
            <span style="color: ${b.color}; margin-right: 4px;">${b.icon}</span>${kn(f.name)} ${f.id===de.id?"(YOU)":""}
          </span>
      ...
      `}else{d.className="player-slot empty";const u=h+1,g=qt==="2v2"?` (TEAM ${h%2===0?"1":"2"})`:"";d.innerHTML=`<div class="slot-status">WAITING FOR OPERATIVE ${u}${g}...</div>`}if(at.playersList.appendChild(d),qt==="1v1"&&h===0){const u=document.createElement("div");u.className="vs-divider",u.innerText="VS",at.playersList.appendChild(u)}}const t=n.find(h=>h.id===de.id);t&&tt.readyToggle&&(Ds=t.ready,tt.readyToggle.className=Ds?"btn secondary":"btn primary",tt.readyToggle.innerText=Ds?"CANCEL READY":"READY TO DEPLOY");const i=document.getElementById("lobby-map-selector-container"),s=document.getElementById("lobby-map-select");if(i&&s)if(xi==="ranked")i.style.display="none";else{i.style.display="block";const h=n[0]&&n[0].id===de.id;s.disabled=!h}const a=document.getElementById("lobby-mode-selector-container"),r=document.getElementById("lobby-mode-select");if(a&&r)if(xi==="ranked")a.style.display="none";else{a.style.display="block";const h=n[0]&&n[0].id===de.id;r.disabled=!h}const o=document.getElementById("lobby-style-selector-container"),l=document.getElementById("lobby-style-select");if(o&&l)if(xi==="ranked")o.style.display="none";else{o.style.display="block";const h=n[0]&&n[0].id===de.id;l.disabled=!h}}function Ua(){if(de)return;const n=_l();de=Aa(n),window.AppSocket=de,de.on("connect_error",()=>{console.warn("Failed to connect to multiplayer server."),$r({total:1,quickplay:0,ranked_realistic:0,ranked_competitive:0})}),de.on("disconnect",()=>{$r({total:1,quickplay:0,ranked_realistic:0,ranked_competitive:0})}),de.on("player-counts",e=>{$r(e)}),de.on("connect",()=>{console.log("Socket connected.");const e=Sl(),t=parseInt(ve.getItem("tacticstrike_rp")||"0"),i=ms(),s=parseInt(ve.getItem("tacticstrike_credits")||"0");let a=[];try{a=JSON.parse(ve.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}de.emit("sync-device",{uuid:e,rp:t,wins:i.wins,losses:i.losses,name:Ke,credits:s,purchasedWeapons:a})}),de.on("device-synced",e=>{console.log("Device synced with database:",e);const t=parseInt(ve.getItem("tacticstrike_rp")||"0"),i=Math.max(t,e.rp||0);ve.setItem("tacticstrike_rp",String(i));const s=ms(),a=Math.max(s.wins,e.wins||0),r=Math.max(s.losses,e.losses||0);jh({wins:a,losses:r});const o=parseInt(ve.getItem("tacticstrike_credits")||"0"),l=Math.max(o,e.credits||0);ve.setItem("tacticstrike_credits",String(l));let c=[];try{c=JSON.parse(ve.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}const h=Array.from(new Set([...c,...e.purchasedWeapons||[]]));ve.setItem("tacticstrike_purchased_weapons",JSON.stringify(h)),e.name&&e.name!=="Operative"&&(Ke=e.name,ve.setItem("tacticstrike_player_name",Ke),Oe.name&&(Oe.name.value=Ke)),Al(),bl(),Ml()}),de.on("register-response",e=>{e.success||console.warn("Register failed:",e.error)}),de.on("login-response",e=>{e.success||console.warn("Login failed:",e.error)}),de.on("room-created",({roomId:e,players:t,autoMatch:i,mode:s,mapId:a,renderStyle:r,isRanked:o})=>{Lt=e,s&&(qt=s),xi=o?"ranked":"casual",at.roomCode.innerText=e;const l=document.getElementById("lobby-map-select");l&&a&&(l.value=a);const c=document.getElementById("lobby-mode-select");c&&s&&(c.value=s);const h=document.getElementById("lobby-style-select");h&&r&&(h.value=r,gi=r),i?(wn(t),Hi("Created matchmaking room. Waiting for opponent...")):(ti("lobby"),wn(t),Hi(`Lobby created. Share code [${e}] with a friend.`))}),de.on("room-joined",({roomId:e,players:t,mode:i,mapId:s,renderStyle:a,isRanked:r})=>{Lt=e,i&&(qt=i),xi=r?"ranked":"casual",at.roomCode.innerText=e,ti("lobby"),wn(t);const o=document.getElementById("lobby-map-select");o&&s&&(o.value=s);const l=document.getElementById("lobby-mode-select");l&&i&&(l.value=i);const c=document.getElementById("lobby-style-select");c&&a&&(c.value=a,gi=a),Hi(`Joined lobby: ${e}`),cn&&(clearTimeout(cn),cn=null),ka=!1}),de.on("room-error",e=>{alert(e)}),de.on("player-joined",({players:e})=>{wn(e);const t=e.find(s=>s.id!==de.id);t&&Hi(`${t.name} entered the lobby.`);const i=document.querySelector(".screen.active");i&&i.id==="matchmaking-screen"&&ti("lobby")}),de.on("players-update",({players:e})=>{wn(e)}),de.on("lobby-map-update",({mapId:e})=>{const t=document.getElementById("lobby-map-select");t&&(t.value=e),Hi(`Host updated mission area to: ${e==="cyberlab"?"Neon Cyber-Lab":e==="arena"?"Neon Arena":"Residential Manor"}`)}),de.on("lobby-mode-update",({mode:e})=>{const t=document.getElementById("lobby-mode-select");t&&(t.value=e),qt=e;let i="Duel 1v1";e==="sabotage"&&(i="Sabotage (Task Survival)"),Hi(`Host updated game mode to: ${i}`)}),de.on("lobby-style-update",({renderStyle:e})=>{const t=document.getElementById("lobby-style-select");t&&(t.value=e),gi=e,Hi(`Host updated render style to: ${e==="competitive"?"Competitive":"Realistic"}`)}),de.on("player-left",({players:e,message:t})=>{wn(e),Hi(t);const i=document.querySelector(".screen.active"),s=i&&i.id==="game-screen";if(Ee&&s)if(Ee.active&&Ee.mode==="online"&&(Ee.gameState==="playing"||Ee.gameState==="countdown"||Ee.gameState==="replay")){if(ir(!0),Ee.isRanked){const r=parseInt(localStorage.getItem("tacticstrike_rp")||"0")+80;localStorage.setItem("tacticstrike_rp",String(r)),Ee.localPlayer&&(Ee.localPlayer.rp=r,Ee.localPlayer.rank=Ee.localPlayer._calcRank(r))}localStorage.removeItem("tacticstrike_active_match"),Ee.endGameDueToDisconnect(t)}else if(Ee.gameState==="match-over"){const a=document.getElementById("rematch-status");a&&(a.innerText="Opponent left the room.");const r=document.getElementById("btn-rematch");r&&(r.disabled=!0,r.innerText="OPPONENT LEFT")}else localStorage.removeItem("tacticstrike_active_match"),Ee.endGameDueToDisconnect(t)}),de.on("match-start",({players:e,seed:t,isRanked:i,mode:s,mapId:a,renderStyle:r})=>{xi=i?"ranked":"casual",r&&(gi=r),fn&&fn.classList.remove("active"),Tl(()=>{const l=e.findIndex(c=>c.id===de.id);at.chatMessages.innerHTML="",localStorage.setItem("tacticstrike_active_match",i?"ranked":"casual"),Ee&&Ee.destroy(),Ee=new ml("game-canvas",{mode:"online",socket:de,localPlayerId:de.id,localPlayerName:Ke,localWeapon:ut,localColor:ii,localPlayerIndex:l,players:e,seed:t,mapId:a||"manor",settings:{...We,volume:We.sfxMuted?0:We.volume},matchMode:s||qt,isRanked:!!i,qpRenderStyle:gi,onMatchEnd:Rl,onKillFeed:Pl}),ti("game")})}),de.on("opponent-requested-rematch",e=>{const t=document.getElementById("rematch-status");let i="Opponent";if(Ee&&e&&e.playerId){const s=Ee.players.find(a=>a.id===e.playerId);s&&(i=s.name)}t&&(t.innerText=`${i} requested a rematch! Click REMATCH to accept.`)})}function Sa(){de&&(de.disconnect(),de=null,Lt=null,window.AppSocket=null),at&&at.roomCode&&(at.roomCode.innerText="-----")}function eh(){const n=document.getElementById("deploy-modal");n&&n.classList.remove("active"),xi="practice",Tl(()=>{at.chatMessages.innerHTML="",Ee&&Ee.destroy();const t=[{id:"player",name:Ke,weapon:ut,color:ii}];qt==="2v2"?(t.push({id:"bot_enemy_1",name:"Bot Miller (Enemy)",weapon:Ma(),color:"red"}),t.push({id:"bot_teammate",name:"Bot Ramirez (Teammate)",weapon:Ma(),color:"green"}),t.push({id:"bot_enemy_2",name:"Bot Cooper (Enemy)",weapon:Ma(),color:"orange"})):t.push({id:"bot_enemy_1",name:"Bot Miller (Enemy)",weapon:Ma(),color:"red"}),Ee=new ml("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ke,localWeapon:ut,localColor:ii,localPlayerIndex:0,players:t,seed:Math.random(),mapId:ss,settings:{...We,volume:We.sfxMuted?0:We.volume},matchMode:qt,isRanked:!1,qpRenderStyle:gi,onMatchEnd:Rl,onKillFeed:Pl}),ti("game")})}function Ma(){return["pistol","rifle","shotgun","sniper","smg","lmg","dmr","vector","famas"][Math.floor(Math.random()*9)]}function Rl(n){localStorage.removeItem("tacticstrike_active_match"),fn&&fn.classList.add("active");const e=!!n.isWin;let t="";if(Ee&&Ee.mode==="online"){ir(e);const g=Ee.players.find(p=>p.id!==de.id);g&&Uy(g.name,e);const _=parseInt(ve.getItem("tacticstrike_credits")||"0");let m=_;if(Ee.isRanked&&e&&(m=_+50,ve.setItem("tacticstrike_credits",String(m)),t=' <span style="color:#ffd700; font-size:10px;">(+50 Credits Ranked Win Bonus!)</span>'),de){const p=Sl(),b=parseInt(ve.getItem("tacticstrike_rp")||"0"),v=ms();let x=[];try{x=JSON.parse(ve.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}de.emit("sync-device",{uuid:p,rp:b,wins:v.wins,losses:v.losses,name:Ke,credits:m,purchasedWeapons:x})}}const i=document.getElementById("match-result-title"),s=document.getElementById("match-result-subtitle");i&&(e?(i.innerText="MISSION ACCOMPLISHED",i.className="result-title win"):(i.innerText="MISSION FAILED",i.className="result-title lose")),s&&(e?s.innerText="You successfully eliminated the target operative.":s.innerText="You were eliminated by the target operative.");let a="Unknown Operative";if(Ee){const g=Ee.players.find(_=>_.id===n.winnerId);g&&(a=g.name)}const r=document.getElementById("match-winner-name");r&&(r.innerText=`WINNER: ${a}`,r.style.color=e?"#39db14":"#ff3c3c");const o=document.getElementById("stat-rounds-won");o&&(o.innerText=n.roundsWon||0);const l=document.getElementById("stat-damage-dealt");l&&(l.innerText=Math.round(n.damageDealt||0));const c=document.getElementById("stat-accuracy");c&&(c.innerText=`${Math.round(n.accuracy||0)}%`);const h=document.getElementById("stat-shots-fired");h&&(h.innerText=n.shotsFired||0);const f=document.getElementById("rematch-status");f&&(f.innerText="");const d=document.getElementById("btn-rematch");d&&(d.disabled=!1,d.innerText="REMATCH"),tt.returnLobby&&(Ee&&Ee.isRanked?tt.returnLobby.innerText="RETURN TO MENU":tt.returnLobby.innerText="RETURN TO LOBBY");const u=document.getElementById("rank-result-panel");if(u){if(Ee&&Ee.isRanked&&n.newRank){const g=n.newRank,_=n.rpDelta||0,m=_>=0?`+${_} RP`:`${_} RP`,p=_>=0?"#39ff14":"#ff3c3c";u.innerHTML=`
        ...
        `,u.style.display="block"}else u.innerHTML='<div style="font-family:var(--font-title); font-size:10px; color:var(--text-muted); text-align:center; letter-spacing:1.5px;">CASUAL MATCH - NO RANK EFFECT</div>',u.style.display="block";if(t){const g=document.createElement("div");g.style.cssText="font-family:var(--font-title); font-size:10px; text-align:center; margin-top:8px;",g.innerHTML=t,u.appendChild(g)}}}function Wy(){var ie;const n=document.getElementById("btn-deploy-main"),e=document.getElementById("btn-close-deploy"),t=document.getElementById("deploy-modal"),i=document.getElementById("btn-play-worldloom"),s=document.getElementById("btn-close-worldloom"),a=document.getElementById("btn-leave-worldloom-unsaved"),r=document.getElementById("btn-retry-worldloom"),o=document.getElementById("btn-return-worldloom"),l=document.getElementById("worldloom-site-screen"),c=document.getElementById("worldloom-frame"),h=document.getElementById("worldloom-frame-loading"),f=h==null?void 0:h.querySelector(".worldloom-frame-actions"),d=document.getElementById("worldloom-portal-status"),u=((ie=h==null?void 0:h.querySelector("small"))==null?void 0:ie.textContent)||"";let g=!1,_=!1,m=null,p=0,b=!1;const v=2500,x=new Map,y=l!=null&&l.parentElement?[...l.parentElement.children].filter(X=>X!==l):[],E=new Map,C=X=>{y.forEach(J=>{X?(E.set(J,J.hasAttribute("inert")),J.setAttribute("inert","")):E.get(J)?J.setAttribute("inert",""):J.removeAttribute("inert")}),X||E.clear()},S=()=>{d&&(d.hidden=!0,d.textContent=""),a&&(a.hidden=!0),f&&(f.hidden=!0),h==null||h.classList.remove("has-error")},w=(X,J=!0)=>{_=J,clearTimeout(m),m=null,h==null||h.classList.remove("is-hidden"),h==null||h.classList.toggle("has-error",J),h==null||h.setAttribute("aria-busy","false");const Te=h==null?void 0:h.querySelector("small");Te&&(Te.textContent=X),f&&(f.hidden=!1)},L=(X=!1)=>{g=!1,_=!1,S(),h==null||h.classList.remove("is-hidden"),h==null||h.setAttribute("aria-busy","true");const J=h==null?void 0:h.querySelector("small");if(J&&(J.textContent=u),clearTimeout(m),m=setTimeout(()=>{!g&&!_&&w("Worldloom is taking longer than expected. You can keep waiting, retry, or return.",!1)},9e3),!c)return;const Te=(i==null?void 0:i.dataset.worldloomPath)||"./worldloom/index.html";X&&c.removeAttribute("src"),c.getAttribute("src")||c.setAttribute("src",Te)},R=()=>{if(!g||!(c!=null&&c.contentWindow))return Promise.resolve(null);const X=`worldloom-save-${Date.now()}-${++p}`;return new Promise(J=>{const Te=setTimeout(()=>{x.delete(X),J(!1)},v);x.set(X,ze=>{clearTimeout(Te),x.delete(X),J(!!ze)}),c.contentWindow.postMessage({source:"tacticstrike",type:"request-save",requestId:X},window.location.origin)})};window.addEventListener("message",X=>{var Te;if(X.origin!==window.location.origin||X.source!==(c==null?void 0:c.contentWindow))return;const J=X.data;(J==null?void 0:J.source)==="worldloom"&&(J.type==="ready"?(g=!0,_=!1,clearTimeout(m),m=null,S(),h==null||h.setAttribute("aria-busy","false"),h==null||h.classList.add("is-hidden")):J.type==="save-ack"?(Te=x.get(J.requestId))==null||Te(J.saved):J.type==="error"&&h&&w(J.message||"Worldloom could not start safely. Retry or return to TacticStrike."))}),n&&t&&n.addEventListener("click",()=>{t.classList.add("active");const X=t.querySelector(".deploy-card");X&&(X.scrollTop=0),Dt(),xt.pause(),xt.currentTime=0,Nt||(mt.volume=.15,mt.currentTime=0,mt.play().catch(()=>{}))}),e&&t&&e.addEventListener("click",()=>{t.classList.remove("active"),Dt(),mt.pause(),mt.currentTime=0,Nt||El()}),i&&i.addEventListener("click",()=>{Dt(),window.stopAllMusic(),t&&t.classList.remove("active"),l&&(l.classList.add("active"),l.setAttribute("aria-hidden","false")),document.body.classList.add("is-worldloom-open"),C(!0),L(!1),s==null||s.focus()}),c&&c.addEventListener("load",()=>{c.getAttribute("src")&&!g&&!_&&(h==null||h.setAttribute("aria-busy","true"))});const P=()=>{clearTimeout(m),m=null,g=!1,_=!1,c&&c.removeAttribute("src"),l&&(l.classList.remove("active"),l.setAttribute("aria-hidden","true")),document.body.classList.remove("is-worldloom-open"),C(!1),S(),h==null||h.classList.remove("is-hidden"),h==null||h.setAttribute("aria-busy","false"),t&&t.classList.add("active"),Nt||(mt.volume=.15,mt.currentTime=0,mt.play().catch(()=>{})),i==null||i.focus(),s&&(s.disabled=!1),b=!1};s&&s.addEventListener("click",async()=>{if(b)return;b=!0,s.disabled=!0,Dt(),document.pointerLockElement&&document.exitPointerLock();const X=await R();if(g&&X===!1){d&&(d.textContent="SAVE FAILED — WORLD KEPT OPEN",d.hidden=!1),a&&(a.hidden=!1),s.disabled=!1,b=!1;return}P()}),a==null||a.addEventListener("click",()=>{l!=null&&l.classList.contains("active")&&P()}),r==null||r.addEventListener("click",()=>L(!0)),o==null||o.addEventListener("click",()=>s==null?void 0:s.click()),Oe.name&&Oe.name.addEventListener("change",()=>{Ke=Oe.name.value.trim()||"Operative",ve.setItem("tacticstrike_player_name",Ke),de&&de.connected&&de.emit("change-name",{name:Ke})}),tt.practiceBot&&tt.practiceBot.addEventListener("click",()=>{Oe.name&&(Ke=Oe.name.value.trim()||"Operative"),ve.setItem("tacticstrike_player_name",Ke),eh()}),tt.btnAmongUs&&tt.btnAmongUs.addEventListener("click",()=>{Oe.name&&(Ke=Oe.name.value.trim()||"Operative"),ve.setItem("tacticstrike_player_name",Ke);const X=document.getElementById("deploy-modal");X&&X.classList.remove("active"),xi="practice",Tl(()=>{at.chatMessages.innerHTML="",Ee&&Ee.destroy();const Te=[{id:"player",name:Ke,weapon:"none",color:ii},{id:"bot_enemy_1",name:"Impostor Killer",weapon:"pistol",color:"red"}];Ee=new ml("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ke,localWeapon:"none",localColor:ii,localPlayerIndex:0,players:Te,seed:Math.random(),mapId:ss,settings:{...We,volume:We.sfxMuted?0:We.volume},matchMode:"sabotage",isRanked:!1,qpRenderStyle:gi,onMatchEnd:Rl,onKillFeed:Pl}),ti("game")})}),tt.createRoom&&tt.createRoom.addEventListener("click",()=>{const X=document.getElementById("deploy-modal");X&&X.classList.remove("active"),Oe.name&&(Ke=Oe.name.value.trim()||"Operative"),ve.setItem("tacticstrike_player_name",Ke),Ua(),de&&de.emit("create-room",{playerName:Ke,mode:qt,color:ii,mapId:ss,weapon:ut,renderStyle:gi})}),tt.joinRoom&&tt.joinRoom.addEventListener("click",()=>{const X=document.getElementById("deploy-modal");X&&X.classList.remove("active");const J=Oe.roomCode?Oe.roomCode.value.toUpperCase().trim():"";if(!J||J.length!==5){alert("Please enter a valid 5-character room code.");return}Oe.name&&(Ke=Oe.name.value.trim()||"Operative"),ve.setItem("tacticstrike_player_name",Ke),Ua(),de&&de.emit("join-room",{roomId:J,playerName:Ke,color:ii,weapon:ut})});function O(X){const J=document.getElementById("deploy-modal");if(J&&J.classList.remove("active"),Oe.name&&(Ke=Oe.name.value.trim()||"Operative"),ve.setItem("tacticstrike_player_name",Ke),Ua(),de){const Te=parseInt(localStorage.getItem("tacticstrike_rp")||"0");ka=!1;const ze=qt+"_"+X;de.emit("auto-match",{playerName:Ke,mode:ze,color:ii,rp:Te,rankStrict:!0,weapon:ut}),ti("matchmaking");const Pe=document.getElementById("mm-rank-display"),Y=document.getElementById("mm-rank-icon"),se=document.getElementById("mm-timer"),ne=document.getElementById("mm-expand-notice"),Me=wl(Te);Pe&&(Pe.innerText=Me.label),Y&&(Y.innerText=Me.icon,Y.style.color=Me.color),se&&(se.innerText="0s"),ne&&(ne.innerText="Searching within your skill bracket...");let Ie=0;window.mmInterval&&clearInterval(window.mmInterval),window.mmInterval=setInterval(()=>{Ie++,se&&(se.innerText=`${Ie}s`)},1e3);let Ce=0;const Ze=document.getElementById("mm-dots");window.mmDotsInterval&&clearInterval(window.mmDotsInterval),window.mmDotsInterval=setInterval(()=>{Ce=(Ce+1)%4,Ze&&(Ze.innerText=".".repeat(Ce))},500),cn&&clearTimeout(cn),cn=setTimeout(()=>{!ka&&de&&de.connected&&(!Lt||Na&&Na.length===1)&&(ka=!0,Hi("⚡ Rank filter removed — expanding search to all ranks..."),ne&&(ne.innerText="⚡ Search expanded to all skill ranks!"),Lt&&(de.emit("leave-room"),Lt=null),de.emit("auto-match",{playerName:Ke,mode:ze,color:ii,rp:Te,rankStrict:!1,weapon:ut}))},2e3)}}tt.rankedRealistic&&tt.rankedRealistic.addEventListener("click",()=>O("realistic")),tt.rankedCompetitive&&tt.rankedCompetitive.addEventListener("click",()=>O("competitive"));const N=document.getElementById("btn-cancel-matchmaking");N&&N.addEventListener("click",()=>{window.mmInterval&&clearInterval(window.mmInterval),cn&&clearTimeout(cn),de&&de.emit("leave-room"),Sa(),window.stopAllMusic(),ti("menu")}),tt.leaveLobby&&tt.leaveLobby.addEventListener("click",()=>{de&&Lt&&de.emit("leave-room"),Sa(),ti("menu")}),tt.readyToggle&&tt.readyToggle.addEventListener("click",()=>{if(de&&Lt){const X=!Ds;de.emit("player-ready",{ready:X}),Jh()}}),tt.copyCode&&tt.copyCode.addEventListener("click",()=>{Lt&&navigator.clipboard.writeText(Lt).then(()=>{tt.copyCode.innerText="✅",setTimeout(()=>tt.copyCode.innerText="📋",1500)})}),tt.returnLobby&&tt.returnLobby.addEventListener("click",()=>{fn&&fn.classList.remove("active");const X=document.getElementById("rank-result-panel");X&&(X.style.display="none",X.innerHTML=""),Ee&&(Ee.destroy(),Ee=null),Al(),de&&Lt&&xi!=="ranked"?(ti("lobby"),Ds=!1,wn(Na),gs(ut)):(de&&de.emit("leave-room"),Sa(),ti("menu"))});const I=document.getElementById("btn-game-menu"),B=document.getElementById("game-menu-overlay"),F=document.getElementById("btn-game-resume"),K=document.getElementById("btn-game-leave");I&&B&&I.addEventListener("click",()=>{B.classList.add("active")}),F&&B&&F.addEventListener("click",()=>{B.classList.remove("active")}),K&&B&&K.addEventListener("click",()=>{console.log("LEAVE MATCH clicked. Cleaning up game session...");try{if(B.classList.remove("active"),Ee){try{if(Ee.active&&Ee.mode==="online"&&(ir(!1),Ee.isRanked)){const X=parseInt(localStorage.getItem("tacticstrike_rp")||"0"),J=Math.max(0,X-40);localStorage.setItem("tacticstrike_rp",String(J))}}catch(X){console.error("Error recording match result during leave:",X)}localStorage.removeItem("tacticstrike_active_match");try{Ee.destroy()}catch(X){console.error("Error destroying gameEngine:",X)}Ee=null}}catch(X){console.error("Error in leave match handler pre-disconnect:",X)}try{de&&Lt&&de.emit("leave-room")}catch(X){console.error("Error emitting leave-room:",X)}try{Sa()}catch(X){console.error("Error disconnecting socket:",X)}try{ti("menu")}catch(X){console.error("Error showing menu screen:",X)}});const Q=document.getElementById("btn-rematch");Q&&Q.addEventListener("click",()=>{if(Ee&&Ee.mode==="offline")fn&&fn.classList.remove("active"),Ee&&(Ee.destroy(),Ee=null),eh();else{Q.disabled=!0,Q.innerText="WAITING...";const X=document.getElementById("rematch-status");X&&(X.innerText="Rematch requested. Waiting for opponent..."),de&&de.emit("request-rematch")}}),window.addEventListener("keydown",X=>{X.key==="Enter"&&(X.preventDefault(),Oe.chat&&document.activeElement===Oe.chat?Gy():mi.game&&mi.game.classList.contains("active")&&at.chatDrawer&&Oe.chat&&(at.chatDrawer.classList.add("active"),Oe.chat.focus()))}),Oe.chat&&Oe.chat.addEventListener("blur",()=>{setTimeout(()=>{Oe.chat&&document.activeElement!==Oe.chat&&at.chatDrawer&&at.chatDrawer.classList.remove("active")},100)}),Oe.qpMapSelect&&(Oe.qpMapSelect.value=ss,Oe.qpMapSelect.addEventListener("change",X=>{ss=X.target.value,ve.setItem("tacticstrike_selected_map",ss),Dt()})),Oe.lobbyMapSelect&&Oe.lobbyMapSelect.addEventListener("change",X=>{const J=X.target.value;de&&Lt&&de.emit("select-map",{mapId:J}),Dt()}),Oe.lobbyModeSelect&&Oe.lobbyModeSelect.addEventListener("change",X=>{const J=X.target.value;de&&Lt&&de.emit("select-game-mode",{mode:J}),Dt()}),Oe.lobbyStyleSelect&&Oe.lobbyStyleSelect.addEventListener("change",X=>{const J=X.target.value;de&&Lt&&de.emit("select-render-style",{renderStyle:J}),Dt()})}function Gy(){if(!Oe.chat)return;const n=Oe.chat.value.trim();n&&(Cl(Ke,n,"self"),de&&Lt&&de.emit("chat-message",{name:Ke,msg:n}),Oe.chat.value=""),Oe.chat.blur()}function Cl(n,e,t){const i=document.createElement("div");i.className=`chat-msg ${t}`,t==="system"?i.innerHTML=`<span class="message">${kn(e)}</span>`:i.innerHTML=`
