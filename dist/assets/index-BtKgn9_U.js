...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function J0(n,e,t){const i=new Float32Array(Un),s=new V(0,1,0);return new zi({name:"SphericalGaussianBlur",defines:{n:Un,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Zc(){return new zi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Jc(){return new zi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:pr(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function pr(){return`
	...
	`}class xd extends Ui{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new dd(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new bn(5,5,5),a=new zi({name:"CubemapFromEquirect",uniforms:_s(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:ii,blending:Qi});a.uniforms.tEquirect.value=t;const r=new ft(s,a),o=t.minFilter;return t.minFilter===Bn&&(t.minFilter=$t),new sp(1,10,this).update(e,r),t.minFilter=o,r.geometry.dispose(),r.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){const a=e.getRenderTarget();for(let r=0;r<6;r++)e.setRenderTarget(this,r),e.clear(t,i,s);e.setRenderTarget(a)}}function Q0(n){let e=new WeakMap,t=new WeakMap,i=null;function s(d,f=!1){return d==null?null:f?r(d):a(d)}function a(d){if(d&&d.isTexture){const f=d.mapping;if(f===Tr||f===wr)if(e.has(d)){const p=e.get(d).texture;return o(p,d.mapping)}else{const p=d.image;if(p&&p.height>0){const v=new xd(p.height);return v.fromEquirectangularTexture(n,d),e.set(d,v),d.addEventListener("dispose",c),o(v.texture,d.mapping)}else return null}}return d}function r(d){if(d&&d.isTexture){const f=d.mapping,p=f===Tr||f===wr,v=f===Gn||f===xs;if(p||v){let g=t.get(d);const m=g!==void 0?g.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==m)return i===null&&(i=new Kc(n)),g=p?i.fromEquirectangular(d,g):i.fromCubemap(d,g),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),g.texture;if(g!==void 0)return g.texture;{const M=d.image;return p&&M&&M.height>0||v&&M&&l(M)?(i===null&&(i=new Kc(n)),g=p?i.fromEquirectangular(d):i.fromCubemap(d),g.texture.pmremVersion=d.pmremVersion,t.set(d,g),d.addEventListener("dispose",h),g.texture):null}}}return d}function o(d,f){return f===Tr?d.mapping=Gn:f===wr&&(d.mapping=xs),d}function l(d){let f=0;const p=6;for(let v=0;v<p;v++)d[v]!==void 0&&f++;return f===p}function c(d){const f=d.target;f.removeEventListener("dispose",c);const p=e.get(f);p!==void 0&&(e.delete(f),p.dispose())}function h(d){const f=d.target;f.removeEventListener("dispose",h);const p=t.get(f);p!==void 0&&(t.delete(f),p.dispose())}function u(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:u}}function eg(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&hl("WebGLRenderer: "+i+" extension not supported."),s}}}function tg(n,e,t,i){const s={},a=new WeakMap;function r(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const p in d.attributes)e.remove(d.attributes[p]);d.removeEventListener("dispose",r),delete s[d.id];const f=a.get(d);f&&(e.remove(f),a.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",r),s[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const f in d)e.update(d[f],n.ARRAY_BUFFER)}function c(u){const d=[],f=u.index,p=u.attributes.position;let v=0;if(p===void 0)return;if(f!==null){const M=f.array;v=f.version;for(let _=0,x=M.length;_<x;_+=3){const y=M[_+0],E=M[_+1],A=M[_+2];d.push(y,E,E,A,A,y)}}else{const M=p.array;v=p.version;for(let _=0,x=M.length/3-1;_<x;_+=3){const y=_+0,E=_+1,A=_+2;d.push(y,E,E,A,A,y)}}const g=new(p.count>=65535?hd:cd)(d,1);g.version=v;const m=a.get(u);m&&e.remove(m),a.set(u,g)}function h(u){const d=a.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return a.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function ig(n,e,t){let i;function s(u){i=u}let a,r;function o(u){a=u.type,r=u.bytesPerElement}function l(u,d){n.drawElements(i,d,a,u*r),t.update(d,i,1)}function c(u,d,f){f!==0&&(n.drawElementsInstanced(i,d,a,u*r,f),t.update(d,i,f))}function h(u,d,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,a,u,0,f);let v=0;for(let g=0;g<f;g++)v+=d[g];t.update(v,i,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function ng(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,r,o){switch(t.calls++,r){case n.TRIANGLES:t.triangles+=o*(a/3);break;case n.LINES:t.lines+=o*(a/2);break;case n.LINE_STRIP:t.lines+=o*(a-1);break;case n.LINE_LOOP:t.lines+=o*a;break;case n.POINTS:t.points+=o*a;break;default:et("WebGLInfo: Unknown draw mode:",r);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function sg(n,e,t){const i=new WeakMap,s=new Mt;function a(r,o,l){const c=r.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=i.get(o);if(d===void 0||d.count!==u){let P=function(){S.dispose(),i.delete(o),o.removeEventListener("dispose",P)};var f=P;d!==void 0&&d.texture.dispose();const p=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,g=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],M=o.morphAttributes.normal||[],_=o.morphAttributes.color||[];let x=0;p===!0&&(x=1),v===!0&&(x=2),g===!0&&(x=3);let y=o.attributes.position.count*x,E=1;y>e.maxTextureSize&&(E=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const A=new Float32Array(y*E*4*u),S=new rd(A,y,E,u);S.type=Li,S.needsUpdate=!0;const w=x*4;for(let C=0;C<u;C++){const L=m[C],z=M[C],U=_[C],I=y*E*4*C;for(let B=0;B<L.count;B++){const N=B*w;p===!0&&(s.fromBufferAttribute(L,B),A[I+N+0]=s.x,A[I+N+1]=s.y,A[I+N+2]=s.z,A[I+N+3]=0),v===!0&&(s.fromBufferAttribute(z,B),A[I+N+4]=s.x,A[I+N+5]=s.y,A[I+N+6]=s.z,A[I+N+7]=0),g===!0&&(s.fromBufferAttribute(U,B),A[I+N+8]=s.x,A[I+N+9]=s.y,A[I+N+10]=s.z,A[I+N+11]=U.itemSize===4?s.w:1)}}d={count:u,texture:S,size:new st(y,E)},i.set(o,d),o.addEventListener("dispose",P)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",r.morphTexture,t);else{let p=0;for(let g=0;g<c.length;g++)p+=c[g];const v=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(n,"morphTargetBaseInfluence",v),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:a}}function ag(n,e,t,i,s){let a=new WeakMap;function r(c){const h=s.render.frame,u=c.geometry,d=e.get(c,u);if(a.get(d)!==h&&(e.update(d),a.set(d,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),a.get(c)!==h&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),a.set(c,h))),c.isSkinnedMesh){const f=c.skeleton;a.get(f)!==h&&(f.update(),a.set(f,h))}return d}function o(){a=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),i.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:r,dispose:o}}const rg={[Gh]:"LINEAR_TONE_MAPPING",[Xh]:"REINHARD_TONE_MAPPING",[qh]:"CINEON_TONE_MAPPING",[$h]:"ACES_FILMIC_TONE_MAPPING",[Kh]:"AGX_TONE_MAPPING",[jh]:"NEUTRAL_TONE_MAPPING",[Yh]:"CUSTOM_TONE_MAPPING"};function og(n,e,t,i,s){const a=new Ui(e,t,{type:n,depthBuffer:i,stencilBuffer:s,depthTexture:i?new vs(e,t):void 0}),r=new Ui(e,t,{type:tn,depthBuffer:!1,stencilBuffer:!1}),o=new Ti;o.setAttribute("position",new ei([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new ei([0,2,0,0,2,0],2));const l=new Jf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new ft(o,l),h=new fr(-1,1,1,-1,0,1);let u=null,d=null,f=!1,p,v=null,g=[],m=!1;this.setSize=function(M,_){a.setSize(M,_),r.setSize(M,_);for(let x=0;x<g.length;x++){const y=g[x];y.setSize&&y.setSize(M,_)}},this.setEffects=function(M){g=M,m=g.length>0&&g[0].isRenderPass===!0;const _=a.width,x=a.height;for(let y=0;y<g.length;y++){const E=g[y];E.setSize&&E.setSize(_,x)}},this.begin=function(M,_){if(f||M.toneMapping===ki&&g.length===0)return!1;if(v=_,_!==null){const x=_.width,y=_.height;(a.width!==x||a.height!==y)&&this.setSize(x,y)}return m===!1&&M.setRenderTarget(a),p=M.toneMapping,M.toneMapping=ki,!0},this.hasRenderPass=function(){return m},this.end=function(M,_){M.toneMapping=p,f=!0;let x=a,y=r;for(let E=0;E<g.length;E++){const A=g[E];if(A.enabled!==!1&&(A.render(M,y,x,_),A.needsSwap!==!1)){const S=x;x=y,y=S}}if(u!==M.outputColorSpace||d!==M.toneMapping){u=M.outputColorSpace,d=M.toneMapping,l.defines={},je.getTransfer(u)===ot&&(l.defines.SRGB_TRANSFER="");const E=rg[d];E&&(l.defines[E]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=x.texture,M.setRenderTarget(v),M.render(c,h),v=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),r.dispose(),o.dispose(),l.dispose()}}const vd=new Qt,ul=new vs(1,1),_d=new rd,Sd=new Rf,Md=new dd,Qc=[],eh=[],th=new Float32Array(16),ih=new Float32Array(9),nh=new Float32Array(4);function As(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let a=Qc[s];if(a===void 0&&(a=new Float32Array(s),Qc[s]=a),e!==0){i.toArray(a,0);for(let r=1,o=0;r!==e;++r)o+=t,n[r].toArray(a,o)}return a}function Bt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Ot(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function mr(n,e){let t=eh[e];t===void 0&&(t=new Int32Array(e),eh[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function lg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function cg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;n.uniform2fv(this.addr,e),Ot(t,e)}}function hg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Bt(t,e))return;n.uniform3fv(this.addr,e),Ot(t,e)}}function dg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;n.uniform4fv(this.addr,e),Ot(t,e)}}function ug(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Bt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Ot(t,e)}else{if(Bt(t,i))return;nh.set(i),n.uniformMatrix2fv(this.addr,!1,nh),Ot(t,i)}}function fg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Bt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Ot(t,e)}else{if(Bt(t,i))return;ih.set(i),n.uniformMatrix3fv(this.addr,!1,ih),Ot(t,i)}}function pg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Bt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Ot(t,e)}else{if(Bt(t,i))return;th.set(i),n.uniformMatrix4fv(this.addr,!1,th),Ot(t,i)}}function mg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function gg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;n.uniform2iv(this.addr,e),Ot(t,e)}}function yg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;n.uniform3iv(this.addr,e),Ot(t,e)}}function xg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;n.uniform4iv(this.addr,e),Ot(t,e)}}function vg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function _g(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;n.uniform2uiv(this.addr,e),Ot(t,e)}}function Sg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;n.uniform3uiv(this.addr,e),Ot(t,e)}}function Mg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;n.uniform4uiv(this.addr,e),Ot(t,e)}}function bg(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let a;this.type===n.SAMPLER_2D_SHADOW?(ul.compareFunction=t.isReversedDepthBuffer()?Bl:Ul,a=ul):a=vd,t.setTexture2D(e||a,s)}function Eg(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||Sd,s)}function Tg(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||Md,s)}function wg(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||_d,s)}function Ag(n){switch(n){case 5126:return lg;case 35664:return cg;case 35665:return hg;case 35666:return dg;case 35674:return ug;case 35675:return fg;case 35676:return pg;case 5124:case 35670:return mg;case 35667:case 35671:return gg;case 35668:case 35672:return yg;case 35669:case 35673:return xg;case 5125:return vg;case 36294:return _g;case 36295:return Sg;case 36296:return Mg;case 35678:case 36198:case 36298:case 36306:case 35682:return bg;case 35679:case 36299:case 36307:return Eg;case 35680:case 36300:case 36308:case 36293:return Tg;case 36289:case 36303:case 36311:case 36292:return wg}}function Rg(n,e){n.uniform1fv(this.addr,e)}function Cg(n,e){const t=As(e,this.size,2);n.uniform2fv(this.addr,t)}function Pg(n,e){const t=As(e,this.size,3);n.uniform3fv(this.addr,t)}function Ig(n,e){const t=As(e,this.size,4);n.uniform4fv(this.addr,t)}function Lg(n,e){const t=As(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Dg(n,e){const t=As(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Ng(n,e){const t=As(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function kg(n,e){n.uniform1iv(this.addr,e)}function Ug(n,e){n.uniform2iv(this.addr,e)}function Bg(n,e){n.uniform3iv(this.addr,e)}function Og(n,e){n.uniform4iv(this.addr,e)}function Fg(n,e){n.uniform1uiv(this.addr,e)}function zg(n,e){n.uniform2uiv(this.addr,e)}function Vg(n,e){n.uniform3uiv(this.addr,e)}function Hg(n,e){n.uniform4uiv(this.addr,e)}function Wg(n,e,t){const i=this.cache,s=e.length,a=mr(t,s);Bt(i,a)||(n.uniform1iv(this.addr,a),Ot(i,a));let r;this.type===n.SAMPLER_2D_SHADOW?r=ul:r=vd;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||r,a[o])}function Gg(n,e,t){const i=this.cache,s=e.length,a=mr(t,s);Bt(i,a)||(n.uniform1iv(this.addr,a),Ot(i,a));for(let r=0;r!==s;++r)t.setTexture3D(e[r]||Sd,a[r])}function Xg(n,e,t){const i=this.cache,s=e.length,a=mr(t,s);Bt(i,a)||(n.uniform1iv(this.addr,a),Ot(i,a));for(let r=0;r!==s;++r)t.setTextureCube(e[r]||Md,a[r])}function qg(n,e,t){const i=this.cache,s=e.length,a=mr(t,s);Bt(i,a)||(n.uniform1iv(this.addr,a),Ot(i,a));for(let r=0;r!==s;++r)t.setTexture2DArray(e[r]||_d,a[r])}function $g(n){switch(n){case 5126:return Rg;case 35664:return Cg;case 35665:return Pg;case 35666:return Ig;case 35674:return Lg;case 35675:return Dg;case 35676:return Ng;case 5124:case 35670:return kg;case 35667:case 35671:return Ug;case 35668:case 35672:return Bg;case 35669:case 35673:return Og;case 5125:return Fg;case 36294:return zg;case 36295:return Vg;case 36296:return Hg;case 35678:case 36198:case 36298:case 36306:case 35682:return Wg;case 35679:case 36299:case 36307:return Gg;case 35680:case 36300:case 36308:case 36293:return Xg;case 36289:case 36303:case 36311:case 36292:return qg}}class Yg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Ag(t.type)}}class Kg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$g(t.type)}}class jg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let a=0,r=s.length;a!==r;++a){const o=s[a];o.setValue(e,t[o.id],i)}}}const so=/(\w+)(\])?(\[|\.)?/g;function sh(n,e){n.seq.push(e),n.map[e.id]=e}function Zg(n,e,t){const i=n.name,s=i.length;for(so.lastIndex=0;;){const a=so.exec(i),r=so.lastIndex;let o=a[1];const l=a[2]==="]",c=a[3];if(l&&(o=o|0),c===void 0||c==="["&&r+2===s){sh(t,c===void 0?new Yg(o,n,e):new Kg(o,n,e));break}else{let u=t.map[o];u===void 0&&(u=new jg(o),sh(t,u)),t=u}}}class Va{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const o=e.getActiveUniform(t,r),l=e.getUniformLocation(t,o.name);Zg(o,l,this)}const s=[],a=[];for(const r of this.seq)r.type===e.SAMPLER_2D_SHADOW||r.type===e.SAMPLER_CUBE_SHADOW||r.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(r):a.push(r);s.length>0&&(this.seq=s.concat(a))}setValue(e,t,i,s){const a=this.map[t];a!==void 0&&a.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let a=0,r=t.length;a!==r;++a){const o=t[a],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,a=e.length;s!==a;++s){const r=e[s];r.id in t&&i.push(r)}return i}}function ah(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Jg=37297;let Qg=0;function ey(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),a=Math.min(e+6,t.length);for(let r=s;r<a;r++){const o=r+1;i.push(`${o===e?">":" "} ${o}: ${t[r]}`)}return i.join(`
`)}const rh=new Be;function ty(n){je._getMatrix(rh,je.workingColorSpace,n);const e=`mat3( ${rh.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(n)){case Ka:return[e,"LinearTransferOETF"];case ot:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function oh(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),a=(n.getShaderInfoLog(e)||"").trim();if(i&&a==="")return"";const r=/ERROR: 0:(\d+)/.exec(a);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+a+`

`+ey(n.getShaderSource(e),o)}else return a}function iy(n,e){const t=ty(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const ny={[Gh]:"Linear",[Xh]:"Reinhard",[qh]:"Cineon",[$h]:"ACESFilmic",[Kh]:"AgX",[jh]:"Neutral",[Yh]:"Custom"};function sy(n,e){const t=ny[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ea=new V;function ay(){je.getLuminanceCoefficients(Ea);const n=Ea.x.toFixed(4),e=Ea.y.toFixed(4),t=Ea.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ry(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zs).join(`
`)}function oy(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function ly(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const a=n.getActiveAttrib(e,s),r=a.name;let o=1;a.type===n.FLOAT_MAT2&&(o=2),a.type===n.FLOAT_MAT3&&(o=3),a.type===n.FLOAT_MAT4&&(o=4),t[r]={type:a.type,location:n.getAttribLocation(e,r),locationSize:o}}return t}function zs(n){return n!==""}function lh(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ch(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const cy=/^[ \t]*#include +<([\w\d./]+)>/gm;function fl(n){return n.replace(cy,dy)}const hy=new Map;function dy(n,e){let t=He[e];if(t===void 0){const i=hy.get(e);if(i!==void 0)t=He[i],De('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return fl(t)}const uy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function hh(n){return n.replace(uy,fy)}function fy(n,e,t,i){let s="";for(let a=parseInt(e);a<parseInt(t);a++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return s}function dh(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const py={[Ua]:"SHADOWMAP_TYPE_PCF",[Fs]:"SHADOWMAP_TYPE_VSM"};function my(n){return py[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const gy={[Gn]:"ENVMAP_TYPE_CUBE",[xs]:"ENVMAP_TYPE_CUBE",[dr]:"ENVMAP_TYPE_CUBE_UV"};function yy(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":gy[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const xy={[xs]:"ENVMAP_MODE_REFRACTION"};function vy(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":xy[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const _y={[Wh]:"ENVMAP_BLENDING_MULTIPLY",[of]:"ENVMAP_BLENDING_MIX",[lf]:"ENVMAP_BLENDING_ADD"};function Sy(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":_y[n.combine]||"ENVMAP_BLENDING_NONE"}function My(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function by(n,e,t,i){const s=n.getContext(),a=t.defines;let r=t.vertexShader,o=t.fragmentShader;const l=my(t),c=yy(t),h=vy(t),u=Sy(t),d=My(t),f=ry(t),p=oy(a),v=s.createProgram();let g,m,M=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const _=M+g+r,x=M+m+o,y=ah(s,s.VERTEX_SHADER,_),E=ah(s,s.FRAGMENT_SHADER,x);s.attachShader(v,y),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function A(C){if(n.debug.checkShaderErrors){const L=s.getProgramInfoLog(v)||"",z=s.getShaderInfoLog(y)||"",U=s.getShaderInfoLog(E)||"",I=L.trim(),B=z.trim(),N=U.trim();let Y=!0,te=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,y,E);else{const se=oh(s,y,"vertex"),he=oh(s,E,"fragment");et("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
Leaving ranked matches results in a temporary ban.`,confirmText:"UNDERSTOOD",tone:"ban"});return}const ae=document.getElementById("deploy-modal");if(ae&&ae.classList.remove("active"),Ue.name&&(Ye=Ue.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye),Wa(),ce){const G=parseInt(localStorage.getItem("tacticstrike_rp")||"0");Vs=!1;const Z=Ht+"_"+q;ce.emit("auto-match",{playerName:Ye,mode:Z,color:Jt,rp:G,rankStrict:!0,weapon:ht}),Zt("matchmaking");const J=document.getElementById("mm-rank-display"),Se=document.getElementById("mm-rank-icon"),Ae=document.getElementById("mm-timer"),Ce=document.getElementById("mm-expand-notice"),tt=Id(G);J&&(J.innerText=tt.label),Se&&(Se.innerText=tt.icon,Se.style.color=tt.color),Ae&&(Ae.innerText="0s"),Ce&&(Ce.innerText="Searching within your skill bracket...");let Ne=0;window.mmInterval&&clearInterval(window.mmInterval),window.mmInterval=setInterval(()=>{Ne++,Ae&&(Ae.innerText=`${Ne}s`)},1e3);let Xe=0;const Je=document.getElementById("mm-dots");window.mmDotsInterval&&clearInterval(window.mmDotsInterval),window.mmDotsInterval=setInterval(()=>{Xe=(Xe+1)%4,Je&&(Je.innerText=".".repeat(Xe))},500),yi&&clearTimeout(yi),yi=setTimeout(()=>{!Vs&&ce&&ce.connected&&(!At||us&&us.length===1)&&(Vs=!0,Pi("⚡ Rank filter removed — expanding search to all ranks..."),Ce&&(Ce.innerText="⚡ Search expanded to all skill ranks!"),At&&(ce.emit("leave-room"),At=null),ce.emit("auto-match",{playerName:Ye,mode:Z,color:Jt,rp:G,rankStrict:!1,weapon:ht}))},2e3);const We=15e3+Math.floor(Math.random()*46e3);qt&&clearTimeout(qt),qt=setTimeout(()=>{qt=null;const vt=document.querySelector(".screen.active");!vt||vt.id!=="matchmaking-screen"||At&&us&&us.length>1||I(q)},We)}}function I(q){window.mmInterval&&clearInterval(window.mmInterval),window.mmDotsInterval&&clearInterval(window.mmDotsInterval),yi&&(clearTimeout(yi),yi=null),qt&&(clearTimeout(qt),qt=null),Vs=!0;const K=document.getElementById("mm-expand-notice"),ae=document.getElementById("mm-dots"),G=document.getElementById("mm-timer");K&&(K.innerText="GAME FOUND — DEPLOYING..."),ae&&(ae.innerText=""),G&&(G.innerText=""),ce&&ce.emit("leave-room"),Bs(),At=null;const Z=mo();ui="ranked";const J=()=>{rt.chatMessages.innerHTML="",xe&&xe.destroy(),localStorage.setItem("tacticstrike_active_match","ranked");const Se=[{id:"player",name:Ye,weapon:ht,color:Jt}];Ht==="2v2"?(Se.push({id:"bot_enemy_1",name:Z,weapon:_n(),color:"red"}),Se.push({id:"bot_teammate",name:mo(),weapon:_n(),color:"green"}),Se.push({id:"bot_enemy_2",name:mo(),weapon:_n(),color:"orange"})):Se.push({id:"bot_enemy_1",name:Z,weapon:_n(),color:"red"}),xe=new Ja("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ye,localWeapon:ht,localColor:Jt,localPlayerIndex:0,players:Se,seed:Math.random(),mapId:fn,settings:{...Ve,volume:Ve.sfxMuted?0:Ve.volume},matchMode:Ht,isRanked:!0,qpRenderStyle:q,onMatchEnd:nr,onKillFeed:sr}),Pi(`Game found! Playing against ${Z}.`),Zt("game")};setTimeout(()=>ir(J),1200)}nt.rankedRealistic&&nt.rankedRealistic.addEventListener("click",()=>U("realistic")),nt.rankedCompetitive&&nt.rankedCompetitive.addEventListener("click",()=>U("competitive"));const B=document.getElementById("btn-cancel-matchmaking");B&&B.addEventListener("click",()=>{window.mmInterval&&clearInterval(window.mmInterval),yi&&clearTimeout(yi),qt&&(clearTimeout(qt),qt=null),ce&&ce.emit("leave-room"),Bs(),window.stopAllMusic(),Zt("menu")}),nt.leaveLobby&&nt.leaveLobby.addEventListener("click",()=>{ce&&At&&ce.emit("leave-room"),Bs(),Zt("menu")}),nt.readyToggle&&nt.readyToggle.addEventListener("click",()=>{if(ce&&At){const q=!Gs;ce.emit("player-ready",{ready:q}),Rd()}}),nt.copyCode&&nt.copyCode.addEventListener("click",()=>{At&&navigator.clipboard.writeText(At).then(()=>{nt.copyCode.innerText="✅",setTimeout(()=>nt.copyCode.innerText="📋",1500)})}),nt.returnLobby&&nt.returnLobby.addEventListener("click",()=>{xn&&xn.classList.remove("active");const q=document.getElementById("rank-result-panel");q&&(q.style.display="none",q.innerHTML=""),xe&&(xe.destroy(),xe=null),Yl(),ce&&At&&ui!=="ranked"?(Zt("lobby"),Gs=!1,Nn(us),Es(ht)):(ce&&ce.emit("leave-room"),Bs(),Zt("menu"))});const N=document.getElementById("btn-game-menu"),Y=document.getElementById("game-menu-overlay"),te=document.getElementById("btn-game-resume"),se=document.getElementById("btn-game-leave");N&&Y&&N.addEventListener("click",()=>{Y.classList.add("active")}),te&&Y&&te.addEventListener("click",()=>{Y.classList.remove("active")}),se&&Y&&se.addEventListener("click",async()=>{if(xe&&xe.active&&xe.gameState!=="match-over"){let K;if(xe.isRanked?K={title:"MATCHMAKING BAN WARNING",message:"Leaving this ranked match will count it as a LOSS (-40 RP) and give you a 5-minute MATCHMAKING BAN.",confirmText:"LEAVE MATCH",cancelText:"STAY IN MATCH",tone:"danger"}:xe.mode==="online"?K={title:"LEAVE MATCH",message:"Leaving this online match will count it as a LOSS.",confirmText:"LEAVE MATCH",cancelText:"STAY IN MATCH",tone:"info"}:K={title:"LEAVE MATCH",message:"Your current match progress will be lost.",confirmText:"LEAVE",cancelText:"STAY",tone:"info"},!await rr(K)){Y.classList.remove("active");return}}console.log("LEAVE MATCH clicked. Cleaning up game session...");try{if(Y.classList.remove("active"),xe){try{if(xe.active&&(xe.mode==="online"||xe.isRanked)&&xe.gameState!=="match-over"&&(xr(!1),xe.isRanked)){const K=parseInt(localStorage.getItem("tacticstrike_rp")||"0"),ae=Math.max(0,K-40);localStorage.setItem("tacticstrike_rp",String(ae)),localStorage.setItem("tacticstrike_mm_ban_until",String(Date.now()+5*60*1e3))}}catch(K){console.error("Error recording match result during leave:",K)}localStorage.removeItem("tacticstrike_active_match");try{xe.destroy()}catch(K){console.error("Error destroying gameEngine:",K)}xe=null}}catch(K){console.error("Error in leave match handler pre-disconnect:",K)}try{ce&&At&&ce.emit("leave-room")}catch(K){console.error("Error emitting leave-room:",K)}try{Bs()}catch(K){console.error("Error disconnecting socket:",K)}try{Zt("menu")}catch(K){console.error("Error showing menu screen:",K)}}),window.addEventListener("beforeunload",q=>{if(xe&&xe.active&&xe.gameState!=="match-over")return q.preventDefault(),q.returnValue="",""});const he=document.getElementById("btn-rematch");if(he&&he.addEventListener("click",()=>{if(xe&&xe.mode==="offline")xn&&xn.classList.remove("active"),xe&&(xe.destroy(),xe=null),Th();else{he.disabled=!0,he.innerText="WAITING...";const q=document.getElementById("rematch-status");q&&(q.innerText="Rematch requested. Waiting for opponent..."),ce&&ce.emit("request-rematch")}}),window.addEventListener("keydown",q=>{q.key==="Enter"&&(q.preventDefault(),Ue.chat&&document.activeElement===Ue.chat?$x():Si.game&&Si.game.classList.contains("active")&&rt.chatDrawer&&Ue.chat&&(rt.chatDrawer.classList.add("active"),Ue.chat.focus()))}),Ue.chat&&Ue.chat.addEventListener("blur",()=>{setTimeout(()=>{Ue.chat&&document.activeElement!==Ue.chat&&rt.chatDrawer&&rt.chatDrawer.classList.remove("active")},100)}),Ue.qpMapSelect){const q=Ue.qpMapSelect.querySelectorAll(".qp-map-option"),K=()=>{q.forEach(ae=>{const G=ae.dataset.map===fn;ae.classList.toggle("active",G),ae.setAttribute("aria-selected",G?"true":"false")})};K(),q.forEach(ae=>{ae.addEventListener("click",()=>{fn!==ae.dataset.map&&(fn=ae.dataset.map,be.setItem("tacticstrike_selected_map",fn),K(),It())})})}Ue.lobbyMapSelect&&Ue.lobbyMapSelect.addEventListener("change",q=>{const K=q.target.value;ce&&At&&ce.emit("select-map",{mapId:K}),It()}),Ue.lobbyModeSelect&&Ue.lobbyModeSelect.addEventListener("change",q=>{const K=q.target.value;ce&&At&&ce.emit("select-game-mode",{mode:K}),It()}),Ue.lobbyStyleSelect&&Ue.lobbyStyleSelect.addEventListener("change",q=>{const K=q.target.value;ce&&At&&ce.emit("select-render-style",{renderStyle:K}),It()}),uo(Ue.lobbyModeSelect),uo(Ue.lobbyMapSelect),uo(Ue.lobbyStyleSelect)}function wh(n=null){document.querySelectorAll(".custom-dropdown.open").forEach(e=>{e!==n&&e.classList.remove("open")})}function uo(n){if(!n||n.dataset.customDropdown==="1")return;n.dataset.customDropdown="1";const e=document.createElement("div");e.className="custom-dropdown",n.parentNode.insertBefore(e,n),e.appendChild(n),n.classList.add("custom-dropdown-source");const t=document.createElement("button");t.type="button",t.className="custom-dropdown-toggle",t.innerHTML='<span class="custom-dropdown-label"></span><span class="custom-dropdown-arrow">▾</span>',e.appendChild(t);const i=document.createElement("div");i.className="custom-dropdown-menu",e.appendChild(i),Array.from(n.options).forEach(c=>{const h=document.createElement("div");h.className="custom-dropdown-option",h.dataset.value=c.value,h.textContent=c.textContent,h.addEventListener("click",()=>{n.disabled||(wh(),a()!==c.value&&(n.value=c.value,n.dispatchEvent(new Event("change",{bubbles:!0}))))}),i.appendChild(h)});const s=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"value"),a=()=>s.get.call(n),r=c=>s.set.call(n,c),o=Object.getOwnPropertyDescriptor(HTMLSelectElement.prototype,"disabled");function l(){const c=a(),h=n.options[n.selectedIndex];t.querySelector(".custom-dropdown-label").textContent=h?h.textContent:"",i.querySelectorAll(".custom-dropdown-option").forEach(u=>u.classList.toggle("active",u.dataset.value===c)),e.classList.toggle("disabled",n.disabled),t.setAttribute("aria-expanded",e.classList.contains("open")?"true":"false")}Object.defineProperty(n,"value",{get:a,set(c){r(c),l()},configurable:!0}),Object.defineProperty(n,"disabled",{get:()=>o.get.call(n),set(c){o.set.call(n,c),l()},configurable:!0}),t.addEventListener("click",c=>{if(c.stopPropagation(),n.disabled)return;const h=e.classList.contains("open");if(wh(),!h){const u=t.getBoundingClientRect();window.innerHeight-u.bottom<150?e.classList.add("drop-up"):e.classList.remove("drop-up"),e.classList.add("open")}l()}),document.addEventListener("click",c=>{e.contains(c.target)||e.classList.remove("open")}),l()}function $x(){if(!Ue.chat)return;const n=Ue.chat.value.trim();n&&(Kl(Ye,n,"self"),ce&&At&&ce.emit("chat-message",{name:Ye,msg:n}),Ue.chat.value=""),Ue.chat.blur()}function Kl(n,e,t){const i=document.createElement("div");i.className=`chat-msg ${t}`,t==="system"?i.innerHTML=`<span class="message">${Wn(e)}</span>`:i.innerHTML=`
  ...
  `;const s=document.createElement("div");s.style.cssText=`
    ...
    width: 4px;
    background: #66fcf1;
  `,i.appendChild(s);const a=document.createElement("div");a.style.paddingLeft="6px",a.innerText=n,i.appendChild(a),i.addEventListener("click",()=>{i.style.opacity="0",i.style.transform="translateX(50px)",setTimeout(()=>i.remove(),350)}),t.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateX(0)"}),setTimeout(()=>{i.parentNode&&(i.style.opacity="0",i.style.transform="translateX(50px)",setTimeout(()=>i.remove(),350))},e)}document.addEventListener("DOMContentLoaded",()=>{if(/Mobi|Android|iPhone|iPad|iPod|Windows Phone|webOS/i.test(navigator.userAgent)||window.innerWidth<800){Gl({immediate:!0});const l=document.getElementById("mobile-warning-screen");l&&(l.style.display="flex");return}const e=document.getElementById("startup-status");e&&Dt.token&&(e.textContent="RESTORING OPERATIVE SESSION"),Dx();const t=localStorage.getItem("tacticstrike_active_match");if(t){if(xr(!1),t==="ranked"){const l=parseInt(localStorage.getItem("tacticstrike_rp")||"0"),c=Math.max(0,l-40);localStorage.setItem("tacticstrike_rp",String(c)),localStorage.setItem("tacticstrike_mm_ban_until",String(Date.now()+5*60*1e3)),rr({title:"GAME LOST",message:`You left a ranked match. The result was recorded as a loss (-40 RP).

MATCHMAKING BAN: 5 minutes.`,confirmText:"UNDERSTOOD",tone:"danger"})}else rr({title:"GAME LOST",message:"You disconnected from an active match. Recorded as a loss.",confirmText:"UNDERSTOOD",tone:"danger"});localStorage.removeItem("tacticstrike_active_match")}Gx();const i=lv();Jx(),Qx(),ev(),av(),ov(),cv(),Xx(),Zx(),Yx(),Kx(),jx(),qx(),Vx();const s=be.getItem("tacticstrike_player_name");if(s)Ye=s;else{const l=["Viper","Ghost","Specter","Rex","Apex","Phantom","Onyx","Nova"];Ye=`${l[Math.floor(Math.random()*l.length)]}_${Math.floor(Math.random()*900+100)}`,be.setItem("tacticstrike_player_name",Ye)}Ue.name&&(Ue.name.value=Ye),Wa(),Zt("menu"),or(),setInterval(()=>{const l=document.querySelector(".screen.active");(!ce||!ce.connected)&&l&&l.id==="menu-screen"&&or()},15e3),$l(),Yl(),ht=be.getItem("tacticstrike_player_weapon")||"pistol",ql(),document.querySelectorAll("#menu-weapon-selector .weapon-btn").forEach(l=>{l.dataset.weapon===ht?l.classList.add("active"):l.classList.remove("active")}),document.querySelectorAll(".weapon-option").forEach(l=>{l.dataset.weapon===ht?l.classList.add("active"):l.classList.remove("active")}),Es(ht),jl(),Nx(i)});function fo(n){const e=Hn[n];if(!e)return!0;try{if(JSON.parse(be.getItem("tacticstrike_purchased_weapons")||"[]").includes(n))return!0}catch{}return parseInt(be.getItem("tacticstrike_rp")||"0")>=e.rp}function Jx(){const n=document.getElementById("news-modal"),e=document.getElementById("btn-close-news");if(!n||!e)return;sessionStorage.getItem("tacticstrike_news_seen")||n.classList.add("active"),e.addEventListener("click",()=>{n.classList.remove("active"),sessionStorage.setItem("tacticstrike_news_seen","true"),It()})}function Qx(){const n=document.getElementById("whats-new-modal"),e=document.getElementById("btn-open-whats-new"),t=document.getElementById("btn-close-whats-new");!n||!e||!t||(e.addEventListener("click",()=>{n.classList.add("active"),It()}),t.addEventListener("click",()=>{n.classList.remove("active"),It()}))}function ev(){const n=document.getElementById("credit-shop-modal"),e=document.getElementById("btn-open-credit-shop"),t=document.getElementById("btn-close-credit-shop"),i=document.querySelectorAll("#credit-shop-modal [data-buy-credit-pack]");!n||!t||(e==null||e.addEventListener("click",()=>Ml("menu")),document.addEventListener("click",s=>{var r;const a=s.target.closest("[data-open-credit-shop]");a&&(a.closest("#account-modal")&&((r=document.getElementById("account-modal"))==null||r.classList.remove("active")),Ml(a.closest("#shop-modal")?"item-shop":"menu"))}),document.addEventListener("click",s=>{const a=s.target.closest("[data-buy-credit-pack]");a&&(s.preventDefault(),tv(a.dataset.buyCreditPack))}),t.addEventListener("click",()=>{n.classList.remove("active"),Ei("close")}),i.forEach(s=>s.addEventListener("click",()=>Ei("confirm"))))}function Ml(n="menu"){const e=document.getElementById("credit-shop-modal");e&&(e.dataset.source=n,e.classList.add("active"),Ei("open"))}async function tv(n){if(!Dt.user||!Dt.token){js("login","Sign in or create an account before purchasing credits.");return}const e=document.querySelector(`[data-buy-credit-pack="${n}"]`),t=e==null?void 0:e.innerHTML;e&&(e.disabled=!0,e.textContent="OPENING SECURE CHECKOUT…");try{const i=await Ji("/api/credits/checkout",{method:"POST",body:JSON.stringify({packageId:n})});Ei("confirm"),window.location.assign(i.checkoutUrl)}catch(i){if(e&&(e.disabled=!1,e.innerHTML=t),i.status===401){ar(),js("login","Your session expired. Sign in again to continue.");return}wn(i.message,6e3),Rs()}}function zn(n="",e=""){const t=document.getElementById("purchase-support-message");t&&(t.textContent=n,t.className=`support-notice${e?` ${e}`:""}`)}function vr(n){const e=new Date(n);return Number.isNaN(e.getTime())?"":e.toLocaleString([],{dateStyle:"medium",timeStyle:"short"})}function Zl(n){return n.closed?"CLOSED":n.status==="approved"?`${n.creditsGranted.toLocaleString()} CREDITS ADDED`:n.status==="denied"?"DENIED":"AWAITING REVIEW"}function Nd(n){return n.closed?"closed":n.status||"open"}function iv(n){return new Promise((e,t)=>{if(!n){t(new Error("Attach a receipt screenshot as proof of purchase."));return}if(!["image/png","image/jpeg","image/webp"].includes(n.type)){t(new Error("Upload a PNG, JPG, or WebP receipt image."));return}if(n.size>15e5){t(new Error("Receipt images must be smaller than 1.5 MB."));return}const i=new FileReader;i.onload=()=>e({name:n.name,data:i.result}),i.onerror=()=>t(new Error("The receipt image could not be read.")),i.readAsDataURL(n)})}function kd(n){const e=document.createElement("div");e.className=`support-message-bubble ${n.senderRole}`;const t=document.createElement("div");t.className="support-message-meta";const i=document.createElement("span");i.textContent=n.senderRole==="admin"?"TACTICSTRIKE SUPPORT":"YOU";const s=document.createElement("span");if(s.textContent=vr(n.createdAt),t.append(i,s),e.appendChild(t),n.body){const a=document.createElement("div");a.textContent=n.body,e.appendChild(a)}if(n.proofData){const a=document.createElement("img");a.className="support-proof-image",a.src=n.proofData,a.alt=n.proofName?`Purchase proof: ${n.proofName}`:"Purchase proof",e.appendChild(a)}return e}function nv(n){if(!(n!=null&&n.id))return;const e=`tacticstrike_server_credits_seen_${n.id}`,t=Math.max(0,parseInt(be.getItem(e)||"0")),i=Math.max(0,Number(n.credits||0));if(i>t){const s=Math.max(0,parseInt(be.getItem("tacticstrike_credits")||"0"));be.setItem("tacticstrike_credits",String(s+(i-t)))}be.setItem(e,String(i))}async function Ga(){var e;const n=document.getElementById("purchase-support-cases");if(n){n.innerHTML='<div class="support-empty-state">Loading secure conversations…</div>';try{const t=await Ji("/api/purchase-support/cases");if(t.user&&(Dt.user=t.user,Sn()),!t.cases.length){n.innerHTML='<div class="support-empty-state">No purchase-verification chats yet.</div>';return}const i=await Promise.all(t.cases.map(s=>Ji(`/api/purchase-support/cases/${s.id}`)));n.innerHTML="",i.forEach(s=>sv(s.purchaseCase,n))}catch(t){if(t.status===401){ar(),(e=document.getElementById("purchase-support-modal"))==null||e.classList.remove("active"),js("login","Your session expired. Sign in again to view purchase support.");return}n.innerHTML='<div class="support-empty-state">Purchase chats could not be loaded. Try refreshing.</div>',zn(t.message,"error")}}}function sv(n,e){const t=document.createElement("article");t.className="support-case-card";const i=document.createElement("div");i.className="support-case-summary";const s=document.createElement("div"),a=document.createElement("strong");a.textContent=`ORDER ${n.orderNumber}`;const r=document.createElement("small");r.textContent=`${n.requestedCredits.toLocaleString()}-credit verification · opened ${vr(n.createdAt)}`,s.append(a,r);const o=document.createElement("span");o.className=`case-status ${Nd(n)}`,o.textContent=Zl(n),i.append(s,o),t.appendChild(i);const l=document.createElement("div");if(l.className="support-message-list",n.messages.forEach(c=>l.appendChild(kd(c))),t.appendChild(l),!n.closed){const c=document.createElement("form");c.className="support-reply-form";const h=document.createElement("input");h.type="text",h.maxLength=1500,h.required=!0,h.placeholder="Reply to support…";const u=document.createElement("button");u.type="submit",u.textContent="SEND",c.append(h,u),c.addEventListener("submit",async d=>{d.preventDefault(),u.disabled=!0;try{await Ji(`/api/purchase-support/cases/${n.id}/messages`,{method:"POST",body:JSON.stringify({message:h.value})}),zn("Reply sent securely.","success"),await Ga()}catch(f){zn(f.message,"error")}finally{u.disabled=!1}}),t.appendChild(c)}e.appendChild(t),requestAnimationFrame(()=>{l.scrollTop=l.scrollHeight})}function av(){const n=document.getElementById("purchase-support-modal"),e=document.getElementById("btn-open-purchase-support"),t=document.getElementById("btn-close-purchase-support"),i=document.getElementById("btn-refresh-purchase-support"),s=document.getElementById("purchase-support-form");!n||!e||!t||!s||(e.addEventListener("click",()=>{if(!Dt.user||!Dt.token){js("login","Sign in before submitting purchase proof.");return}n.classList.add("active"),zn(),Ei("open"),Ga()}),t.addEventListener("click",()=>{n.classList.remove("active"),Ei("close")}),i==null||i.addEventListener("click",Ga),s.addEventListener("submit",async a=>{a.preventDefault();const r=s.querySelector('button[type="submit"]');r.disabled=!0,zn("Encrypting and submitting your purchase proof…","info");try{const o=document.getElementById("purchase-proof-file").files[0],l=await iv(o);await Ji("/api/purchase-support/cases",{method:"POST",body:JSON.stringify({orderNumber:document.getElementById("purchase-order-number").value,packageId:document.getElementById("purchase-package").value,message:document.getElementById("purchase-support-text").value,proof:l})}),s.reset(),zn("Purchase proof submitted. Support will reply within 1–12 hours.","success"),Ei("confirm"),await Ga()}catch(o){zn(o.message,"error"),Rs()}finally{r.disabled=!1}}))}function fs(n="",e=""){const t=document.getElementById("admin-login-message");t&&(t.textContent=n,t.className=`support-notice${e?` ${e}`:""}`)}function bl(n){const e=document.getElementById("admin-login-view"),t=document.getElementById("admin-dashboard-view");e&&(e.hidden=n),t&&(t.hidden=!n)}function Jl(){gs=null,Wl=null,be.removeItem(Hl),bl(!1)}async function Xs(n=Wl){const e=document.getElementById("admin-case-list"),t=document.getElementById("admin-case-detail");if(!(!e||!t)){e.innerHTML='<div class="support-empty-state">Loading purchase queue…</div>';try{const i=await Ms("/api/admin/purchase-cases");if(!i.cases.length){e.innerHTML='<div class="support-empty-state">No messages submitted.</div>',t.innerHTML='<div class="support-empty-state">The verification queue is empty.</div>';return}e.innerHTML="",i.cases.forEach(a=>{const r=document.createElement("button");r.type="button",r.dataset.caseId=a.id,r.className=`admin-case-list-item${a.id===n?" active":""}`;const o=document.createElement("strong");o.textContent=a.userEmail||"Unknown account";const l=document.createElement("span");l.textContent=`Order ${a.orderNumber}`;const c=document.createElement("small");c.textContent=`${Zl(a)} · ${vr(a.updatedAt)}`,r.append(o,l,c),r.addEventListener("click",()=>Ah(a.id)),e.appendChild(r)});const s=i.cases.some(a=>a.id===n)?n:i.cases[0].id;await Ah(s,!1)}catch(i){if(i.status===401){Jl(),fs("Admin session expired. Sign in again.","error");return}e.innerHTML='<div class="support-empty-state">The verification queue could not be loaded.</div>',t.innerHTML=""}}}async function Ah(n,e=!0){var i;const t=document.getElementById("admin-case-detail");if(t){Wl=n,e&&(document.querySelectorAll(".admin-case-list-item").forEach(s=>s.classList.remove("active")),(i=document.querySelector(`.admin-case-list-item[data-case-id="${n}"]`))==null||i.classList.add("active")),t.innerHTML='<div class="support-empty-state">Loading secure chat…</div>';try{const s=await Ms(`/api/admin/purchase-cases/${n}`);rv(s.purchaseCase)}catch(s){if(s.status===401){Jl(),fs("Admin session expired. Sign in again.","error");return}t.innerHTML='<div class="support-empty-state">This purchase chat could not be loaded.</div>'}}}function rv(n){const e=document.getElementById("admin-case-detail");if(!e)return;e.innerHTML="";const t=document.createElement("div");t.className="admin-case-detail-head";const i=document.createElement("div"),s=document.createElement("span");s.className="section-kicker",s.textContent=n.userEmail||"OPERATIVE ACCOUNT";const a=document.createElement("h3");a.textContent=`ORDER ${n.orderNumber}`;const r=document.createElement("p");r.textContent=`Requested package: ${n.requestedCredits.toLocaleString()} credits · opened ${vr(n.createdAt)}`,i.append(s,a,r);const o=document.createElement("span");o.className=`case-status ${Nd(n)}`,o.textContent=Zl(n),t.append(i,o),e.appendChild(t);const l=document.createElement("div");if(l.className="support-message-list admin-message-list",n.messages.forEach(d=>l.appendChild(kd(d))),e.appendChild(l),!n.closed){const d=document.createElement("form");d.className="support-reply-form admin-reply-form";const f=document.createElement("input");f.type="text",f.maxLength=1500,f.required=!0,f.placeholder="Reply to this user…";const p=document.createElement("button");p.type="submit",p.textContent="SEND REPLY",d.append(f,p),d.addEventListener("submit",async v=>{v.preventDefault(),p.disabled=!0;try{await Ms(`/api/admin/purchase-cases/${n.id}/messages`,{method:"POST",body:JSON.stringify({message:f.value})}),await Xs(n.id)}catch(g){wn(g.message,5e3)}finally{p.disabled=!1}}),e.appendChild(d)}const c=document.createElement("div");c.className="admin-actions",[50,500,2e3].forEach(d=>{const f=document.createElement("button");f.type="button",f.textContent=`ADD ${d.toLocaleString()} CREDITS`,f.disabled=n.closed||n.status==="approved",f.addEventListener("click",()=>po(n,"grant",d)),c.appendChild(f)});const h=document.createElement("button");h.type="button",h.className="danger",h.textContent="DENY PROOF",h.disabled=n.closed||n.status==="approved",h.addEventListener("click",()=>po(n,"deny"));const u=document.createElement("button");u.type="button",u.className="close-chat",u.textContent="CLOSE CHAT",u.disabled=n.closed,u.addEventListener("click",()=>po(n,"close")),c.append(h,u),e.appendChild(c),requestAnimationFrame(()=>{l.scrollTop=l.scrollHeight})}async function po(n,e,t=0){const i=e==="grant"?`Add ${t.toLocaleString()} credits to ${n.userEmail}? This cannot be granted twice.`:e==="deny"?`Deny the proof submitted for order ${n.orderNumber}?`:"Close this chat? The user will no longer be able to reply.";if(window.confirm(i))try{await Ms(`/api/admin/purchase-cases/${n.id}/decision`,{method:"POST",body:JSON.stringify({action:e,credits:t})}),wn(e==="grant"?`${t.toLocaleString()} credits added.`:e==="deny"?"Proof denied.":"Chat closed.",4500),await Xs(n.id)}catch(s){wn(s.message,5500),Rs()}}function ov(){var o,l;const n=document.getElementById("admin-modal"),e=document.getElementById("version-admin-trigger"),t=document.getElementById("btn-close-admin"),i=document.getElementById("admin-login-form");if(!n||!t||!i)return;const s=()=>{n.classList.add("active"),fs(),bl(!!gs),Ei("open"),gs&&Xs()};let a=0,r=null;e==null||e.addEventListener("click",()=>{if(a+=1,clearTimeout(r),a>=5){a=0,s();return}r=setTimeout(()=>{a=0},2200)}),t.addEventListener("click",()=>{n.classList.remove("active"),Ei("close")}),i.addEventListener("submit",async c=>{c.preventDefault();const h=i.querySelector('button[type="submit"]');h.disabled=!0,fs("Authenticating with the secure server…","info");try{const u=await Ms("/api/admin/login",{method:"POST",body:JSON.stringify({username:document.getElementById("admin-username").value,password:document.getElementById("admin-password").value})});gs=u.token,be.setItem(Hl,u.token),i.reset(),bl(!0),await Xs()}catch(u){fs(u.message,"error")}finally{h.disabled=!1}}),(o=document.getElementById("btn-refresh-admin-cases"))==null||o.addEventListener("click",()=>Xs()),(l=document.getElementById("btn-admin-logout"))==null||l.addEventListener("click",async()=>{try{await Ms("/api/admin/logout",{method:"POST"})}catch{}Jl(),fs("Signed out of the admin dashboard.","success")})}function Yi(n="",e=""){const t=document.getElementById("account-message");t&&(t.textContent=n,t.className=`account-message${e?` ${e}`:""}`)}function Xa(n="login"){const e=document.getElementById("account-tab-login"),t=document.getElementById("account-tab-register"),i=document.getElementById("account-login-form"),s=document.getElementById("account-register-form"),a=n==="login";e==null||e.classList.toggle("active",a),t==null||t.classList.toggle("active",!a),e==null||e.setAttribute("aria-selected",String(a)),t==null||t.setAttribute("aria-selected",String(!a)),i&&(i.hidden=!a),s&&(s.hidden=a)}function Sn(){const n=Dt.user;n&&(nv(n),Dt.token&&be.setItem(Ss,JSON.stringify(n)));const e=document.getElementById("btn-open-account"),t=document.getElementById("credit-shop-account-status"),i=document.getElementById("account-profile-email"),s=document.getElementById("account-profile-credits"),a=document.getElementById("account-auth-view"),r=document.getElementById("account-profile-view"),o=document.querySelectorAll("#credit-shop-modal [data-buy-credit-pack]");if(e&&(e.textContent=n?`ACCOUNT · ${n.displayName||n.email.split("@")[0]}`:Vn?"ACCOUNT":"SIGN IN",e.classList.toggle("signed-in",!!n)),t){t.classList.toggle("signed-in",!!n);const l=t.querySelector("span:last-child");l&&(l.textContent=n?`SIGNED IN · ${n.email}`:Vn?"RESTORING ACCOUNT…":"SIGN IN TO PURCHASE")}i&&(i.textContent=(n==null?void 0:n.email)||""),s&&(s.textContent=String((n==null?void 0:n.credits)||0)),a&&(a.hidden=!!n),r&&(r.hidden=!n),o.forEach(l=>{l.firstChild&&(l.firstChild.textContent=n?"CONTINUE TO CHECKOUT ":Vn?"RESTORING ACCOUNT… ":"SIGN IN TO BUY ")})}function Rh(n){Dt={token:n.token,user:n.user},Vn=!1,be.setItem(Vl,n.token),be.setItem(Ss,JSON.stringify(n.user)),Sn()}function ar(){Dt={token:null,user:null},Vn=!1,be.removeItem(Vl),be.removeItem(Ss),Sn()}function js(n="login",e=""){var t;Xa(n),Yi(e,e?"info":""),Sn(),(t=document.getElementById("account-modal"))==null||t.classList.add("active"),Ei("open")}function lv(){var s,a,r;const n=document.getElementById("account-modal"),e=document.getElementById("btn-close-account"),t=document.getElementById("account-login-form"),i=document.getElementById("account-register-form");return!n||!e||!t||!i?Promise.resolve():(document.addEventListener("click",o=>{o.target.closest("[data-open-account], #btn-open-account")&&js("login")}),e.addEventListener("click",()=>{n.classList.remove("active"),Ei("close")}),(s=document.getElementById("account-tab-login"))==null||s.addEventListener("click",()=>{Xa("login"),Yi()}),(a=document.getElementById("account-tab-register"))==null||a.addEventListener("click",()=>{Xa("register"),Yi()}),t.addEventListener("submit",async o=>{o.preventDefault();const l=t.querySelector('button[type="submit"]');l.disabled=!0,Yi("Authenticating…","info");try{const c=await Ji("/api/auth/login",{method:"POST",body:JSON.stringify({email:document.getElementById("account-login-email").value,password:document.getElementById("account-login-password").value})});Rh(c),wn("Welcome back, operative.",4e3)}catch(c){Yi(c.message,"error")}finally{l.disabled=!1}}),i.addEventListener("submit",async o=>{o.preventDefault();const l=document.getElementById("account-register-password").value,c=document.getElementById("account-register-confirm").value;if(l!==c){Yi("Passcodes do not match.","error");return}const h=i.querySelector('button[type="submit"]');h.disabled=!0,Yi("Creating secure operative profile…","info");try{const u=await Ji("/api/auth/register",{method:"POST",body:JSON.stringify({email:document.getElementById("account-register-email").value,password:l})});Rh(u),wn("Operative account created.",4500)}catch(u){Yi(u.message,"error")}finally{h.disabled=!1}}),(r=document.getElementById("btn-account-logout"))==null||r.addEventListener("click",async()=>{try{await Ji("/api/auth/logout",{method:"POST"})}catch{}ar(),Xa("login"),Yi("Signed out successfully.","success")}),Sn(),Dt.token?Ji("/api/auth/me").then(l=>{Dt.user=l.user,be.setItem(Ss,JSON.stringify(l.user)),Sn()}).catch(l=>{if(l.status===401){ar();return}console.warn("Account session validation was delayed:",l)}).finally(()=>{Vn=!1,Sn()}):(Vn=!1,Sn(),Promise.resolve()))}function cv(){const n=document.getElementById("shop-modal"),e=document.getElementById("btn-open-shop"),t=document.getElementById("btn-close-shop");!n||!e||!t||(be.getItem("tacticstrike_credits")===null&&be.setItem("tacticstrike_credits","0"),e.addEventListener("click",()=>{Ud(),n.classList.add("active"),It()}),t.addEventListener("click",()=>{n.classList.remove("active"),It()}))}function Ud(){const n=document.getElementById("shop-items-container"),e=document.getElementById("shop-credits-display"),t=document.getElementById("shop-owned-count"),i=document.getElementById("shop-available-count");if(!n||!e)return;const s=parseInt(be.getItem("tacticstrike_credits")||"0");e.innerText=s;let a=[];try{a=JSON.parse(be.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}const r=parseInt(be.getItem("tacticstrike_rp")||"0");n.innerHTML="";let o=0,l=0;Object.keys(Hn).forEach(c=>{const h=Hn[c],u=kx[c],d=a.includes(c),f=r>=h.rp,p=s>=h.price,v=d||f;v?o+=1:p&&(l+=1);const g=document.createElement("article");g.className=`shop-item-card tier-${u.tier.toLowerCase()}${v?" is-owned":""}${!p&&!v?" needs-credits":""}`;let m="",M="";d?(m='<span class="shop-item-status owned"><i></i>ACQUIRED</span>',M='<button class="shop-buy-action owned" disabled>IN YOUR ARMORY</button>'):f?(m='<span class="shop-item-status rank"><i></i>RANK UNLOCKED</span>',M='<button class="shop-buy-action owned" disabled>AVAILABLE IN LOADOUT</button>'):(m=`<span class="shop-item-status locked"><i></i>${h.rank} CLEARANCE</span>`,p?M=`<button class="shop-buy-action buy-btn" data-weapon="${c}">UNLOCK EARLY <span>→</span></button>`:M=`<button class="shop-buy-action top-up" type="button" data-open-credit-shop>GET CREDITS <span>+${(h.price-s).toLocaleString()}</span></button>`);const _=yr[c]||{name:c};g.innerHTML=`
