  ...
  `}function Nn(n){var c;if(fs=n,!rt.playersList)return;rt.playersList.innerHTML="";const e=Ht==="2v2"?4:2;for(let h=0;h<e;h++){const f=n[h],d=document.createElement("div");if(f){d.className=`player-slot active ${f.ready?"ready":""}`;const u=((c=pr[f.weapon])==null?void 0:c.name)||f.weapon,v={cyan:"#66fcf1",green:"#39db14",purple:"#9d3bff",orange:"#ff7f3b",yellow:"#ffd700",red:"#ff3c3c"}[f.color]||"#66fcf1",g=Ht==="2v2"?`TEAM ${h%2===0?"1":"2"}`:h===0?"HOST":"GUEST",m=f.rp||0,M=Td(m);d.innerHTML=`
        <div class="player-info">
          <span class="player-name" style="color: ${v};">
            <span style="color: ${M.color}; margin-right: 4px;">${M.icon}</span>${Wn(f.name)} ${f.id===le.id?"(YOU)":""}
          </span>
      ...
      `}else{d.className="player-slot empty";const u=h+1,p=Ht==="2v2"?` (TEAM ${h%2===0?"1":"2"})`:"";d.innerHTML=`<div class="slot-status">WAITING FOR OPERATIVE ${u}${p}...</div>`}if(rt.playersList.appendChild(d),Ht==="1v1"&&h===0){const u=document.createElement("div");u.className="vs-divider",u.innerText="VS",rt.playersList.appendChild(u)}}const t=n.find(h=>h.id===le.id);t&&it.readyToggle&&(Gs=t.ready,it.readyToggle.className=Gs?"btn secondary":"btn primary",it.readyToggle.innerText=Gs?"CANCEL READY":"READY TO DEPLOY");const i=document.getElementById("lobby-map-selector-container"),s=document.getElementById("lobby-map-select");if(i&&s)if(fi==="ranked")i.style.display="none";else{i.style.display="block";const h=n[0]&&n[0].id===le.id;s.disabled=!h}const a=document.getElementById("lobby-mode-selector-container"),r=document.getElementById("lobby-mode-select");if(a&&r)if(fi==="ranked")a.style.display="none";else{a.style.display="block";const h=n[0]&&n[0].id===le.id;r.disabled=!h}const o=document.getElementById("lobby-style-selector-container"),l=document.getElementById("lobby-style-select");if(o&&l)if(fi==="ranked")o.style.display="none";else{o.style.display="block";const h=n[0]&&n[0].id===le.id;l.disabled=!h}}function Ha(){if(le)return;const n=ur();le=ka(n),window.AppSocket=le,le.on("connect_error",()=>{console.warn("Failed to connect to multiplayer server."),sr()}),le.on("disconnect",()=>{sr()}),le.on("player-counts",e=>{Id(e)}),le.on("connect",()=>{console.log("Socket connected.");const e=Fl(),t=parseInt(be.getItem("tacticstrike_rp")||"0"),i=bs(),s=parseInt(be.getItem("tacticstrike_credits")||"0");let a=[];try{a=JSON.parse(be.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}le.emit("sync-device",{uuid:e,rp:t,wins:i.wins,losses:i.losses,name:Ye,credits:s,purchasedWeapons:a})}),le.on("device-synced",e=>{console.log("Device synced with database:",e);const t=parseInt(be.getItem("tacticstrike_rp")||"0"),i=Math.max(t,e.rp||0);be.setItem("tacticstrike_rp",String(i));const s=bs(),a=Math.max(s.wins,e.wins||0),r=Math.max(s.losses,e.losses||0);Sd({wins:a,losses:r});const o=parseInt(be.getItem("tacticstrike_credits")||"0"),l=Math.max(o,e.credits||0);be.setItem("tacticstrike_credits",String(l));let c=[];try{c=JSON.parse(be.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}const h=Array.from(new Set([...c,...e.purchasedWeapons||[]]));be.setItem("tacticstrike_purchased_weapons",JSON.stringify(h)),e.name&&e.name!=="Operative"&&(Ye=e.name,be.setItem("tacticstrike_player_name",Ye),Fe.name&&(Fe.name.value=Ye)),Wl(),Vl(),zl()}),le.on("register-response",e=>{e.success||console.warn("Register failed:",e.error)}),le.on("login-response",e=>{e.success||console.warn("Login failed:",e.error)}),le.on("room-created",({roomId:e,players:t,autoMatch:i,mode:s,mapId:a,renderStyle:r,isRanked:o})=>{wt=e,s&&(Ht=s),fi=o?"ranked":"casual",rt.roomCode.innerText=e;const l=document.getElementById("lobby-map-select");l&&a&&(l.value=a);const c=document.getElementById("lobby-mode-select");c&&s&&(c.value=s);const h=document.getElementById("lobby-style-select");h&&r&&(h.value=r,Mi=r),i?(Nn(t),Pi("Created matchmaking room. Waiting for opponent...")):(ti("lobby"),Nn(t),Pi(`Lobby created. Share code [${e}] with a friend.`))}),le.on("room-joined",({roomId:e,players:t,mode:i,mapId:s,renderStyle:a,isRanked:r})=>{wt=e,i&&(Ht=i),fi=r?"ranked":"casual",rt.roomCode.innerText=e,ti("lobby"),Nn(t);const o=document.getElementById("lobby-map-select");o&&s&&(o.value=s);const l=document.getElementById("lobby-mode-select");l&&i&&(l.value=i);const c=document.getElementById("lobby-style-select");c&&a&&(c.value=a,Mi=a),Pi(`Joined lobby: ${e}`),yi&&(clearTimeout(yi),yi=null),qt&&(clearTimeout(qt),qt=null),Vs=!1}),le.on("room-error",e=>{alert(e)}),le.on("player-joined",({players:e})=>{Nn(e);const t=e.find(s=>s.id!==le.id);t&&Pi(`${t.name} entered the lobby.`);const i=document.querySelector(".screen.active");i&&i.id==="matchmaking-screen"&&(qt&&(clearTimeout(qt),qt=null),ti("lobby"))}),le.on("players-update",({players:e})=>{Nn(e)}),le.on("lobby-map-update",({mapId:e})=>{const t=document.getElementById("lobby-map-select");t&&(t.value=e),Pi(`Host updated mission area to: ${e==="cyberlab"?"Neon Cyber-Lab":e==="arena"?"Neon Arena":"Residential Manor"}`)}),le.on("lobby-mode-update",({mode:e})=>{const t=document.getElementById("lobby-mode-select");t&&(t.value=e),Ht=e;let i="Duel 1v1";e==="sabotage"&&(i="Sabotage (Task Survival)"),Pi(`Host updated game mode to: ${i}`)}),le.on("lobby-style-update",({renderStyle:e})=>{const t=document.getElementById("lobby-style-select");t&&(t.value=e),Mi=e,Pi(`Host updated render style to: ${e==="competitive"?"Competitive":"Realistic"}`)}),le.on("player-left",({players:e,message:t})=>{Nn(e),Pi(t);const i=document.querySelector(".screen.active"),s=i&&i.id==="game-screen";if(ve&&s)if(ve.active&&ve.mode==="online"&&(ve.gameState==="playing"||ve.gameState==="countdown"||ve.gameState==="replay")){if(mr(!0),ve.isRanked){const r=parseInt(localStorage.getItem("tacticstrike_rp")||"0")+80;localStorage.setItem("tacticstrike_rp",String(r)),ve.localPlayer&&(ve.localPlayer.rp=r,ve.localPlayer.rank=ve.localPlayer._calcRank(r))}localStorage.removeItem("tacticstrike_active_match"),ve.endGameDueToDisconnect(t)}else if(ve.gameState==="match-over"){const a=document.getElementById("rematch-status");a&&(a.innerText="Opponent left the room.");const r=document.getElementById("btn-rematch");r&&(r.disabled=!0,r.innerText="OPPONENT LEFT")}else localStorage.removeItem("tacticstrike_active_match"),ve.endGameDueToDisconnect(t)}),le.on("match-start",({players:e,seed:t,isRanked:i,mode:s,mapId:a,renderStyle:r})=>{fi=i?"ranked":"casual",r&&(Mi=r),yn&&yn.classList.remove("active"),Qa(()=>{const l=e.findIndex(c=>c.id===le.id);rt.chatMessages.innerHTML="",localStorage.setItem("tacticstrike_active_match",i?"ranked":"casual"),ve&&ve.destroy(),ve=new Za("game-canvas",{mode:"online",socket:le,localPlayerId:le.id,localPlayerName:Ye,localWeapon:ht,localColor:Zt,localPlayerIndex:l,players:e,seed:t,mapId:a||"manor",settings:{...Ve,volume:Ve.sfxMuted?0:Ve.volume},matchMode:s||Ht,isRanked:!!i,qpRenderStyle:Mi,onMatchEnd:er,onKillFeed:tr}),ti("game")})}),le.on("opponent-requested-rematch",e=>{const t=document.getElementById("rematch-status");let i="Opponent";if(ve&&e&&e.playerId){const s=ve.players.find(a=>a.id===e.playerId);s&&(i=s.name)}t&&(t.innerText=`${i} requested a rematch! Click REMATCH to accept.`)})}function Bs(){le&&(le.disconnect(),le=null,wt=null,window.AppSocket=null),rt&&rt.roomCode&&(rt.roomCode.innerText="-----")}function _h(){const n=document.getElementById("deploy-modal");n&&n.classList.remove("active"),fi="practice",Qa(()=>{rt.chatMessages.innerHTML="",ve&&ve.destroy();const t=[{id:"player",name:Ye,weapon:ht,color:Zt}];Ht==="2v2"?(t.push({id:"bot_enemy_1",name:"Bot Miller (Enemy)",weapon:vn(),color:"red"}),t.push({id:"bot_teammate",name:"Bot Ramirez (Teammate)",weapon:vn(),color:"green"}),t.push({id:"bot_enemy_2",name:"Bot Cooper (Enemy)",weapon:vn(),color:"orange"})):t.push({id:"bot_enemy_1",name:"Bot Miller (Enemy)",weapon:vn(),color:"red"}),ve=new Za("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ye,localWeapon:ht,localColor:Zt,localPlayerIndex:0,players:t,seed:Math.random(),mapId:Ln,settings:{...Ve,volume:Ve.sfxMuted?0:Ve.volume},matchMode:Ht,isRanked:!1,qpRenderStyle:Mi,onMatchEnd:er,onKillFeed:tr}),ti("game")})}function vn(){return["pistol","rifle","shotgun","sniper","smg","lmg","dmr","vector","famas"][Math.floor(Math.random()*9)]}function er(n){localStorage.removeItem("tacticstrike_active_match"),yn&&yn.classList.add("active");const e=!!n.isWin;let t="";if(ve&&ve.mode==="online"){mr(e);const p=ve.players.find(m=>m.id!==le.id);p&&Ix(p.name,e);const v=parseInt(be.getItem("tacticstrike_credits")||"0");let g=v;if(ve.isRanked&&e&&(g=v+50,be.setItem("tacticstrike_credits",String(g)),t=' <span style="color:#ffd700; font-size:10px;">(+50 Credits Ranked Win Bonus!)</span>'),le){const m=Fl(),M=parseInt(be.getItem("tacticstrike_rp")||"0"),_=bs();let x=[];try{x=JSON.parse(be.getItem("tacticstrike_purchased_weapons")||"[]")}catch{}le.emit("sync-device",{uuid:m,rp:M,wins:_.wins,losses:_.losses,name:Ye,credits:g,purchasedWeapons:x})}}const i=document.getElementById("match-result-title"),s=document.getElementById("match-result-subtitle");i&&(e?(i.innerText="MISSION ACCOMPLISHED",i.className="result-title win"):(i.innerText="MISSION FAILED",i.className="result-title lose")),s&&(e?s.innerText="You successfully eliminated the target operative.":s.innerText="You were eliminated by the target operative.");let a="Unknown Operative";if(ve){const p=ve.players.find(v=>v.id===n.winnerId);p&&(a=p.name)}const r=document.getElementById("match-winner-name");r&&(r.innerText=`WINNER: ${a}`,r.style.color=e?"#39db14":"#ff3c3c");const o=document.getElementById("stat-rounds-won");o&&(o.innerText=n.roundsWon||0);const l=document.getElementById("stat-damage-dealt");l&&(l.innerText=Math.round(n.damageDealt||0));const c=document.getElementById("stat-accuracy");c&&(c.innerText=`${Math.round(n.accuracy||0)}%`);const h=document.getElementById("stat-shots-fired");h&&(h.innerText=n.shotsFired||0);const f=document.getElementById("rematch-status");f&&(f.innerText="");const d=document.getElementById("btn-rematch");d&&(d.disabled=!1,d.innerText="REMATCH"),it.returnLobby&&(ve&&ve.isRanked?it.returnLobby.innerText="RETURN TO MENU":it.returnLobby.innerText="RETURN TO LOBBY");const u=document.getElementById("rank-result-panel");if(u){if(ve&&ve.isRanked&&n.newRank){const p=n.newRank,v=n.rpDelta||0,g=v>=0?`+${v} RP`:`${v} RP`,m=v>=0?"#39ff14":"#ff3c3c";u.innerHTML=`
        ...
        `,u.style.display="block"}else u.innerHTML='<div style="font-family:var(--font-title); font-size:10px; color:var(--text-muted); text-align:center; letter-spacing:1.5px;">CASUAL MATCH - NO RANK EFFECT</div>',u.style.display="block";if(t){const p=document.createElement("div");p.style.cssText="font-family:var(--font-title); font-size:10px; text-align:center; margin-top:8px;",p.innerHTML=t,u.appendChild(p)}}}function Fx(){var fe;const n=document.getElementById("btn-deploy-main"),e=document.getElementById("btn-close-deploy"),t=document.getElementById("deploy-modal"),i=document.getElementById("btn-play-worldloom"),s=document.getElementById("btn-close-worldloom"),a=document.getElementById("btn-leave-worldloom-unsaved"),r=document.getElementById("btn-retry-worldloom"),o=document.getElementById("btn-return-worldloom"),l=document.getElementById("worldloom-site-screen"),c=document.getElementById("worldloom-frame"),h=document.getElementById("worldloom-frame-loading"),f=h==null?void 0:h.querySelector(".worldloom-frame-actions"),d=document.getElementById("worldloom-portal-status"),u=((fe=h==null?void 0:h.querySelector("small"))==null?void 0:fe.textContent)||"";let p=!1,v=!1,g=null,m=0,M=!1;const _=2500,x=new Map,y=l!=null&&l.parentElement?[...l.parentElement.children].filter($=>$!==l):[],E=new Map,A=$=>{y.forEach(q=>{$?(E.set(q,q.hasAttribute("inert")),q.setAttribute("inert","")):E.get(q)?q.setAttribute("inert",""):q.removeAttribute("inert")}),$||E.clear()},S=()=>{d&&(d.hidden=!0,d.textContent=""),a&&(a.hidden=!0),f&&(f.hidden=!0),h==null||h.classList.remove("has-error")},w=($,q=!0)=>{v=q,clearTimeout(g),g=null,h==null||h.classList.remove("is-hidden"),h==null||h.classList.toggle("has-error",q),h==null||h.setAttribute("aria-busy","false");const ue=h==null?void 0:h.querySelector("small");ue&&(ue.textContent=$),f&&(f.hidden=!1)},P=($=!1)=>{p=!1,v=!1,S(),h==null||h.classList.remove("is-hidden"),h==null||h.setAttribute("aria-busy","true");const q=h==null?void 0:h.querySelector("small");if(q&&(q.textContent=u),clearTimeout(g),g=setTimeout(()=>{!p&&!v&&w("Worldloom is taking longer than expected. You can keep waiting, retry, or return.",!1)},9e3),!c)return;const ue=(i==null?void 0:i.dataset.worldloomPath)||"./worldloom/index.html";$&&c.removeAttribute("src"),c.getAttribute("src")||c.setAttribute("src",ue)},C=()=>{if(!p||!(c!=null&&c.contentWindow))return Promise.resolve(null);const $=`worldloom-save-${Date.now()}-${++m}`;return new Promise(q=>{const ue=setTimeout(()=>{x.delete($),q(!1)},_);x.set($,ye=>{clearTimeout(ue),x.delete($),q(!!ye)}),c.contentWindow.postMessage({source:"tacticstrike",type:"request-save",requestId:$},window.location.origin)})};window.addEventListener("message",$=>{var ue;if($.origin!==window.location.origin||$.source!==(c==null?void 0:c.contentWindow))return;const q=$.data;(q==null?void 0:q.source)==="worldloom"&&(q.type==="ready"?(p=!0,v=!1,clearTimeout(g),g=null,S(),h==null||h.setAttribute("aria-busy","false"),h==null||h.classList.add("is-hidden")):q.type==="save-ack"?(ue=x.get(q.requestId))==null||ue(q.saved):q.type==="error"&&h&&w(q.message||"Worldloom could not start safely. Retry or return to TacticStrike."))}),n&&t&&n.addEventListener("click",()=>{t.classList.add("active");const $=t.querySelector(".deploy-card");$&&($.scrollTop=0),kt(),vt.pause(),vt.currentTime=0,Ut||(gt.volume=.15,gt.currentTime=0,gt.play().catch(()=>{}))}),e&&t&&e.addEventListener("click",()=>{t.classList.remove("active"),kt(),gt.pause(),gt.currentTime=0,Ut||Hl()}),i&&i.addEventListener("click",()=>{kt(),window.stopAllMusic(),t&&t.classList.remove("active"),l&&(l.classList.add("active"),l.setAttribute("aria-hidden","false")),document.body.classList.add("is-worldloom-open"),A(!0),P(!1),s==null||s.focus()}),c&&c.addEventListener("load",()=>{c.getAttribute("src")&&!p&&!v&&(h==null||h.setAttribute("aria-busy","true"))});const L=()=>{clearTimeout(g),g=null,p=!1,v=!1,c&&c.removeAttribute("src"),l&&(l.classList.remove("active"),l.setAttribute("aria-hidden","true")),document.body.classList.remove("is-worldloom-open"),A(!1),S(),h==null||h.classList.remove("is-hidden"),h==null||h.setAttribute("aria-busy","false"),t&&t.classList.add("active"),Ut||(gt.volume=.15,gt.currentTime=0,gt.play().catch(()=>{})),i==null||i.focus(),s&&(s.disabled=!1),M=!1};s&&s.addEventListener("click",async()=>{if(M)return;M=!0,s.disabled=!0,kt(),document.pointerLockElement&&document.exitPointerLock();const $=await C();if(p&&$===!1){d&&(d.textContent="SAVE FAILED — WORLD KEPT OPEN",d.hidden=!1),a&&(a.hidden=!1),s.disabled=!1,M=!1;return}L()}),a==null||a.addEventListener("click",()=>{l!=null&&l.classList.contains("active")&&L()}),r==null||r.addEventListener("click",()=>P(!0)),o==null||o.addEventListener("click",()=>s==null?void 0:s.click()),Fe.name&&Fe.name.addEventListener("change",()=>{Ye=Fe.name.value.trim()||"Operative",be.setItem("tacticstrike_player_name",Ye),le&&le.connected&&le.emit("change-name",{name:Ye})}),it.practiceBot&&it.practiceBot.addEventListener("click",()=>{Fe.name&&(Ye=Fe.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye),_h()}),it.btnAmongUs&&it.btnAmongUs.addEventListener("click",()=>{Fe.name&&(Ye=Fe.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye);const $=document.getElementById("deploy-modal");$&&$.classList.remove("active"),fi="practice",Qa(()=>{rt.chatMessages.innerHTML="",ve&&ve.destroy();const ue=[{id:"player",name:Ye,weapon:"none",color:Zt},{id:"bot_enemy_1",name:"Impostor Killer",weapon:"pistol",color:"red"}];ve=new Za("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ye,localWeapon:"none",localColor:Zt,localPlayerIndex:0,players:ue,seed:Math.random(),mapId:Ln,settings:{...Ve,volume:Ve.sfxMuted?0:Ve.volume},matchMode:"sabotage",isRanked:!1,qpRenderStyle:Mi,onMatchEnd:er,onKillFeed:tr}),ti("game")})}),it.createRoom&&it.createRoom.addEventListener("click",()=>{const $=document.getElementById("deploy-modal");$&&$.classList.remove("active"),Fe.name&&(Ye=Fe.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye),Ha(),le&&le.emit("create-room",{playerName:Ye,mode:Ht,color:Zt,mapId:Ln,weapon:ht,renderStyle:Mi})}),it.joinRoom&&it.joinRoom.addEventListener("click",()=>{const $=document.getElementById("deploy-modal");$&&$.classList.remove("active");const q=Fe.roomCode?Fe.roomCode.value.toUpperCase().trim():"";if(!q||q.length!==5){alert("Please enter a valid 5-character room code.");return}Fe.name&&(Ye=Fe.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye),Ha(),le&&le.emit("join-room",{roomId:q,playerName:Ye,color:Zt,weapon:ht})});function z($){const q=parseInt(localStorage.getItem("tacticstrike_mm_ban_until")||"0");if(Date.now()<q){const ye=q-Date.now(),G=Math.floor(ye/6e4),J=Math.floor(ye%6e4/1e3);nr({title:"MATCHMAKING BAN ACTIVE",message:`${G}:${String(J).padStart(2,"0")} remaining.

Leaving ranked matches results in a temporary ban.`,confirmText:"UNDERSTOOD",tone:"ban"});return}const ue=document.getElementById("deploy-modal");if(ue&&ue.classList.remove("active"),Fe.name&&(Ye=Fe.name.value.trim()||"Operative"),be.setItem("tacticstrike_player_name",Ye),Ha(),le){const ye=parseInt(localStorage.getItem("tacticstrike_rp")||"0");Vs=!1;const G=Ht+"_"+$;le.emit("auto-match",{playerName:Ye,mode:G,color:Zt,rp:ye,rankStrict:!0,weapon:ht}),ti("matchmaking");const J=document.getElementById("mm-rank-display"),K=document.getElementById("mm-rank-icon"),we=document.getElementById("mm-timer"),Ae=document.getElementById("mm-expand-notice"),Pe=Td(ye);J&&(J.innerText=Pe.label),K&&(K.innerText=Pe.icon,K.style.color=Pe.color),we&&(we.innerText="0s"),Ae&&(Ae.innerText="Searching within your skill bracket...");let st=0;window.mmInterval&&clearInterval(window.mmInterval),window.mmInterval=setInterval(()=>{st++,we&&(we.innerText=`${st}s`)},1e3);let De=0;const Xe=document.getElementById("mm-dots");window.mmDotsInterval&&clearInterval(window.mmDotsInterval),window.mmDotsInterval=setInterval(()=>{De=(De+1)%4,Xe&&(Xe.innerText=".".repeat(De))},500),yi&&clearTimeout(yi),yi=setTimeout(()=>{!Vs&&le&&le.connected&&(!wt||fs&&fs.length===1)&&(Vs=!0,Pi("⚡ Rank filter removed — expanding search to all ranks..."),Ae&&(Ae.innerText="⚡ Search expanded to all skill ranks!"),wt&&(le.emit("leave-room"),wt=null),le.emit("auto-match",{playerName:Ye,mode:G,color:Zt,rp:ye,rankStrict:!1,weapon:ht}))},2e3);const et=15e3+Math.floor(Math.random()*46e3);qt&&clearTimeout(qt),qt=setTimeout(()=>{qt=null;const He=document.querySelector(".screen.active");!He||He.id!=="matchmaking-screen"||wt&&fs&&fs.length>1||U($)},et)}}function U($){window.mmInterval&&clearInterval(window.mmInterval),window.mmDotsInterval&&clearInterval(window.mmDotsInterval),yi&&(clearTimeout(yi),yi=null),qt&&(clearTimeout(qt),qt=null),Vs=!0;const q=document.getElementById("mm-expand-notice"),ue=document.getElementById("mm-dots"),ye=document.getElementById("mm-timer");q&&(q.innerText="GAME FOUND — DEPLOYING..."),ue&&(ue.innerText=""),ye&&(ye.innerText=""),le&&le.emit("leave-room"),Bs(),wt=null;const G=ho();fi="ranked";const J=()=>{rt.chatMessages.innerHTML="",ve&&ve.destroy(),localStorage.setItem("tacticstrike_active_match","ranked");const K=[{id:"player",name:Ye,weapon:ht,color:Zt}];Ht==="2v2"?(K.push({id:"bot_enemy_1",name:G,weapon:vn(),color:"red"}),K.push({id:"bot_teammate",name:ho(),weapon:vn(),color:"green"}),K.push({id:"bot_enemy_2",name:ho(),weapon:vn(),color:"orange"})):K.push({id:"bot_enemy_1",name:G,weapon:vn(),color:"red"}),ve=new Za("game-canvas",{mode:"offline",socket:null,localPlayerId:"player",localPlayerName:Ye,localWeapon:ht,localColor:Zt,localPlayerIndex:0,players:K,seed:Math.random(),mapId:Ln,settings:{...Ve,volume:Ve.sfxMuted?0:Ve.volume},matchMode:Ht,isRanked:!0,qpRenderStyle:$,onMatchEnd:er,onKillFeed:tr}),Pi(`Game found! Playing against ${G}.`),ti("game")};setTimeout(()=>Qa(J),1200)}it.rankedRealistic&&it.rankedRealistic.addEventListener("click",()=>z("realistic")),it.rankedCompetitive&&it.rankedCompetitive.addEventListener("click",()=>z("competitive"));const I=document.getElementById("btn-cancel-matchmaking");I&&I.addEventListener("click",()=>{window.mmInterval&&clearInterval(window.mmInterval),yi&&clearTimeout(yi),qt&&(clearTimeout(qt),qt=null),le&&le.emit("leave-room"),Bs(),window.stopAllMusic(),ti("menu")}),it.leaveLobby&&it.leaveLobby.addEventListener("click",()=>{le&&wt&&le.emit("leave-room"),Bs(),ti("menu")}),it.readyToggle&&it.readyToggle.addEventListener("click",()=>{if(le&&wt){const $=!Gs;le.emit("player-ready",{ready:$}),Md()}}),it.copyCode&&it.copyCode.addEventListener("click",()=>{wt&&navigator.clipboard.writeText(wt).then(()=>{it.copyCode.innerText="✅",setTimeout(()=>it.copyCode.innerText="📋",1500)})}),it.returnLobby&&it.returnLobby.addEventListener("click",()=>{yn&&yn.classList.remove("active");const $=document.getElementById("rank-result-panel");$&&($.style.display="none",$.innerHTML=""),ve&&(ve.destroy(),ve=null),Wl(),le&&wt&&fi!=="ranked"?(ti("lobby"),Gs=!1,Nn(fs),Es(ht)):(le&&le.emit("leave-room"),Bs(),ti("menu"))});const B=document.getElementById("btn-game-menu"),N=document.getElementById("game-menu-overlay"),j=document.getElementById("btn-game-resume"),te=document.getElementById("btn-game-leave");B&&N&&B.addEventListener("click",()=>{N.classList.add("active")}),j&&N&&j.addEventListener("click",()=>{N.classList.remove("active")}),te&&N&&te.addEventListener("click",async()=>{if(ve&&ve.active&&ve.gameState!=="match-over"){let q;if(ve.isRanked?q={title:"MATCHMAKING BAN WARNING",message:"Leaving this ranked match will count it as a LOSS (-40 RP) and give you a 5-minute MATCHMAKING BAN.",confirmText:"LEAVE MATCH",cancelText:"STAY IN MATCH",tone:"danger"}:ve.mode==="online"?q={title:"LEAVE MATCH",message:"Leaving this online match will count it as a LOSS.",confirmText:"LEAVE MATCH",cancelText:"STAY IN MATCH",tone:"info"}:q={title:"LEAVE MATCH",message:"Your current match progress will be lost.",confirmText:"LEAVE",cancelText:"STAY",tone:"info"},!await nr(q)){N.classList.remove("active");return}}console.log("LEAVE MATCH clicked. Cleaning up game session...");try{if(N.classList.remove("active"),ve){try{if(ve.active&&(ve.mode==="online"||ve.isRanked)&&ve.gameState!=="match-over"&&(mr(!1),ve.isRanked)){const q=parseInt(localStorage.getItem("tacticstrike_rp")||"0"),ue=Math.max(0,q-40);localStorage.setItem("tacticstrike_rp",String(ue)),localStorage.setItem("tacticstrike_mm_ban_until",String(Date.now()+5*60*1e3))}}catch(q){console.error("Error recording match result during leave:",q)}localStorage.removeItem("tacticstrike_active_match");try{ve.destroy()}catch(q){console.error("Error destroying gameEngine:",q)}ve=null}}catch(q){console.error("Error in leave match handler pre-disconnect:",q)}try{le&&wt&&le.emit("leave-room")}catch(q){console.error("Error emitting leave-room:",q)}try{Bs()}catch(q){console.error("Error disconnecting socket:",q)}try{ti("menu")}catch(q){console.error("Error showing menu screen:",q)}}),window.addEventListener("beforeunload",$=>{if(ve&&ve.active&&ve.gameState!=="match-over")return $.preventDefault(),$.returnValue="",""});const se=document.getElementById("btn-rematch");se&&se.addEventListener("click",()=>{if(ve&&ve.mode==="offline")yn&&yn.classList.remove("active"),ve&&(ve.destroy(),ve=null),_h();else{se.disabled=!0,se.innerText="WAITING...";const $=document.getElementById("rematch-status");$&&($.innerText="Rematch requested. Waiting for opponent..."),le&&le.emit("request-rematch")}}),window.addEventListener("keydown",$=>{$.key==="Enter"&&($.preventDefault(),Fe.chat&&document.activeElement===Fe.chat?zx():Si.game&&Si.game.classList.contains("active")&&rt.chatDrawer&&Fe.chat&&(rt.chatDrawer.classList.add("active"),Fe.chat.focus()))}),Fe.chat&&Fe.chat.addEventListener("blur",()=>{setTimeout(()=>{Fe.chat&&document.activeElement!==Fe.chat&&rt.chatDrawer&&rt.chatDrawer.classList.remove("active")},100)}),Fe.qpMapSelect&&(Fe.qpMapSelect.value=Ln,Fe.qpMapSelect.addEventListener("change",$=>{Ln=$.target.value,be.setItem("tacticstrike_selected_map",Ln),kt()})),Fe.lobbyMapSelect&&Fe.lobbyMapSelect.addEventListener("change",$=>{const q=$.target.value;le&&wt&&le.emit("select-map",{mapId:q}),kt()}),Fe.lobbyModeSelect&&Fe.lobbyModeSelect.addEventListener("change",$=>{const q=$.target.value;le&&wt&&le.emit("select-game-mode",{mode:q}),kt()}),Fe.lobbyStyleSelect&&Fe.lobbyStyleSelect.addEventListener("change",$=>{const q=$.target.value;le&&wt&&le.emit("select-render-style",{renderStyle:q}),kt()})}function zx(){if(!Fe.chat)return;const n=Fe.chat.value.trim();n&&(Gl(Ye,n,"self"),le&&wt&&le.emit("chat-message",{name:Ye,msg:n}),Fe.chat.value=""),Fe.chat.blur()}function Gl(n,e,t){const i=document.createElement("div");i.className=`chat-msg ${t}`,t==="system"?i.innerHTML=`<span class="message">${Wn(e)}</span>`:i.innerHTML=`
      <span class="author">${Wn(n)}:</span>
      <span class="message">${Wn(e)}</span>
    `,rt.chatMessages&&(rt.chatMessages.appendChild(i),rt.chatMessages.scrollTop=rt.chatMessages.scrollHeight),rt.chatDrawer&&rt.chatDrawer.classList.add("active"),window.chatTimeout&&clearTimeout(window.chatTimeout),window.chatTimeout=setTimeout(()=>{Fe.chat&&document.activeElement!==Fe.chat&&rt.chatDrawer&&rt.chatDrawer.classList.remove("active")},4e3)}function Pi(n){Gl("",n,"system")}function tr(n,e,t){var r;const i=document.getElementById("kill-feed");if(!i)return;const s=document.createElement("div");s.className="kill-msg";const a=((r=pr[t])==null?void 0:r.name)||t;s.innerHTML=`
