...
const base=process.env.NITE_TEST_URL||'http://127.0.0.1:4186/';
...
try{
  ...
  assert.match(await page.title(),/^Nite/);
  ...
  await page.screenshot({path:'../../outputs/nite-hub-desktop.png'});
  ...
  await page.screenshot({path:'../../outputs/nite-hub-hover.png'});
  ...
  await page.screenshot({path:'../../outputs/nite-hub-mobile.png'});
  ...
  assert.match(await page.$eval('#title-button',b=>b.textContent),/return to Nite/);
  ...
  await reduced.screenshot({path:'src/public/hub/nite-social.jpg',type:'jpeg',quality:88});
